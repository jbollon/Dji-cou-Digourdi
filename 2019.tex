...
\Juliespeaks Ouè, pequé comme sèide beun, dedeun la Compagnì n’at i eunna groussa disquech\'on, que l'a divijà le Digourdì eun doe fach\'on!
...
\Aimespeaks Mi devàn de voté fa comprendre comme son allaye pe dab\'on le bague\ldots
...
\StageDir{Vouése foua campe \vouese: ``Eunna normalla réuni\'on di Digourdì.''
}
...
\Jordyspeaks \direct{S'arite to d'eun creppe avouì Cima} Ad\'on, se te me baille fèi té deun lo 2019 te fé seutta partia iaou te fé eun grou monologue devàn a 30 meulle personne \direct{Cima dimèn sondze seutta \textit{scène}} té to solette!

\Cimaspeaks Mi mé n'i todzor deu-lo que té tia an mentalitoù jénialla, té Giordi t’a an martse eun pi!
...
\StageDir{Richard se levve \footnote{ Dèi-z-ara tcheu le consèillì que prègnon la paolla se levvon pe prédjì.}, comenche a prédjì mi se sen ren pequé l'a pa allemoù lo microfonne. Tcheu lèi diyon de allemì lo microfonne. Richard se inerve é can areuvve finalemàn a allemi-lo se sen eun ``isto seutte \textit{porcherie}''. Tcheu le prézàn lèi repondon avouì eun``shttt".}

\Cimaspeaks \direct{Ver lo pebleuque} Squezade\ldots l'è de Jovençan!

\Richardspeaks Bondzor a tcheutte! Vouillo maque propozé eunna dzenta idoù: eunna pièse avouì dou vétchot devàn eun fornet \fornet, fan la counta de comme son tsandjaye le séiz\'on, avouì eun bon dobl\'on de rodzo é\ldots
...
\Presidanspeaks Bon-a idoù Paolo! Senque n'a-tì de pi téatral di noutro Consèille réjonal? Ah voualà\ldots pouèn fé la conta de comme n'i gagnà le-z-éléch\'on pe vin-ì Prézidàn! \direct{Inervaye} L’a dimand\'o la paolla la conséilliye Comé é fièn prédjì eunc\'o lleu.
...
\StageDir{Lo secretéo se beutte le lenette \lenette , teurie foua eun grou livro \livro\ avouì desì bièn de poussa, souffle desì pe la gavé, tsertse la padze djeusta é SI SCHIARISCE LA VOCE\ldots}
...
\StageDir{Levvon la man Cima, Jordy, Sophie é Eyvia. Marco l'a la tita pe le gnoule é ad\'on Cima lèi baille tourna eun creppe eun tita pe lèi diye de lévé la man. Marco levve la man é lo secretéo marque si lo verbal sinque vouése pe la pièse ``Le Simpson".}

\Secreteospeaks Lévisa la man sise que son a faveur de la pièse ``Comme n'i gagnà le-z-éléch\'on"\ldots
...
\Eyviaspeaks \'E ara comme martse?
...
\StageDir{Lo palque seré divijà eun trèi poueun illoumin\'o : a gotse n'a Jean Luc, a drèite eun Pompiolèn eun tren de coueillì de secòrie é i mentèn n'at eunna viille penchon-aye saventa que baille bèye i son jéragn\'on to sèque.}
...
\Dallasspeaks Acoutta Jo\"{e}lle, n'i prédzà avouì Madama la Prézidanta é l'a deu-me ``te fa partì avouì Jo\"{e}lle, alé i Chef-Lieu é pourté-me 800 vouése!".
...
\Jeanspeaks \direct{Euncoa to fier} \ldots mi son de moublo! Van da solette! Da coupa di mondo! 
...
\StageDir{Paolo refléchèi \pense doe seconde é repette ``sa pa qui son le Digourdì" eugn avèitsèn Jo\"{e}lle pe lèi diye ``di pa ren".}
...
\Joelledallasspeaks \direct{Eun tsantèn} ``Te travaille pe trèi mèis, te gagne to l'an, vota Marlène Prézidàn!''

\StageDir{Paolo é Jo\"{e}lle baillon eun \textit{santino} de Marlène a Jean Luc.}
...
\Jeanspeaks Ah tranquila!\direct{Eun moutrèn lo \textit{santino}} Mé la croueu la beutto seu desì! 
...
\StageDir{Paolo é Jo\"{e}lle baillon eun \textit{santino} de Marlène a la viille madama.}
...
\StageDir{N'at eun vétchot que l'è eun tren de coueillì de secòrie. Dérì de llou areuvvon Cima é Marco avouì eunna tsaretta plèin-a de bague.}
...
\Marcospeaks Ouemma que dzente secòrie!
...
\Pompiolenspeaks Mi ouè coueillèn catro secòrie.

\Marcospeaks Èita Paolo que dzente secòrie que l'a lo mesieu\ldots
...
\Pompiolenspeaks \direct{Pren eunna secòrie é la moutre a Paolo} Èitade seu que qui blan! Gneunca la fenna can l'ie dzoueun-a l'ayè eun qui pouèi!

\Cimaspeaks \ldots é ad\'on sade an baga? Avouì le-z-où de Feleunna \direct{lèi fé vère le-z-où}\ldots  voutre secòrie\ldots 
...
\Cimaspeaks Mi ouè, fièn an baga: betèn to dedeun  voutra saquetta di secòrie.
...
\Cimaspeaks Ah voualà!\direct{Eun terièn foua eun \textit{santino}} Rappelade-v\'o maque, mesieu, lo 9 de marse, Lista num\'er\'o 2, Digourdì\ldots

\Pompiolenspeaks Eh? Senque l'è seutta porcaria?

\Cimaspeaks \direct{I pebleuque} Oh la mondjeu, sitte comprèn ren! \direct{I vétchot} Dèijade alì beté an croueu lo 9 de marse si la lista num\'er\'o 2.
...
\StageDir{Paolo teurie foua eugn atro \textit{santino}.}

\Cimaspeaks Ouè é prégnade eunc\'o sitte pe la fenna, prégnade tcheu dou.

\Pompiolenspeaks\direct{Eun prégnèn lo sec\'on \textit{santino}} Ouè tcheu dou, pouèi dou pi dou\ldots catro!
...
\Cimaspeaks \ldots é ad\'on comme l'è, tot amoddo?

\Jeanspeaks Mi ouè amoddo! Te vèi pa comme si to contèn? Son djeusto ià dou dzi que l'an deu-me que me payon pe to l'an; mé traillo maque chouì mèis a l'an, féo la sèiz\'on si eun Pila.

\Cimaspeaks \direct{Douteu \pense} Dou dzi? Mi comèn l'ion arbeillà? Comme l'ion?
...
\Cimaspeaksèita Mi avèitsa comme te reste bièn; é aprì lo flou que l'at!
...
\StageDir{Marco baille a Paolo eun \textit{santino}.}

\Cimaspeaks \ldots lo 9 de marse te dèi alì votì le Digourdì\ldots mi la Lista num\'er\'o 2, sise dzano, le pi onéto!

\StageDir{Cima baille a Jean Luc lo \textit{santino}.}

\Jeanspeaks \direct{Eun lizèn} ``Eunsemblo pe le Digourdì''.
...
\StageDir{Entron Jo\"{e}lle é Paolo é reston dérì lo vétchot que l'è todzor eun tren de coueillì le secòrie.}
...
\Pompiolenspeaks\direct{Malechà \malecha} Senque?Le serdzette le-z-atsetade pi a sen de Bisson, don! Seutte son de SECÒRIE!

\StageDir{Jo\"{e}lle pren la paolla pe arendjì la gaffe de Paolo.}

\Joellespeaks  Mi que dzente secòrie! Aprì avouì le-z-où seutte son la feun di mondo! 
...
\StageDir{Jo\"{e}lle avèitse Paolo dispéraye é eunsemblo tournon dérì lo mesieu pe prédjì dézò vouése. Dimèn lo vétchot conteugne a coueillì le secòrie.}
...
\Pompiolenspeaks Mi an tappolette [GIUSTO???] sit an, de bague moustre!
...
\Joellespeaks \ldots pe le secòrie! 

\Pompiolenspeaks Que dzenta baga!

\Dallasspeaks \ldots é ad\'on di-meu, véo te nen vou? Alé, spara si an tseuffra!
...
\Joellespeaks \ldots se pi de secòrie t'ou coueilìi\ldots

\Dallasspeaks \ldots vota Marlène \ldots

\Joellespeaks  \ldots di Digourdì!

\StageDir{Jo\"{e}lle lèi fé veure lo \textit{santino} de Marlène.}

\Pompiolenspeaks Ah ouè, ouè, n'i to comprèi. Betade maque deun la saquetta.

\StageDir{Jo\"{e}lle beutte lo \textit{santino} deun la saquetta; dimèn Paolo fé tsire pe tèra, dérì lo vétchot, 500 euro.}
...
\Pompiolenspeaks \direct{Ver lo pebleuque} Eh eh eh! \direct{Eun countèn le sou} Mé n'i pi belle comprèi ren! Le rouza, le dzano, Marlène, Jordy, argh! Bague pe le dzouveun-o, salle bague lé; l'eumpourtàn l'è que oueu n'en pourt\'o i mitcho la pagnotta\ldots é la fèi avouì so\direct{eun moutrèn le sou} nen atseutto eunc\'o eun mouì! Ah l'è fran bièn aloù que sise rablasoque l'an fran comprèi ren: leur pensoon que mé fise de Tsarvensoù, que votòo pe inque; na, na, na\ldots mé si eun Pompiolèn é si renque inque a la maodda!
...
\StageDir{Ver la drèite di palque sentèn la vouése de Marco que, eun braillèn``Paolo si arrevoù", entre eun scène avouì la tsaretta \tsaretta; mi eugn arrevèn to de coursa, Marco s'apersèi pa di jiragn\'on é le gnaque avouì la tsaretta.}
...
\StageDir{Cima baille eun cré caouse a la viille madama, todzor itaoulaye si la tsaretta, rèida é paralizaye.}
...
\StageDir{Cima pren eun \textit{santino} é tsertse de lo euncastré deun la man de la madama.}
...
\StageDir{Vouése foua campe \vouese : ``Eun leugne de sé a catro\ldots trèi\ldots dou\ldots eun\ldots}
...
\StageDir{Lo tchequeun soun-e \dindon .}
...
\Brunospeaks Ah, madama Dzourio bonsouar! Ad\'on, senque me contade? Comme l'è alaye la campagne élettorale? 
...
\begin{enumerate}
	\item eun tseun acappe dézò tèra lo \textit{santino} é lo pourte i son patr\'on;
	\item eun gars\'on acappe lo \textit{santino} dedeun eun paneun;
	\item eunna mamma acappe lo \textit{santino} dedeun lo pannoleun di mèinoù;
	\item eun djovinotte acappe lo \textit{santino} dedeun lo distributeur di gan de Paris;
	\item avouì lo \textit{metal detector } eun djouyao di fiolet acappe lo \textit{santino} déz\'o téra.
\end{enumerate}
}
...
\Brunospeaks \direct{Eun calmèn Jordy} Euh pe plèizì! Comme n'i demandoù a Marlène Dzourio, vo dimando comme l'è itaye seutta campagne elettorale.
...
\begin{enumerate}
	\item eunna feuille s'aprotse a l'imondicha pe tapì ià eun cart\'on: dèi déz\'o le cart\'on chor foua Jordy pe lèi soumondre eun \textit{santino};
	\item eunna madama l'è eun tren de lavé le pateun i boueuille: eun chortèn foua de l'éve Jordy  lèi soum\'on eun \textit{santino};
	\item eun gars\'on s'aprotse i for di pan; can lo ivre troue Jordy, dza preste avouì lo \textit{santino} eun man;
	\item eun djovinotte l'è eun tren de galoppé si pe eun sentchì: eun chortèn foua di tombeun, Jordy lo bloque é lèi baille lo \textit{santino};
	\item eunna feuille ivre son conjélateur é lèi troue dedeun Jordy avouì eun \textit{santino} eun man\ldots la feuille déside de lo clloure tourna deun lo conjélateur.
\end{enumerate}
}
...
\StageDir{Lo tchéqueun soun-e \dindon .}
...
\SpectIIspeaks Bonsouar a tcheutte! N'ario an baga a dimandé i doe fach\'on: véyo l'è coutaye la campagne elettorale? Pa pe d’atro, mi maque pe savèi, pequé salle son de sou de tcheu no!
...
\Brunospeaks GONG! Voualà, la télévouése l'è fenia é ara ferio voté vo di pebleuque, pequé l'è bièn eumpourtàn. Eun attendèn Viondapapì fiade le voutre contcho: avèitsade qui gagne avouì la télévouese é no ara vièn comme va avouì lo pebleuque.
...
\Jordyspeaks Comme catro vouése?
...
\StageDir{Vouése foua campe \vouese :``Mi ouè!" (L'è eunna vouése de eugn ommo, mi se comprèn pa amoddo de qui).}
...
\StageDir{Vouése foua campe \vouese :``Ouè madama!" }
...
\StageDir{Vouése foua campe \vouese :``Ah ouè madama!". Marlène se levve, tchoué pe tèra la londze sigalla é s'aprotse i pebleuque.}
