...
%%% ridurre spazioe prima dell'indice
%\usepackage{tocloft}
%\setlength{\cftbeforetoctitleskip}{-0.0cm}
...
\usepackage{graphicx}
\usepackage[paperheight=216mm,%#9in,
paperwidth=154mm,%6in,
%showframe, verbose, %bindingoffset=0in,
inner=18.0mm, outer=21mm,
top=26mm, bottom=27mm,
%inner=18mm, outer=27mm,
%top=27.5mm, bottom=41mm,
...
%\usepackage{gfsdidot}
\usepackage[charter]{mathdesign}%{mathdesign}
%FONT!
\usepackage{qrcode}
\usepackage{etoolbox}
...
\centering
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{#1}
}
\begin{center}
...
\foreach \x [count=\i] in {#1} {
 ...
 \vspace*{2mm}
\qrcode[hyperlink, height=#4 in]{\y}
  \end{subfigure}%
   \fi
 }
}
...
%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\Fv}[1]{
Vouése derì le rid\'o \vouese\ : \og #1 \fg . 
}
%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{float}
\newcommand{\listvideos}{\vspace*{-0.0cm}Liste di \textit{vidéo}}
...
\newcommand{\listsounds}{\vspace*{-0.0cm}Liste di mezeucque}
...
% Effet
%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\listeffets}{\vspace*{-0.0cm}Liste di-z-éffé sonore}
...
% Foto
%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\listfotos}{\vspace*{-0.0cm}Liste di foto}
