...
\item[$\bullet$] De matériel pe fé betsii: caoutì, TAGLIERI, Scottex, sidel, cachoule, eumbouéleuza\ldots ;
...
\Hermannspeaks\direct{Ironique} No-z-allèn pamì reterì la vianda, dièn i dzi que son si ``Scherzi a parte"?
...
\Luciespeaks\direct{Foua campe, eun braillèn} Na tanta! Tanta Melanie! Na!
...
\StageDir{Vouése foua campe \vouese : ``Son pasoù dou dzor. Totta la fameuille l'è eun tren de fenì la betsii. Fa eunc\'o eumbouélé é gropé la dériye tsèin-a de boudeun. Oueu l'è lo dzor de la sepolteua".}
