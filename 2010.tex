...
\Pierrespeaks Mi ad\'on ara mé n'i to comprèi comme son alaye le bague! Voualà iaou catson le tréneun de Cogne!
...
\Ritaspeaks \direct{Ironique} Ah sit cou si tranquila!
 ...
 \StageDir{Vouése de la réjì \vouese\ : ``Rita t’i presta? L’è djeusto fenì \textit{Mattino Cinque} é sampouza totse a no''.}
...
\StageDir{Vouése de la réjì \vouese\ : ``Attenchón, diretta de sé a ouette, satte, chouì, sinque, catro, trèi\ldots ''}
\StageDir{Partèi lo \textit{jénérique}:}
...
\Bertinaspeaks Sen maria-no lo 12 Touéno! \direct{Eun plaouen \piangere} Vèyade mesieu lo dzeudzo, comme féyo a resté eunc\'o avouì eungn ommo pouèi!
...
\StageDir{Vouése de la régie \vouese\ ``Dirette de sé a ouette, satte, chouì, sinque, catro, trèi, dou\ldots '' Tcheut dimèn prègnon leur plase. Pascal soun-e lo campaneun \campanel .}
...
\StageDir{\vouese\ ``Rita t'i presta? Tornèn comenchì''. Pascal é Tobie entron eun \textit{scène}.}
 
\Ritaspeaks Mondje, vouè, vouè!

\StageDir{\vouese\ `` Presta pe la diretta, 6-5-4-3-2\ldots ''.}
...
\Ticspeaks \direct{Malecha \malecha} Oh senque?! Restade tchica calmo!
...
\StageDir{Partèi la mezeucca de \hyperref[forum]{Forum}\footnote{ \textit{Jénérique} a padze \pageref{forum}.}. Pascal èidze lo dzeudzo a chotre.}
...
\StageDir{\vouese\ \direct{Avouì acsan de Fin-is} ``Ouè, mondje mondje n’i prèi la leugne Piero, que émosón Rita, 'on de-r-an que aprouo, mondje, mondje!".}

\Ritaspeaks Si fran contenta pe vo Madama!

\StageDir{``Ouè squezode, mé dze 'i Rina de Féic é, vuoillavo difendre Tchièn eun diyèn que le dou carabegnì a la pla'e de fouété le dzi pourion se compolté tchica miouc avouì le sitouayèn perqué son bièn malpoulic. Eun pouteun a Pascal!''.}
...
\StageDir{Chor é s'en va déz\'o la mezeucca de \hyperref[forum]{Forum}\footnote{ \textit{Jénérique} a padze \pageref{forum}.}. Comme douàn tcheut se plachon i mentèn di palque.}
...
\StageDir{Partèi lo refrèn de \hyperref[forum]{Forum}\footnote{ \textit{Jénérique} a padze \pageref{forum}.}.}
