...
\StageDir{\vouese\ \direct{Avouì acsàn de Fin-is} ``Ouè, mondje mondje n’i prèi la leugne Piero, que émosón Rita, 'on de-r-an que aprouo, mondje, mondje!".}

\Ritaspeaks Si fran contenta pe vo Madama!

\StageDir{``Ouè squezode, mé dze 'i Rina de Féic é, vuoillavo difendre Tchièn eun diyèn que le dou carabegnì a la pla'e de fouété le dzi pourion se compolté tchica miouc avouì le sitouayèn perqué son bièn malpoulic. Eun pouteun \pouteun a Pascal!''.}
