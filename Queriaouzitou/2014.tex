...
\item[$\bullet$] Ver mèitchà piése, Paolo Cima Sander s'oubliè todzor eun\-na battiya a propoù di bouì. Pe tsertchì de lèi la fé rappelì, Pierre, can comprégnè que Paolo l'iye eun tren de s'oubliì la battiya, dijè \og Oh flotte! \fg. Naturellamente, eunc\'o lo dzor di spettaclle Paolo l'è oublia-se  la battiya\ldots vo queuttèn la queriaouzitoù d'accapé si momàn.\\

\item[$\bullet$] Pe qui avèitserè la \textit{vidéo}, l'è for probablo que s'apesèiserè d'eun pégno \textit{vaff****lo} que noutro Paolo l'è queutto-se scapé! Paolo se squeuze avouì vo tcheutte!
\end{itemize}
}