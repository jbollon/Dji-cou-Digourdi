...
\item[$\bullet$] Pe Fabien Lucianaz, futur Prézidàn di Digourdì, SÈIDE\-POU\-(VO)\-ÈR reprézente lo débù deun la compagnì téatrale.\\

\item[$\bullet$] Pe lo premì cou l'è pouyà si lo palque eun noutro cher collaborateur é \textit{auteur}. No spéèn todzor que tournise si lo palque, mi llou préfée partisipé foua di téatre, eun no baillen de-z-idoù jénialle pe réalizé de counte comique\footnote{ A désembro 2024 l'è pouyà tourna si lo palque, avouì eun mémorable duo comique eunsemblo a André Comé. \textit{Chanceux ceux qui étaient là}!}.\\

\item[$\bullet$] L'élémèn lo pi métatéatral de SÈIDEPOUVOÈR l'è, sensa dou\-te, la campagne élettorale que tcheu le-z-atteur l'an fé lo lon di senà devàn de la pièse. Le doe liste l'an pa mol\'o de baillì de beillette élettoral ià pe la parotse, pe convencre le dzi d'alì a téatre pe voté lo nouo Prézidàn di Digourdì. A témouagnadzo de la pressante propagande féta pe la lista numér\'o dou, n'a seutta \textit{vidéo}:
