\queriaouzitou{
\begin{itemize}
\item[$\bullet$] Lo titre\footnote{ Pe la grafie di BREL lo titre sarie ``SÈIDEPOU(VO)ER". Lo dérì acsàn l'è pa nésesséo, mi l'è gneunca eugn erreur.} de la pièse l'è eun djouà de paolle que souligne dou élémèn di mal gouvernemèn de la classe dirijante: la sèi de pouvoer (SÈI DE POUVOÈR) é la corruch\'on, l'itre pouer (SÈIDE POUÈR);
...
\item[$\bullet$] Pe lo premì l'è pouyà si lo palque eun noutro cher collaborateur é \textit{auteur}. No spéèn todzor que tournise si lo palque, mi llou préfée partisipé foua di téatre, eun no baillen de jénialle-z-idoù pe réalizé de counte comique;
