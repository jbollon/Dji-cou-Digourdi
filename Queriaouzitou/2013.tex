...
\item[$\bullet$] Pe lo premì cou, la prézentach\'on di-z-atteur l'è itaye féta de fas\'on diffienta reuspé a la tradichonella magniye de queryì eun aprì l'atro tcheu le-z-atteur a la feun di spettaclle. Tcheu le-z-atteur son it\'o prézent\'o a l'entérieur de la danse \textit{chorégraphique} finale.
\end{itemize}
}