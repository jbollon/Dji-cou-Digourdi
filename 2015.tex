...
\Character[DORINA]{DORINA}{Dorina}{Tsambrie di local Disco Flama (40 an), \nameF{Valérie Marguerettaz}}
...
\Character[HÉLÈNE]{HÉLÈNE}{Helene}{Tsambrie trèinasoque di local Disco Flama pe le-z-àn '90, \nameF{Elisa Viérin}}
...
Achouat\'o, douàn lo banc\'on, n'at eun cliàn abituel é eun joueur. A drèite, achouataye si eunna panquetta, n'a doe feuille.}
...
\StageDir{Gemma se levve de la panquetta é, demì malechaye, tsemin-e ver Walter. Dimèn entre Selmo. Sensa diye ren saliye Dorina, paye l'entrée é se plache i banc\'on. Gène lèi soum\'on eunna bira.}
...
\StageDir{Sensa remersì Selmo, Ketty pren le \textit{cocktail} é s'achouatte si la panquetta avouì le-z-amie de lleu.} 
...
\Genespeaks\direct{Totchà deun l'orgueuill, ver Pino}	Acrapì que t'i pa d'atro! Seutta l'è pa an crotta! Si sit solàn l'an tsemià de dzi comme \direct{eun moutrèn le fotografiye} Petchoù Tony, Mike Bondzor\ldots payade maque l'\textit{entrée}.
...
\StageDir{Ketty, eunfastedjaye, s'achouatte si la panquetta.}
...
\Laurentspeaks\direct{Foua campe} Praou, praou!
...
\StageDir{Sen todzor i Disco Flama, mi si cou sen pe le-z-àn '80. Acapèn Gène, dérì lo banc\'on, é Dorina, protso de la remiza di dra, avouì 20 an de pi. Tcheu dou l'an le pèi blan. Gène, sourtoù, l'è bièn relièn deun la jestch\'on di local. Pe bailli-lei eunna man, acapèn protso de llou Berta, sa feuille.}
...
\StageDir{Entre Giulio. S'aprotse i GUARDAROBA, paye lo beillet, baille la djacca a Dorina é s'aprotse i banc\'on. Dimèn le trèi feuille conteneuvvon a tsaplétì.}
...
\Ornellaspeaks Fé finque mou i cou.
...
\Djouiyaoueunspeaks\direct{I seun compagn\'on} V'ouèi vi que pertse que n’i acapoù!
...
Ara la propriétéa di local l'è Berta (feuille de Gène). I GUARDAROBA n'a todzor Dorina, avouì dji-z-àn de pèi blan eun pi é eun per de \textit{decibel} eun mouèn. Achouataye li eun livro, mi eun réalit\'o, avouì de grou biicllo di solèi, l'è eun tren de drimì. Dérì lo banc\'on acapèn Hélène, tsambrie di local. L’è minite é le premì cliàn dérian arrevé de sé a pouza.
...
\Dorinaspeaks Pe fose que le dzouveuno i dzor de oueu reston malle pe de dzor.\direct{NOSTALGICA} I ten de mé, n'ayè pa totte seutte potchaquiye. No béyaon todzor lo Vermouth! L'ie boun lo Vermouth!

\StageDir{Hélène tourne dedeun avouì lo \textit{lime}.}

\Dorinaspeaks\direct{Stouffie} Ouè Dorina, ouè.

\StageDir{Entron lo DJ é la \textit{cubista}, que s'aprotse a Hélène pe ataqué a tchatcharì.}
...
\StageDir{Entron dou dzouveun-o, eun poumpa pe fé fita é s'amuzé. Galoppon directemàn i banc\'on.}
...
\Michelspeaks Pouèi sen vin-ì a pià di Pon. [DICE QUALCOS'ALTRO MA NON RIESCO A TRADURLO]. \direct{Eun s'aprotsèn a Dorina} Sen so que flo de l'achao [GIUSTO?] que n'i\ldots
...
\StageDir{Partèi la fita: Hélène soum\'on a bèye [SOUMON BÈYE?], Berta counte le sou, le-z-amì fan santé pe la dériye nite de Giulio, la \textit{cubista} ataque a danchì. Pierre é Louis lèi beutton eun per de BANCONOTE deun le pantal\'on.}

\StageDir{La mezeucca bèiche.}

\Giuliospeaks\direct{I seun amì} Mi salla feuille li que danche? V'ouèide pens\'o a to so pe mé?
...
\StageDir{La fita conteneuvve: Giulio veun prèi di seun amì é tapp\'o si pe l'er eun per de cou. La mezeucca l'è forta.}
...
\StageDir{Sami diillatte Giulio. Giulio se levve é a man iverte tsertse Sami.}

\Giuliospeaks Iaou t'i Sami?

\Samispeaks Seuilla!

\StageDir{Sami pren Giulio é lo pourte i mentèn di palque pe eunna danse sensuelle, iaou Giulio pou totchì eunna mia de pi. Dimèn le-z-amì conteneuvvo a riye é a fé fita.}
...
\StageDir{Michel pren lo vèyo d'éve é eunsemblo i seun amì lo voueudze si lo vezadzo de Giulio, que se rèche é se teurie si eun catro catro ouette.}
...
\StageDir{Le catro (eun réalit\'o le trèi, Auguste contre Pierre é Louis) comenchon a se pouchì. Auguste l'è nettamente pi for. Pierre é Louis se tramon ver la chortiya, a tita ata, eun djabléyèn countre le dou mal polì.}
...
\Bertaspeaks\direct{Eun prédzèn i pebleuque} Qui l'arì jamì deu-lo que eun dzor Pollentch\'on é Tsarvensolèn l’arian betoù de coutì totte  leur discuch\'on é plantou-la li de se tsacotì pe de counte foule\ldots va savèi tanque can!
