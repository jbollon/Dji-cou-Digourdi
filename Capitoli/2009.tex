...
\Character[PRIYE]{PRIYE}{Prie}{Lo priye de l'opetaille \prete ,\\ \name{Pierre Savioz}}

\Character[FENNE\\ DI POULISIE]{FENNA DI POULISIE}{Fennepulisie}{Femalle arbeillaye comme le méccanisièn de la \textit{Ferrari}, eunterprétaye pe \textsc{Jasmine Comé}, \textsc{Giada Grivon} é \textsc{\mbox{Serena} Giorgi}. Giada é Jasmine eunterprèton eunc\'o le-z-eunfermiye de la \textit{psychiatrie}.}
...
\Character[\hspace*{1mm}]{\hspace*{1mm}}{a}{\hspace*{1mm}}
...
\Gerominespeaks Oh! Avèitsa qui se vèi. Ad\'on te sa qué que t’a eunna mamma?
