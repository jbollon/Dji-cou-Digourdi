...
\fotocopertina{Foto/2009/gruppo.jpg}{Paola Lucianaz, Francesca Lucianaz, Jo\"{e}l Albaney, Jasmine Comé,\\ Paolo Cima Sander, Giada Grivon, Fabrizio Pession, Pierre Savioz,\\ Ilaria Linty}{Valeria Brunod, Serena Giorgi, Jo\"{e}lle Bollon, Simone Roveyaz,\\ Laurent Chuc, Ester Bollon, Marco Ducly}{2009}\label{link}

%\vspace*{-0.5cm}
\LinkPiese{L'opetaille moderno}{https://www.youtube.com/watch?v=lP22_oK_hws&list=PLBofM-NS_eLJUln45l7VH457fGak_Bk5O&index=10}{.5}{.75}
...
\item[$\bullet$] 1 fondal téatral avouì eunna pourta i mentèn d'iaou le-z-atteur pouon entré é chotre;
\item[$\bullet$] 1 bourset pe le grou sou é 1 pe le sou tri;
\item[$\bullet$] 1 campaneun \campanellino ;
\item[$\bullet$] 3 botèille de Gatorade ;
\item[$\bullet$] 1 flute ;
...
\Character[ARISTOCRATE]{ARISTOCRATE}{PersEmpourtanta}{Mesieu Veullatchì bièn eumpourtàn, recoveroù a l'opetaille, \name{Marco Ducly}}

\Character[GASTON]{GASTON}{Eunfeurmi}{L’eunfermì personnel de l'Aristocrate, \name{Laurent Chuc}}

\Character[PRIYE]{PRIYE}{Prie}{Lo priye de l'opetaille, \name{Pierre Savioz}}

\Character[FENNE\\ DI POULISIE]{FENNA DI POULISIE}{Fennepulisie}{Femalle arbeillaye comme le méccanisièn de la \mbox{\textit{Ferrari}}, eunterprétaye pe \textsc{Jasmine Comé}, \textsc{Giada Grivon} é\\ \textsc{\mbox{Serena} Giorgi}. Giada é Jasmine eunterprèton eunc\'o le-z-eunfermiye de la \textit{psychiatrie}.}
...
\Character[MED. MITCHO]{MED. MITCHO}{MedMitcho}{Lo \textit{Doctor House} de l'opetaille,\\ \name{Paolo Cima Sander}}
...
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2009/b.jpg}
}
\end{figure}
\vfill
\begin{figure}[h]
...
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2009/1S9D0110.jpg}
}
\end{figure}
\vfill
...
\StageDir{Se senton de vouése que veugnon de dérì la tèila.}
...
\Laurentspeaks T'i tan grou é t'a pouiye de cattro personne que son viin-e no vére?!

\Pierrespeaks Ad\'on fièn an baga? Baillèn dou creppe a la moura!
...
\StageDir{Lemiye \lemieSi\ desù lo \textit{proscenium}. Pierre chor de dérì la tèila.}
...
\Pierrespeaks T'a rèiz\'on! Son tcheu pi greundzo\ldots pe deue\ldots té pensa que eun cou t'ayè praou te réchì a satte é demì pe alé eun Veulla a ouett'aoue. Ara, avouì seutta dzenta arionda que l'an fé-no ba i Pont-Suaz te fa te réchì a chouì é demì! Péqué eun cou que t'i  ba, te fa baillì la présédanse i Gressaèn; aprì pi de 50 an que n'en i no si drouette! \'E comme se bastise pa, can te feullon devàn l'an eunc\'o eun grou sourì a 32 di \sorrisone .
...
\Pierrespeaks Mi na! Senque te me di? Sitte l'è pa lo travaille di-z-ommo! Son le fenne que dèyon pensé i megnadzo.

\Laurentspeaks \direct{Ironique} Eh brao! Eun cou l'iye pouèi! Aya a Tsarvensoù, dèi can l'an betoù si doe formach\'on di femalle di fiolet, leur pi grou tracasse l'è si d'aprestì l'èima, baillì la biacca i fiolet é prenotì le campe réjonal pe la demendze.

\Pierrespeaks Ouè, ouè\ldots si cou va fran tott'a bal\'on!

\Laurentspeaks Te pou pa resté bièn avouì seutta viya! T'i stressoù! Aprì fenèi que eun se beutte maladdo!
...
\Laurentspeaks N'ayò sentì de seutta loué: la Subettina. Espleucca vèi comèn fonchoun-e!

\Pierrespeaks Ad\'on, te sa que Brunetta l'a desid\'o d'aoumenté l'oréo de la \textit{mutua}; donque, noutro Senteucco l'a betoù eunna riilla pe tcheu le sitouayèn! Dèi ara can eun l'è maladdo, l'è maladdo i $100\%$! Te pou gnenca pamì alì ba a la crotta pe prendre eunna boun-a botèille de veun ou alì de foua pe couillì le pomme \mela .

\Laurentspeaks Ah ara n'i comprèi péqué l'è an senâ que vèyo pa mon vezeun di mitcho é pe tèra n'a totte le pomme pouriye.

\Pierrespeaks \ldots é fa fé attench\'on! Péqué lèi  son le vallet de veulla que pasoun, dzor é nite, mitcho pe mitcho pe verifiì. Eugn effé, l'an pamì lo ten de pasì i mentèn de la parotse pe baillì la multa i machine parquédjaye mal!

\Laurentspeaks \ldots é comme se n'isse panco praou, n'a eunc\'o d'atro mé cher-z-amì, péqué eun cou que t'a aprést\'o sin-a, t'a baillà medjì i mèinoù é t'a lav\'o le-z-éze\ldots te l'amerie pa t'itaoulé eun mo\-màn desù lo chofà pe avèitchì lo Grande Fratello?
...
\Pierrespeaks Me rappelao pamì de seutta counta! \'E t'a sentì que n'at eunc\'o la finanse é le carabignì di bouque que son eun tren de cayì to pe l'er lo péi pe tsertchì seutte-z-arme?

\Laurentspeaks N'ay\'o sentì de seutta counta é say\'o tellemàn tracachà que n'i falì euntéré deun lo courtì le dou pistolet a éve: le dou Super Liquidator di botcha!
...
\Pierrespeaks Can mimo douàn can sen chortì di tend\'on n'ay\'on tan pouiye di dzi\ldots ara n'en finque prèi tro de coadzo.

\Laurentspeaks N'en eunc\'o prao deu-nen! Spéèn can mimo que la Quemeua é tcheutte le Tsarvensolèn contenisan a no baillì eunna man; piatro sit an l'è lo premì é dérì an que fièn lo \textit{Printemps Thé\^{a}tral}.

\Pierrespeaks Ouè! \direct{Eun avèitsèn la moutra \orologio} Ara senque te nen di se prézentisan la pièse?

\Laurentspeaks \direct{Eun avèitsèn son pouse sensa moutra \footnote{ Malerezamente Laurent l'iye oublia-se de betì la moutra, mi lo pebleucco l'a bièn riette pe seutta gaffe.}} Ouè l'è l'aoua de comenchì, mi devàn vourio fé eunna présizach\'on pe tcheu le Tsarvensolèn: tcheu sise manifeste que n'en bet\'o ia pe la parotse, l'è pa pequé gavoon l'éve ou l'élétrisit\'o, mi l'è pe lo spétaclle de seutta nite! Tracachade-v\'o pa!

\Pierrespeaks Amoddo! Mogà no sistémèn an miya pe la prézentach\'on?

\StageDir{Pierre é Laurent se cllouzon la djacca é drichon lo papillon \papillon\ . Eun pi, Laurent se beutte si le poueunte di pià é Pierre se plèye si le dzegnaou de fas\'on que sisan ate tcheu dou igale.}

\Pierrespeaks \textit{Mesdames} é \textit{Messieurs} a vo \og L'opetaille moderno\fg . Pise i\-cri\-ta pe Jo\"{e}l Albaney.
...
\StageDir{Eun \textit{scène} n’a trèi coutse. Doe, salle iaou son itaouloù Casimir é Geromine, son bièn seumple é protso n'a maque doe caèye é doe \textsl{tables de nuit}; i contréo, la trèijima coutse (a gotse), salla de la personna eumpourtanta (l'aristocrate), l’è d’ott\'on, avouì eun queusseun de sèya é eun \textit{couvre-lit} avouì le frandze. Acoutì n'at eunna comodda poltronna é eunna \textit{table de nuit}. Pe completì la \textsl{scénographie}, i fon di palque n'a dou-z-armouére eun feur, eun pourtamantì é eun grou fondal avouì eunna pourta i mentèn.\\ L'aristocrate l’è catchà déz\'o le queverte é l'è eun tren de drimì. Geromine l’et eun tren de fé lo tsaous\'on é lo vioù l’et eun tren de lie lo journal avouì le lenette ba desì lo na.}
...
\Gerominespeaks Si pi praou coudzia. Mi mé sensa mon courtì é le dzeleunne \gallina\ de mé si perdiya!

\Casimirspeaks \direct{Euntre lli} Eunna pi, eunna mouèn\ldots

\Gerominespeaks N’i pa comprèi\ldots senque t’a deu?

\Casimirspeaks Ren, ren! Diavo maque que te pouave te le porté inque avouì té! O\-mou\-en\-te n’ario magà pouì féye de nouo discour avouì caqueun. Le-z-aoue comenchon itre londze seuilla dedeun\ldots é lo spettacllo l’et todzor lo mimo \direct{avouì lo dèi moutre \deidreite\ Geromine} é ta viya la si perqueue: l’è chouì cou que te me la conte!

\Gerominespeaks Te pense que a mé fiyisse plèizì restì seuilla avouì eun rabadàn comme tè? Surtoù veure, can te tsandzon le fise, eun mous\-tre patanì pi é ouse, blan comme lo lasì é sensa pamì ren de euntéressàn pe le femalle.

\Casimirspeaks Mag\^a pe de femalle comme té! Se le femalle que travaillon seuilla son jantile maque avouì mé n’aret eunna rèizón! \'E té te fa pa itre dzalaouza! \'E aprì resta maque tranquilla, itsaouda-té pa\ldots piatro te pren eugn atro \textit{infarto}!

\Gerominespeaks Mé ara resto adì bièn é si pa senque baillerio pe itre eun campagne.

\Casimirspeaks Ouè fa beun diye que s’en eun trèi malado eun tsambra é l’atro \direct{moutre la personna eumpourtanta} l’a panco t’an prédjà.
...
\StageDir{Se rèche l'aristocrate que l’ie eun tren de drimì. Se derèidì é aprì pren lo campaneun \campanellino\ pe queryì son valet.}
...
\StageDir{Lo vioù, que l'a vi la \textit{scène}, l’a i fon de la coutse le queverte que lo toppon pa totte. Ad\'on pe pa trebelì proue a se fé èidjì.}

\Casimirspeaks Gaston! Squezade Gaston! 

\StageDir{L’eunfeurmì fé semblàn de ren. Lo vioù tourne lo criì eun vouaillèn.}
...
\StageDir{Pe la pourta i fon di palque entre eun prée avouì la Bible eun man.}

\Priespeaks\direct{Eun fièn la croueu} Bondzor a tcheutte.

\Casimirspeaks Bondzor Monseur.

\StageDir{Lo prée s'aprotse a Gaston que l'iye eun tren de poulitì le-z-onlle de l'aristocrate.}

\Priespeaks Mesieu\ldots

\Eunfeurmispeaks Ouè.

\Priespeaks Qui l'è lo pi vioù é pi maladdo seuilla?
...
\Priespeaks \direct{Eun lèi prédzèn comme fuse eun pouo matasse} Mesieu, com\-me la demando-me voutra fameuille si vin-ì vo saliì pe lo dérì cou.
...
\Priespeaks Mesieu, si pa se v'ouèide sentì que no fa refé lo tette de l’éillize. Se vouillade pouade baillì eunna man eunc\'o vo.

\Casimirspeaks Na mé n'i dza baillà praou i  ten de mé.
...
\StageDir{Lo prée va ver l'aristocrate.}
...
\StageDir{Gaston to todzèn tsertse de réchì lo mesieu.}
...
\Eunfeurmispeaks Va bièn, comme vouillade.
...
\StageDir{Gaston baille i prée le dou tri que l'a prèi pe lo bourset.}
...
\StageDir{Lo prée fé la marca de la croueu é chor.}

\scene[-- Ferrari \ferrari\ poulisie]

\StageDir{Entron trèi femalle di poulisie: son arbeillaye avouì eun tone rodzo de la Ferrari. Eunna avouì l'icaoua \scopa , l’atra avouì de prodouì pe poulitì é la dériye avouì eun patrasse.}
...
\FennepulisieCspeaks Sen itaye coudziye. Diyon que lo maladdo se te lèi prèdze sa lenva se queutte bièn pi alé.

\Casimirspeaks Ouè, ouè fran pèi!

\StageDir{Entre lo cape avouì eun cronomètre \cronometro\ é eunna bandjèira a car\'on blan é ner (salla que emplèyon pe le compétich\'on di machine).}

\Starterspeaks Sah, sah, ad\'on v'ouite tcheu preste? Beut\-ta\-de-v\'o totte eun reugga, eunc\'o té!

\FennepulisieAspeaks Mi vouè, resta tranquilo. Oueu si plèin-a d'é\-ner\-jì!
...
\FennepulisieCspeaks Pensa que salla poura matassa perdave de ten a poulitì tcheu le cassette!

\FennepulisieAspeaks Bondàn ézajér\'o! L’ayè panco comprèi comèn mar\-tse seuilla dedeun. Djeusto la mandì i mitcho!

\Starterspeaks Bon perdèn pa de ten, prest? Trèi, dou, eun\ldots Via!

\StageDir{Lo cape fé partì lo cronomètre é sopatte la bandjèira \bandiera\ pe l’er. Le femalle totte a galoppe pouliton lo pi vito poussiblo. Saouton d’eun coutì a l’atro de la tsambra é, eun mimo ten, tsanton é danchon, avouì finque le dou vioù, la tsans\'on:}

\sound{https://soundcloud.com/user-234168361/di-congo-pe-travailli}{Di Congo pe travaillì - Le Digourdì}

\StageDir{Can la mezeucca fenèi, se plachon protso de leur cape.}
...
\Starterspeaks Ara vo béyade maque eun bon Gatorade pe eunna\ldots
...
\Starterspeaks \ldots é lo Champagne \champagne\ v'atèn pi defoua!
...
\Eunfeurmiespeaks \direct{Eurle avouì acsàn tédesque} L'oréo di vezeutte comen\-che ara!

\Eunfeurmispeaks Sht! Te vèi pa que lo Chef de mé drime!

\Eunfeurmiespeaks \direct{Arroganta} Me euntéresse pa, sitte l'è lo répar de mé é fiyo sen que n’i voya!

\Eunfeurmispeaks \direct{Eun moutrèn l'aristocrate} Avouì llou séilla véyèn pi tan\-que can!
...
\Eunfeurmispeaks Mah, lèi dzouyeriyo pa lo mitcho.
...
\Gerominespeaks Sen pamì tan dzoueun-o mi n’en praou de sentì eun cou pe comprendre senque no dion.

\Casimirspeaks Ah se l’è comme totta la senâ vou cheur pa me lagnì avouì to si mondo que veun me trouvì.

\Gerominespeaks Comprègno beun perqué t’a pa gneun. T’i gramo com\-me eun pet.
...
\Gerominespeaks Avèitsa qui se vèi! Ad\'on te sa qué que t’a eunna mamma?
...
\StageDir{Se baillon eun poteun. Josette s'achouatte si la caèya protso de la coutse.}

\Feliespeaks Can mimo to bièn? Comèn se reuste seuilla?

\Gerominespeaks \direct{Avouì eun ton ironique} Se reste bièn. L’è caze eun o\-ber\-dze. Si poste seuilla ara l’a maque trèi-z-itèile \stella\ pequé la catrima l’an djeusto gavou-la. \direct{Avèitse Casimir ironiquemàn} Aprì la compagnì l’è fran dzenta! Fiyèn de salle riaye é de salle fite que avèitsa!

\Feliespeaks S’i fran contenta. Ad\'on t’a fran fata de ren? Mé n'i pensoù de pourti-te an bouite de biscouì.

\Gerominespeaks Oh mersì Josette. \direct{Avèitse la conféch\'on} Lo pri te pouave lo gavì!

\Feliespeaks Ah ouè n’i oublià! Squeza-mé!

\Gerominespeaks Pe $0.80$ santime t’aré cheur atseutou-me de biscouì \biscotto\ bièn bon!

\Feliespeaks Mamma n’ayè l’offre a la LIDL é pouèi n’i fé que spendre an mia de pi pe atsetì doze conféch\'on.

\Casimirspeaks Seutta l’è cheur ta feuille!
...
\StageDir{L'eunfermì, avouì eun cabaré d'ardzèn, lèi pourte eun \textit{cracker}. L'aristocrate lèi baille eunna mordiya é tourne lo pouzé desì lo cabaré. L'eunfermì beutte tourna totte eun caro.\\ Entre lo medeseun.}

\scene[-- Medeseun Mitcho \casa]

\MedMitchospeaks Bondzor a tcheutte!

\Eunfeurmispeaks  Bondzor mesieu! L'è arreuvoù Doctor House!
...
\MedMitchospeaks Voualà lèi sen caze madama! Dou ou trèi dzor é vo mando i mitcho.

\Gerominespeaks Ouè l’è devendro é vo èi dza deu-me seutta baga demarse!

\MedMitchospeaks Me diplì mi voutra préch\'on monte é bèiche tcheu le momàn; é aprì avouì an feuille pai penso que vo féyo pi restì eunc\'o seuilla doe ou trèi senâ.

\Gerominespeaks Ah! Restade maque tranquillo que vo èi vi-la oueu é la vèyade cheur pamé a me trouvì!

\Casimirspeaks Pa deutte\ldots l’a eunc\'o onze conféch\'on de biscouì a fi foua!
...
\StageDir{Geromine fé totte sen que lèi di lo medeseun é, dimèn que ivre é cllou le man, lo medeseun nen profite pe fé lo fleungàn avouì Josette.}

\MedMitchospeaks\direct{Ver Josette, bièn malisieu \malisieu} Ad\'on squezade, mi queun l'è voutro non?

\Feliespeaks Si Josette, plèizì!

\MedMitchospeaks Oh Josette! Mé si House! Medeseun House, mi cri\-à\-de-me maque Mitcho; é diade-mé, an fenna dzenta comme vo senque fé? Queun travaille fé?

\Feliespeaks Si dirijanta eun Réj\'on.

\Gerominespeaks\direct{Eunfastedjaye \malechaa} Va bièn pouèi medeseun?
...
\StageDir{Geromine conteneuvve a clloure é ivrì le man avouì le joueu cllou\-jì. Lo medeseun Mitcho reprèn a martélé Josette.}
...
\StageDir{To d'eun creppe, entre eun maladdo \textsl{psychiatrique} que, eun trambélèn, eurle:\og Tchouf, tchouf! Tchouf, tchouf!\fg . Aprì eun per de seconde doe eunfermiye entron i galoppe, fan eunna pouenteua i pasiàn ià de tita, l'eumbrancon é lo teurion foua de pèise. Dimèn medeseun \textit{House} tranquilize Josette é Geromine.}
...
\Casimirspeaks Que drolo! La feuille que l’è seuilla protso l’è dza eun mo\-màn que l’è arrevaye é penso fran que sise sen!
...
\MedMitchospeaks Lèi manque eunc\'o finque lo \textit{Viagra}, pai te me stchop\-pe comme eun pallontcheun! Sa, ara ivrade la botse\ldots

\StageDir{Avouì eunna lemiye medeseun Mitcho avèitse dedeun la botse de Casimir, mi teurie vitto eun déri la tita.}
...
\MedMitchospeaks Demàn mateun lèi baillade eunc\'o eunna dzenta frotaye. Ara teriàde-vo si.

\StageDir{Casimir, avouì an miya de difficult\'o, se beutte achouatoù si la coutse.}

\MedMitchospeaks Teriade si la flanella\ldots
...
\MedMitchospeaks Lèi sen caze. Sel\'on mé, se vouillade eunna tosse tchi\-ca pi sètse vo consèillo de passé de trèi a dou paquet de \textit{trinciato} pe dzor!

\Casimirspeaks Voué, va bièn medeseun, comèn vouillade vo.

\MedMitchospeaks Aya le tsambe é aprì n'en fenì. 

\StageDir{Lo medeseun fé lo tor de la coutse é se plache devàn Casimir. Avouì eun martelette \martello\ léi baille eun crep deur desì lo dzegnaou, mi Casimir levve eun bri; lo medeseun lèi baillie eugn atro crep mi, comme douàn, Casimir levve lo bri. Dimèn Josette avouì la squiza de beté eun plase la coutse de la mamma se fé avèitchì lo qui di medeseun, que, distré, baille eun creppe de martelette si la tsamba de Casimir. Lo pouo Casimir réajèi eun terièn eun caouse i bale di medeseun que, souffràn, tsi pe tèra.}

\Feliespeaks \direct{Eun galoppèn vitto ver lo medeseun} Medeseun, medeseun, v'ouite fé-vo de mou?

\MedMitchospeaks  Na, na, tot a poste! Tracachade-v\'o pa. 

\StageDir{Josette tourne protso de Geromine.}
...
\MedMitchospeaks Gneun problème. Passo pi mé pi tar. Ah, djeusto eun\-na bagga: va-tì bièn la coutse que n’en beuttou-lèi protso de la fenitra? Sade, lamen fére contèn noutro pi eumportàn cliàn.

\Eunfeurmispeaks Ouè, fran amoddo! De seuilla vèi bièn lo Mont-\'Emilius que llu lame da mat.
...
\MedMitchospeaks\direct{Ver Casimir} Bon ara me nen vou. Mogà tourno pi tar pe eun dzen \textit{clistere}! \direct{Avèitse la dzenta feuille} Vo\ldots v'ouèide eunna beurta grima, vo vèyo an mia blaye. Pe mé v'ouèide fata d'eunna pégna vezeutta.

\Gerominespeaks A mé semble pa: l’è todzor igalla.

\Feliespeaks Mamma mé vou vère. Vourriyo jamì que aprì me sento mal djeusto foua de l’opetaille. 

\Gerominespeaks Josette fé attench\'on!

\StageDir{Josette baille dou pouteun \bacino\ a la mamma é chor avouì lo medeseun.}

\Gerominespeaks \direct{Eugn avèitsèn lo medeseun} Té pren-te varda!

\MedMitchospeaks \direct{Eun chortèn avouì Josette} \textit{Au revoir} a tcheutte!

\StageDir{Josette é medeseun Mitcho chorton.}
%\newpage
\scene[-- Lo motchaou]

\StageDir{Lo vioù pren eun motchaou desù sa \textsl{table de nuit} mi lèi tsi pe tèra. Pe lo prendre se dèi caze cayì pe tèra. L’eunfermì, que l'a vi amoddo la \textit{scène}, baoudze pa eun dèi. Lo maladdo pren lo motchaou eun se lagnèn é a fose se souffle lo na.}
...
\Eunfeurmispeaks Oh\ldots fran eunna dzenta soufflaye! V'ouèide caze reumpli-lo!

\Gerominespeaks Na, mi se pou pa itre fagnàn pouèi?

\Casimirspeaks Ouè, l’atro l’a caze fé-me moueure pe coillì lo motchaou é avèitsa avouì sit ommo senque l’a fé? 

\StageDir{Dimèn l'eunfermì arendze l'atchaou di queseun a Gaston.}

\scene[-- L'aoua de maènda]

\StageDir{Entre l’eunfermiye avouì  eun per de platte, vèyo é fourtsette de papì.}

\Eunfeurmiespeaks L’oréo di vezeutte fenèi ara! La maenda l’è caze pre\-sta. \direct{Ver Casimir é Geromine} A vo lo plat é le fortsette de papì.
...
\Gerominespeaks La mia l'iye eunna demanda\ldots diavo pe riye\ldots mondje!

\Casimirspeaks Qui areuvve pe no baillì medjì?

\Eunfeurmiespeaks Areuvve ara Fernanda vo servì. \direct{Ver l'eunfermì} Pe llu \direct{avouì la tita moutre Gaston} areuvve eunc\'o lo menù spésial. \textit{Au revoir}!

\StageDir{L'eunfermiye chor.}

\Casimirspeaks\direct{A Geromine} Mé medjì seuilla dedeun lamo ren!

\Gerominespeaks A qui te lo di!

\Casimirspeaks Me semble de itre a eunna de salle fite di Pro Loco.
...
\StageDir{Jénérique de:}

\sound{https://soundcloud.com/user-234168361/extrait-de-il-pranzo-e-servito}{Il pranzo è servito - Augusto Martelli}
...
\StageDir{Casimir alondze lo bri pe pasé la pillule a Fernanda, mi malerezamente lèi tsi pe tèra. Fernanda lo reprodze eun lèi baillèn, avouì la potse, eun crep desì lo djise.}

\Fernandaspeaks Mi Casimir! T’a fé tchire la Polenta é fricand\'o! 

\Casimirspeaks Ouè é té t'a to rempli-me de puré!

\Fernandaspeaks \direct{Eun perdèn la pachense} Ouè, ouè. Ad\'on v'ouèide desidoù senque vouillade medjì? N'i pa de ten a pèdre!
...
\Fernandaspeaks Eunc\'o eunna potchà! N'i pa voya que aprì te va i mi\-tcho é te di que Nanda te baille pa prao medjì!
...
\Fernandaspeaks\direct{Eun se poulitèn le mandze é le lenette} Mersì madama!
...
\Fernandaspeaks Voualà é se v'ouèide eunc\'o fan criade-mé!
...
\Gerominespeaks L’è pi caze satte dzor que meudzo so é tcheu le dzor l’a caze eun gou nouo.
...
\StageDir{Entre eun tsambrì tot élégàn é va ver l'aristocrate que i mimo ten se beutte comoddo si la coutse. Gaston lèi refèiche le lenchoueu.}

\Tsambrispeaks Bondzor a tcheut! Bienvenù a l’opetaille moderno. Sen\-que vouillade medjì oueu?

\PersEmpourtantaspeaks Senque v'ouèide?

%\newpage
\Tsambrispeaks \direct{Pren lo menù é li} Lo chef vo propoze, comme \textit{entré}:
...
\StageDir{Le dou vioù s’avèitson amoddo é areuvon pa a comprendre \confuso.}

\PersEmpourtantaspeaks Na, na\ldots lèi sen pa. Mé vouillavo eunna \textit{bourguignonne}!

\Tsambrispeaks \textit{Bourguignonne}, n'a gneun problème. V'apresto tot\-te!
...
\StageDir{L'aristocrate di de ouè avouì la tita. Lo tsambrì levve lo topèn é s'aprotse a la coutse, mi malerezamente s'euntsambotte é vouidze to l'ouillo bolequèn desù l'aristocrate. Le dou vioù, dimèn que l'aristocrate braille di mou, s'avèitson é se fan an dzenta riaye.}
...
\MedMitchospeaks\direct{A Geromine} Ad\'on oueu l’è lo dzor! Fiade voutre valize que vo mando i mitcho perqué si cou l’è totte eun plase. Saliade-mé la feuille!
...
\MedMitchospeaks\direct{A Casimir, itèn bièn louèn pe pa sentre son flo} Itade-mé bièn eunc\'o vo.
...
\Gerominespeaks Ouè, fé maque lo feun, pouèi demàn t'i tourna seuilla!

\Casimirspeaks\direct{Eun desuèn la vouése de Geromine} T'i torna seuilla! Te tsandze pa té!
...
\Casimirspeaks Te tsandze jamì le batiye?
...
\Gerominespeaks\direct{A l'aristocrate} Te queutto la bouite di biscouì, pouèi te le meudze\ldots ouè, can t'areuve pi a le medjì!
...
\StageDir{Geromine teurie foua eun motchaou é lo pourte i na de l'ari\-stocrate.}
...
\centering
\whiteshadowbox{
\includegraphics[height=5.5cm,keepaspectratio]{Foto/2009/1S9D0171.JPG}
}
\end{figure}
\vfill
...
\centering
\whiteshadowbox{
\includegraphics[height=5.5cm,keepaspectratio]{Foto/2009/1S9D0137.jpg}
}
\end{figure}
...
\centering
\whiteshadowbox{
\includegraphics[height=5.5cm,keepaspectratio]{Foto/2009/a.jpg}
}
\end{figure}
\vspace*{\fill}
\end{drama}