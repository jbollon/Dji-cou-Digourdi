...
\fotocopertina{Foto/2013/gruppo.jpg}{Ester Bollon, Giada Grivon, Marco Ducly, Simone Roveyaz,\\ Ilaria Linty, Laurent Chuc, André Comé, Pierre Savioz, Jordy Bollon}{Sophie Comé, Jasmine Comé, Jo\"{e}l Albaney, Jo\"{e}lle Bollon,\\ Francesca Lucianaz, Paolo Cima Sander, Stephanie Albaney}{2013}

\LinkPiese{Matte\ldots sen tcheutte matte}{https://www.youtube.com/watch?v=AKkdx5w1Mdk}{.75}{.75}
...
\item[$\bullet$] 1 bal\'on d'éponje pe le mèinoù;
...
\centering
\whiteshadowbox{
\includegraphics[height=5cm,keepaspectratio]{Foto/2013/0.JPG}
}
\end{figure}
\vfill
...
\centering
\whiteshadowbox{
\includegraphics[height=4.5cm,keepaspectratio]{Foto/2013/1.JPG}
}
\end{figure}
\vspace*{\fill}
...
\centering
\whiteshadowbox{
\includegraphics[height=4.5cm,keepaspectratio]{Foto/2013/2.JPG}
}
\end{figure}
\vspace*{\fill}

\setlength{\lengthchar}{3.00cm}
...
\Character[GUILLAUME]{GUILLAUME}{Guillaume}{Imitach\'on de \href{https://it.wikipedia.org/wiki/Enzo_Miccio}{Enzo Miccio}, prézentateur de la trasmech\'on \href{https://it.wikipedia.org/wiki/Ma_come_ti_vesti\%3F!}{\textit{Ma come ti vesti?!}}, \name{\\Laurent Chuc}}

\Character[CHÉRIE]{CHÉRIE}{Cherie}{Imitach\'on de \href{https://it.wikipedia.org/wiki/Carla_Gozzi}{Carla Gozzi}, prézentatrise de la trasmech\'on \textit{Ma come ti vesti?!}, \nameF{\\Francesca Lucianaz}}
...
\Character[SPÉRANCE]{SPÉRANCE}{Sperance}{Dzouveunna grasieuza mi bièn déterminaye a gagnì lo queur de Tanteun, \nameF{\\Stephanie Albaney}}

\Character[TWITTER]{TWITTER}{Twitter}{Gars\'on eumpestoù é vichà, botcha de Alice é Tanteun, \name{Marco Ducly}}

\Character[TANTA FINE]{TANTA FINE}{Tanta}{Imitach\'on d'eunna \textit{babysitter/tata} de la trasmech\'on \href{https://it.wikipedia.org/wiki/SOS_Tata}{\textit{SOS Tata}} que eunsègne comèn terì si le bo\-tcha, \nameF{Ester Bollon}}

\Character[\hspace*{1cm}]{nb}{pippo}{\hspace*{1cm}}
...
\centering
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2013/3.JPG}
}
\end{figure}
\vfill
...
\StageDir{\textsl{Lemiye} \lemieSi\ a gotse di palque, iaou acapèn eun vétchot achouatoù si eun chofà. L'è eun tren d'atendre son meillaou amì.}
...
\StageDir{Auguste s'avèitse a l'entor é comenche a baillì de pégno creppe i solàn é i meur.}
...
\Vioupspeaks Lo mateun, can van travaillì, se euncrouèijon salla que galoppe pe lo plan d'Ampaillan, ad\'on son tranquilo de teumbré eugn oréo; can, i contréo, la euncrouijon i Fossà, son belle que tracachà!

\Vioujspeaks Ah!\direct{Eun moutrèn eun poueun douàn lli} Belle dzen lo nouo cadre que t'a pendì i meur.
...
\StageDir{Joseph teurie foua eun grou sidel de Popcorn é lo baille a Auguste. Aprì aleumme la télévij\'on. Can s'aleumme, la lemiye é le couleur son tellamente forte que Auguste dèi clloure le joueu!}
...
\Vioujspeaks Oh ouè! Ara ouè, fran dzen! Mi\ldots n'at eunna émich\'on que comenche? Senque l'è?
...
\Vioujspeaks\direct{Douteu, eun s'avèitsèn le pateun} De pantal\'on, ga\-neus\-s\'on, la tsemize é lo tsapì!

\Vioupspeaks Mi senque t'i eun tren de me diye té?

\Vioujspeaks M'arbeuillo pouèi mé!

\Vioupspeaks Mi na! \og Comèn te t’arbeuille?!\fg l’è lo non de l'émich\'on! Te sa beun senque l'è?

\Vioujspeaks Na! Mé avèitso pa seutte bague.

\Vioupspeaks \ldots é ad\'on dimanda touteun! Donque\ldots t'euspleuccon comèn t'arbeillì a la modda.

\Vioujspeaks N'i la fèi que t'avèitse pa tan chouèn seutta émich\'on. T'a to\-dzor le mimo dra de can t'ayè 20 an!
...
\StageDir{Eun scène n’a Chérie, Guillaume é eun manequeun arbeillà avouì eun dzen coteill\'on. Comme fondal n'at eunna tèila desì laquelle l'è proyettoù lo \textsl{logo} de la trasmech\'on.}
...
\Cheriespeaks L'an rèiz\'on le-z-amì de té! Mi ara alèn veure le pateun que l'at.
...
\StageDir{Chérie teurie foua eun cachiné\footnote{ \textit{\'Echarpe} eun fransé ou \textit{sciarpa} eugn italièn.}.}
...
\StageDir{Chérie teurie foua eun \textsl{foulard} blan.}
...
\StageDir{Alice pren lo \textsl{foulard} di man de Chérie.}

\Alicespeaks \ldots avèitsa te fiyo vère: can fé frette mé fiyo pouai\ldots

\StageDir{Alice moutre a Guillaume é Chérie comèn se toppe di frette: avouì lo \textsl{foulard} se fèiche la tita.}
...
\StageDir{Alice se vionde. Sensa pédre de ten, Chérie tappe ià lo \textsl{foulard}.}
...
\Cheriespeaks N'en cherdì pe té eun tissù de Paris: Louis de Cagnon!
...
\StageDir{Partèi eunna \textsl{vidéo} iaou Alice entre pe eun négose pe atseté de-z-arbeillemèn. Guillaume é Chérie, dimèn que avèitson la \textsl{vidéo}, dzeudzon sen que combin-e Alice\footnote{ Tanque a la feun de la proyéch\'on, le-z-ach\'on é le battiye de Alice icrite deun si teste son salle que lleu eunterprète deun la \textsl{vidéo}.}.}

\StartVideo{https://youtu.be/boRH83CCIPM}{Comèn te t'arbeuille?!}{

\Alicespeaks\direct{Eugn entrèn deun lo négose, ver la serventa} Bondzor, mé si l'amia de Chérie é Guillaume de \og Mi comèn te t'arbeuille?!\fg .
...
\Cheriespeaks Mi si lé l'iye dzen! \direct{Eugn avèitsèn la \textsl{vidéo}} \'E ara\ldots dzen sise peundeun, i mitcho nen n'i eun per igale\ldots
...
\StageDir{Feun de la \textsl{vidéo}.\newline}
}

\Cheriespeaks\direct{I pebleuque} Boneur que l'è arrevoù Guillaume! Vo rendade contcho comèn s'arbeuille salla fenna? Guillaume!
...
\Cheriespeaks Acoutta Guillaume, va veure deun lo poubleuque se n'a lo pappa de Alice, mogà l'a quetsouza a no deue.
...
\scene[-- Dou Sen Pée é eun saout\'on]

\StageDir{Lemiye a gotse \lemieSi .}
  
\Vioujspeaks Mi baillon-tì todzor seutta counta foula?

\Vioupspeaks Ouè, eunna counta noua tcheu le dzor. A propoù de counte\ldots é salla di Sen Pée? Avouì totte le dzi que trebeullon deun la viya é dèyon travaillì tanque a 70 an, pe lo premì cou deun l'istouére l'è all\'o lo Sen Pée eun pench\'on!
...
\Vioujspeaks Prèdza-mé pa de pench\'on! Avouì sise cattro tri que n'i areuv\-vo pa a la feun di mèis! Mi ara tsandzerèn le bague\ldots pequé mé baillo pi la vouése a sise di saout\'on !
...
\Vioujspeaks Comèn que n'en djeusto fé-le? N'isan fé-le, le bague sarian tsandjaye. Avèitsa si i Gouvernemàn: n'a todzor le mimo é lo Prézidàn de la Repebleucca\ldots tourna llou!

\Vioupspeaks Eugn éffé t'a beun pa tcheu le tor gneunca té.

\Vioujspeaks\direct{Eugn avèitsèn la télévij\'on} Can mimo\ldots la réclamme l'è fenia.
...
\Vioupspeaks Ah ouè n'i comprèi\ldots donque pe la diye avouì de paolle seum\-ple, ll'et eugn ommo que dèi chédre de fenne\ldots tchica comme i mar\-tchà di vatse. La prézentatrise l'è Marie de Feleunna, la blounda.
...
\StageDir{Lemiye \lemieSi\ si la drèite di palque.}

\StageDir{I mentèn n'at eunna poltronna eun pi, a gotse trèi caèye coloraye é a drèite eun tabouré de bouque. Comme fondal n'at eunna tèila desì laquelle l'è proyettoù lo \textsl{logo} de la trasmech\'on é la fotografiye de Marie de Feleunna.}

\StageDir{Entre Marie de Feleunna.}

\sound{https://www.youtube.com/watch?v=3i1OlH1e1go}{\textit{Uomini e Donne - Jénérique}}%\label{uominidonne}

\Mariespeaks Bonsouar a tcheut é bienvin-ì a la 43$^a$ é deriye émich\'on de \og Ommo é Fenne\fg! Oueu, noutro Costanteun, pe tcheut \og Lo Dzen Tanteun\fg, cherderè sa compagne de viya.

\newpage
\Mariespeaks  Ad\'on fien-l\'o to de chouite entré: Tanteun!

\sound{https://www.youtube.com/watch?v=3i1OlH1e1go}{Uomini e Donne - \textit{Jénérique}}[false]%\label{uominidonne}
\vspace*{-6pt}
...
\Tanteunspeaks\direct{Ver Marie} Aprì to lo ten pass\'o eunsemblo avouì totte le feuille que n’en cougnì sen arrevoù a la feun de seutta dzenta trasmech\'on. Te dèyo diye eunna bagga Marie: l'è fenì mon ten comme fleungàn!
...
\sound{https://www.youtube.com/watch?v=3i1OlH1e1go}{\textit{Uomini e Donne - Jénérique}}[false]%\label{uominidonne}

\StageDir{Di pebleuque pouye si lo palque Louise. Pèi rouze é avouì de tsambe eunna mia tro peluye, Louise fé lo défilé eun salièn tcheut. Louise prèdzerè todzor avouì eunna vouése déguizaye, bièn femminile.}

\Louisespeaks Bonsouar Tanteun, que dzen te reveure, fiyo pa d'atro que pensì a té.

\Tanteunspeaks\direct{Eunna mia digout\'o} Bonsouar Louise, \direct{ironique} si fran con\-tèn de te veure.
...
\Mariespeaks La secounda feuille l'è Alice: l'at 28 an, eumplouayé réjonalla é l'è bièn lamaye par noutro Tanteun. L'a maque eun petchoù problème: l'é pa tan bon-a de s'arbeillì. Ad\'on vièn sen que l'a fé, oueu lo nite, pe plère a noutro Tanteun. Alice! Entra!
...
\Tanteunspeaks\direct{Eugn avèitsèn to lo cor de Alice} Ouè, me semble que què\-tsouza l'è beun meilloroù!

\Alicespeaks Ad\'on vou m'achaté.

\StageDir{Alice s'achouatte protso de Louise.}

\Mariespeaks\direct{I pebleuque} Voualà, é ara la dériye feuille l'è noutra Spérance: lleu s'atèn pa de grouse bague de seutta trasmech\'on,  lleu vou maque eugn ommo pe bèye eun cafì de tenzentèn lo desandro ou pe fé de chortie caque cou. Ad\'on fièn entré Spérance.

%\newpage
\sound{https://www.youtube.com/watch?v=3i1OlH1e1go}{\textit{Uomini e Donne - Jénérique}}[false]%\label{uominidonne}
\vspace*{-6pt}

\StageDir{Di pebleuque pouye si lo palque Spérance avouì eun coteill\'on d'ipaou\-za. F\'e eun petchoù défilé é s'aprotse a Marie é Tanteun.}

\Sperancespeaks Bonsouar a tcheut, bonsouar Tanteun!

\Tanteunspeaks\direct{\'Eton-où} Bonsouar, mi comèn t'i ar\-be\-illaye?
...
\StageDir{Si la tèila l'è proyettaye la souaré amoureuza de Tanteun é Spérance: eunna romantinque sin-a i restoràn Monte Emilius.}
...
\Louisespeaks Mi Marie, t’a sentì comèn m’eunseurte? Acouta seuilla bel\-la! Mé si eunna patoille mi oumouèn n'i le bale pe deue sen que penso\ldots pa comme vo doe! Eunna reste quèya é l'atra se catse dérì eun grou-z-arbeillemèn blan!

\Alicespeaks  Louise! Rapella-té que pe prédjì maque pe baillì flo a la botse, l’è mioù resté quèi\ldots ou quèya; \direct{ver Spérance} é té planta-là lé de te arbeillì avouì sise patrasse blan. Pequé Tanteun pourteré mé a l’aouté\ldots avouì mon charme!

\StageDir{Spérance, offenchaye, se levve é s'apreste pe chotre.}

\Sperancespeaks Marie! Mé deun seutta condich\'on queutto la trasmech\'on. Me sento fran prèiza pe lo \textit{C}.
...
\StageDir{Le doe s'achouatton, mi conteneuvvon a tsacoté eun lévèn to\-dzor pi la vouése. Dimèn\ldots}
...
\StageDir{Alice é Spérance s'apersèison de la danse é queutton de s'euncheurté. Louise é Tanteun son todzor pi llatoù: s'avèitson, s'acarèson, s'eumbrachon\ldots Tanteun, dousemàn, bèiche le man é sare lo qui de Louise. A si poueun Alice é Spérance se levvon é divijon Tanteun é Louise.}
...
\StageDir{Tcheutte s'achouatton a leur poste.}
...
\Mariespeaks Praou! Praou! Praou! Ara l'è lo mo\-màn iaou noutro Tanteun dèi chédre sa compagne de viya. Tanteun te dèi to de chouite me baillì lo non de la premiye feuille de oueu lo nite.

\Tanteunspeaks\direct{Douteu} L'è defesilo\ldots senque diye. Donque\ldots comencheriyo avouì\ldots Louise.

\StageDir{Louise souspire, spéranseuze.}

\Tanteunspeaks Louise n'i porto-te seuilla perqué tsertsavo de bague nou\-e, diféente, mi si apersi-me que a la feun di contcho l'è fran la normalitoù sen que tsertso. Ad\'on pouì maque te diye que t'i pa la fenna pe mé.

\Louisespeaks \direct{Eun plaouèn} \'E beun Tanteun, te sa pa sen que te te per! T'i eunna grousa déluj\'on .

\Tanteunspeaks Touteun si beun que t'i pa eun gramo gars\'on, \direct{jèinoù\imbarazzatoo} eun\-na grama feuille! Mi t'a pa i de chanse, squeza-mé.

\Mariespeaks Louise, t’i restaye-lèi praou mal\ldots pren eun motchaou.

\StageDir{Marie baille son mo\-tchaou a Louise.}
...
\Sperancespeaks Mi Tanteun! Sel\'on té dze si arbeilla-me pouèi pe sen\-que? T'i fran eun mar\'on! 
...
\StageDir{Alice se levve émochon-aye.}
...
\StageDir{Lemiye \lemieSi\ a gotse.}

\Vioujspeaks Baillon de-z-émich\'on bièn euntellijante!

\Vioupspeaks Maleur, maleur! Deh, senque l'è salla réclamme?\direct{Eugn a\-vèi\-tsèn la télévij\'on} \`Eita ! To lo bouque que beurle\ldots ll'è eunc\'o eunna verdzasse \ldots é ara peuque eun bonb\'on. Mi senque fé? Levve la patta é\ldots pette?! 

\StageDir{Le dou stchoppon di riye.}

\Vioujspeaks Eunna verdzasse que pette!
...
\Vioujspeaks Ouè! Mi tsandzèn discoù:  n'i pamì sentì prédjì de salla counta de Corméyaou\ldots

\Vioupspeaks Queunta? Lo caille de La Saxe?

\Vioujspeaks Na\ldots salla que vouillon tsandjì lo non de la Quemeua eun  Courmayeur-Mont-Blanc.

\Vioupspeaks Ouè! Te sa pa la dériye: eunc\'o noutro Seunteucco l'a désidoù de tsandjì lo non de la Quemeua. L'a dimand\'o lo condjà i Prézidàn! Te sa comèn vou la queryì?
...
\Vioupspeaks\direct{Eun prégnèn la télécomanda} Avèitsèn sen que gnoue: Samsung!

\StageDir{Joseph gnaque eun bot\'on . Le dou saron le joueu pe lie.}

\Vioupspeaks Ara comenche \og Èidza-mé tanta\fg. \direct{Ver Auguste} Te sa sen\-que l'è?

\Vioujspeaks Na, avèitso pa seutte bague!

\Vioupspeaks Ad\'on demanda!\direct{Eun gnaquèn eun bot\'on} Samsung! Don\-que, eunna fameuille dispéaye\ldots dimande l'èidzo de tanta Fine. Té t'a comprèi quèichouza?
...
\StageDir{Lemiye \lemieSi\ a drèite, iaou acapèn doe table: eunna pe maenda é l'atra pe travaillì avouì l'ordinateur.  Comme fondal n'at eunna tèila desì laquelle l'è proyettoù lo \textsl{logo} de la trasmech\'on \og Èidza-mé Tanta\fg.}

\StageDir{A gotse de la \textit{scène} n'at Alice. Achouataye, se fé le-z-onlle é avèitse son mèinoù, Twitter, que djouye dézò la tabla. A drèite n'at Tanteun, atatchà a l'ordinateur, bièn eungadjà avouì lo traille. Twitter, botcha fran bièn eumpestoù, molle pa de fé de braillo é d'eunfastedjì pappa Tanteun.}
...
\Tanteunspeaks\direct{Malechà} Maladetto d'eun botcha eumpestoù! Va djouì i mentèn de la rotta réjonalla!
...
\Tanteunspeaks Tine? Na\ldots

\Alicespeaks L'a deu-me que son eun tren de tsertchì de bouye pe fé le seun\-tchiye de Cavalli. 
...
\Alicespeaks Mi na mon petchoù\ldots
...
\StageDir{Tanteun gnouye a icriye.}
...
\Tanteunspeaks \og \`Eidza-mé Tanta\fg! Voualà queun non l'at. Ara l'acappo si Google\ldots

\StageDir{Tanteun icrì eunna \textsl{e-mail}. Dimèn Twitter conteneuvve a lo eunfastedjì. Alice, i contréo, djouye avouì lli.}
...
\StageDir{Alice chor eun dzemotèn.}

\Alicespeaks\direct{Jantila} Bondzor, entrade maque.

\sound{https://www.youtube.com/watch?v=BEXJa_A7TZw}{SOS tata - \textit{Jénérique}}\label{tata}

\StageDir{Entron Alice é Tanta Fine. Fine l'è arbeillaye avouì eunna londze jupe bleuvva  é eunna djaquetta de la mima couleur. Avouì eun per de lenette si la poueunte di na, l'è bièn sérieuze é \textsl{autoritaire}. Deun eunna man l'at eun \textsl{dossier}, deun l'atra eunna baquetta.}
...
\Alicespeaks Mi na, l'è que mon pop\'on l'è tchica timido. \direct{Eugn alondzèn la man ver Twitter} Veun seuilla\ldots
...
\Alicespeaks Na, na, mé é mon ommo n’en pensoù de bailli-lèi eun non actuel, moderno!
...
\Tantaspeaks Vo fiade maque voutra viya de tcheu le dzor, mé me beutto pe eunna coueugne é can n'a caque bague que va pa \direct{avouì la baquetta lévaye} mé eunterveugno!
...
\StageDir{Twitter s'aprotse a mamma é Alice lèi baille lo \textsl{ciuccio}.}
...
\Tanteunspeaks Proua-lèi té a lo gavì!

\StageDir{Tanta Fine s'aprotse a Twitter, pren lo \textsl{ciuccio} é tsertse de teri-lèi-l\'o ià avouì bièn de forse. Twitter molle pa de saré le di. A si poueun, Fine lèi baille eunna baquétaye si lo qui.}

\Twitterspeaks Ahia!

\StageDir{Fine tappe ià lo \textsl{ciuccio}. Twitter comenche a plaoué.}
...
\Alicespeaks\direct{Eun braillèn} Todzor la mima counta deun si mitcho! Twitter l'è preste. \direct{Eunc\'o pi for} Twitter! Veun seu t'achouaté.

\Twitterspeaks Na n'i pa voya!

\StageDir{Alice areuvve pa a fée achouaté Twitter si la caèya; donque lo pren é lo plache pe tèra protso de la tabla.}
...
\Tanteunspeaks\direct{Eugn avèitsèn l'\textsl{écran} de l'ordinateur} Ouè\ldots
...
\Tanteunspeaks\direct{Eugn avèitsèn lo platte} Mi senque t'a combinoù seuilla? To\-dzor le mime bague. Senque l'è so?

\StageDir{Tanteun pren avouì le man eun \textit{Sofficino} é lo boueuche si la tabla. Di son l'è deur comme eun bèrio : probablemèn l'è pa it\'o praou didzal\'o . Tanteun, démoraliz\'o, tsertse de medji-lo.}

\Twitterspeaks Mamma! Cacca!

\Alicespeaks\direct{Dispéraye} Acoutta\ldots t'a lo Pampers, fé lé é ita tranquilo. 
...
\Twitterspeaks \direct{Dimèn que lèi teurie lo bouigno} Ahia, ahia, ahia!
...
\StageDir{Tanta Fine plache amoddo lo pispot dézò lo qui de Twitter.}
...
\StageDir{Twitter conteneuvve a fé de grouse grimasse. Alice é Tanteun son surprì.}

\Alicespeaks\direct{Ver Tanteun} Avèitsa! Noutro pop\'on !
...
\Tantaspeaks\direct{Eugn avèitsèn lo pispot} L'è eun per de dzor que caque pa!

\Alicespeaks Pouo noutro Twitter\ldots
...
\sound{https://www.youtube.com/watch?v=BEXJa_A7TZw}{\textit{SOS tata - Jénérique}}[false]%\label{tata}
...
\StageDir{Lemiye \lemieSi\ a gotse, iaou acapèn maque Auguste achouatoù si lo chofà.}

\StageDir{Entre Joseph.}

\Vioupspeaks Squeza-m\'e, mi seutta \textit{prostata} me fé to di lon galoppé i ben! Mi tracacha-t\'e pa que n'i to sentì lé achouat\'o . \direct{Polemique} Di-me té se n'a fata de eunna tanta que vegnise te diye comèn fa élevé ton mèinoù. Sen-tì pa matte?
...
\Vioupspeaks Ouè, n'i sentì seutta counta\ldots mi fa douàn gagnì le-z-é\-lé\-ch\'on !
...
\Vioupspeaks Mi na! Eun télévij\'on ll'è \og N'a de pousta pe té \fg ! Veun sé, tranquilo, achouatta-té.

\StageDir{Auguste, perplesse, s'achouatte.}
...
\sound{https://www.youtube.com/watch?v=D9oppHdF--4}{Love Theme - Barry White - \textit{Jénérique}}\label{pousta}
 
\StageDir{Lemiye \lemieSi\ a drèite. Comme fondal n'at eun \textsl{écran} desì loquel l'è proyettoù lo \textsl{logo} de la trasmech\'on. A drèite n'a catro caèye, a gotse eunna caèya é eun tabouré de bouque si loquel acapèn Marie de Feleunna. Can lo refrèn fenèi, Marie comenche a prédjì.}

\Mariespeaks Bonsouar a tcheutte é bienvin-ì a eunna nou\-a émich\'on de \og N’a de pousta pe tè\fg. Oueu lo nite n'en la conta de eunna fameuille que l’a de grou problème pe acapì eun traille a leur mèinoù. Perdériyo pa d'atro ten é dze fériyo to de chouite entrì la fameuille: Tanteun, Alice é le dou mèinoù: Twitter é Ipad.
...
\Mariespeaks Se me troumpo pa no sen vi-no caque-z-àn fé deun eunna de mé-z-émich\'on, vrèi?

\Tanteunspeaks\direct{Comme douàn} Ouè,  malerezemàn. Dèi si dzor l’è comenchà mon eunfer!

\Mariespeaks \'Ezajèra pa! T’a beun eunna dzenta fa\-meu\-ille, na?
...
\Alicespeaks L’è fran pe so que sen seu avouì té Marie, t’i noutra dériye spéranse. No n'en eun problème é no cougnisèn eunna personna que sel\'on no pouriye no baillì eunna grousa man, com\-me  l’a dza bailla-la a tan d’atre.
...
\StageDir{Si la tèila l'è proyettaye eunna \textsl{vidéo} iaou Geppino, lo posteill\'on de Marie, va eun beseclletta, dézò la plodze, a Palase Réjonal pe pourté a Turi Touneun l'eunvitach\'on a \og N'a de pousta pe té\fg. Tony assepte de partisipé a la trasmech\'on .}

\StartVideo{https://youtu.be/PEOtbdHbDv0}{N'a de pousta pe té}

\scene[-- La busta de Tony]

\Mariespeaks Fériyo to de chouite entré la busta. \direct{Eun bra\-illèn} Geppino! La busta!
...
\Mariespeaks Geppino, Tony l’a assétoù de vin-ì inque a\-vouì no?

\Geppinospeaks Ouè Marie, Tony l’a assétoù l'eunvitach\'on é l’è inque a\-vouì no. Vou lo queryì.

\sound{https://www.youtube.com/watch?v=D9oppHdF--4}{Love Theme - Barry White - Jénérique}[false]%\label{pousta}

\StageDir{Entre Turi Touneun. S'achouatte protso de Marie.}
...
\Mariespeaks Mi na! Lèi si mé inque, itade tranquilo. Don\-que\ldots te cougnì le riille di djouà?

\Turispeaks Na n'i jamì pouì vère.

\Mariespeaks Ad\'on, \direct{eun moutrèn la busta de bouque} in\-que no-z-ivrérèn  la busta é de l'atro coutì n'arè caqueun que vou vo prédjì. Vo itade quèi é acoutade. A la feun pouade lèi repoundre. To comprèi?

\Turispeaks Ouè, va bièn.

\Mariespeaks\direct{Eun braillèn} Geppino! Veun ivrì la busta!

\StageDir{Geppino entre avouì eun gars\'on pi ate de llou. Atatchà a la grousa busta de bouque n'at eun sec\'on pannel triangulère de bouque que toppe eunna fenitra. Lo gars\'on levve lo pannel é lèi plache déz\'o eun baquette de fas\'on que la busta reustise iverta. Pe mézo de la fenitra, la fameuille é Tony se vèyon pe lo premì cou.}
...
\StageDir{Silanse. Tony é la fameuille, de l'atro coutì de la busta, s'a\-vèi\-tson.}

\Turispeaks\direct{Eun prédzèn plan} Marie\ldots senque vouillon sise?

\Mariespeaks Shhht, itade quèi!
...
\StageDir{Turi pren lo téléfonne é queurie caquen.}
...
\Ipadspeaks Souplì Tony!\direct{Eun moutrèn Twitter} Lo pachento pamì si strumèn pe lo mitcho! Acappa quetsouza!
...
\Mariespeaks Can mimo mé si pa sen que vo diye. N'i jamì i eugn'émich\'on pouèi queurta. Mesieu Tony, vouillade le-z-am\-bra\-chì?

\Turispeaks Ouè, ouè bièn volontchì.

\Mariespeaks\direct{Eun braillèn} Geppino, vito! Veun vèi gavì seutta busta i mentèn di pià!

\sound{https://www.youtube.com/watch?v=D9oppHdF--4}{Love Theme - Barry White - Jénérique}[false]%\label{pousta}

\StageDir{Geppino é lo gars\'on dzouveunno pourton ià la busta. Tony eumbrache eun pe cou totta la fameuille. Turi l'è bièn sourièn é dzouze si momàn de télévij\'on pe se fé fé de fotografiye avouì totta la fameuille; i contréo, Tanteun é Twitter son malechà avouì llou.}
...
\Turispeaks\direct{Eun lèi pourtèn ià lo microfonne di man} Mi ouè, alé! Fiyo vito eun discoù!
...
\StageDir{Dimèn que Tony conteneuvve avouì son discoù vouido, di palque veugnon portaye ià totte le caèye. Dousemèn partèi eunna tsan\-s\'on; Tony s'avèitse a l'entor é réalize d'itre solette.}

\Turispeaks\direct{Dizorientoù} Mi seu\ldots mi seu se nen van tcheut\-te!
...
\StageDir{Totta la compagnì entre é attaque la \textsl{chorégraphie} de :}
...
\centering
  ...
  \centering
    \qrcode[hyperlink, height=0.5in]{https://youtu.be/HDjdC5LmlOk}
  \end{subfigure}%
%\vspace*{-5pt}
\end{figure}
...
\RoleNoms{\textit{Vidéo}}{André Comé}
...
\centering
\whiteshadowbox{
\includegraphics[height=5.5cm,keepaspectratio]{Foto/2013/4.JPG}
}
\end{figure}
\vfill
...
\centering
\whiteshadowbox{
\includegraphics[height=5cm,keepaspectratio]{Foto/2013/5.JPG}
}
\end{figure}
\vfill
...
\centering
\whiteshadowbox{
\includegraphics[height=5cm,keepaspectratio]{Foto/2013/6.JPG}
}
\end{figure}
\vfill
