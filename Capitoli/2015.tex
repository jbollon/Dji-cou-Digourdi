...
\fotocopertina{Foto/2015/gruppo.jpg}{\small Ilaria Linty, Paolo Cima Sander, Christian Brunod, Francesca Lucianaz,\\ Alain Yeuillaz, Tania Gianino, Elisa Viérin, Denise Borbey, Jordy Bollon,\\ Pierre Savioz, Ester Bollon, Jo\"{e}l Albaney, Aline Dalbard, Sophie Comé,\\ Giada Grivon, Jasmine Comé}{\small Marco Ducly, Valérie Marguerettaz, Laurent Chuc, André Comé,\\ Michel Squinabol, Jo\"{e}lle Bollon, Simone Roveyaz, Marlène Jorrioz,\\ Ilenia Squinabol, Federico Squinabol}{2015}

\LinkPiese{Disco Flama}{https://www.youtube.com/watch?v=MZ9IIh0Y5c8&list=PLBofM-NS_eLJUln45l7VH457fGak_Bk5O&index=12}{.5}{.55}
...
\item[$\bullet$] 2 pégne banquette de bouque;
...
\paragraph*{Costume} Di momàn que la pièse se deroule si trèi-z-acte deun lo ten (an '60, '80 é '90), le-z-arbeillemèn, le pereuque é lo maquiadzo seràn diffièn é coérèn avouì l'époque istorique reprézentaye.

\end{itemize}

\setlength{\lengthchar}{2.50cm}
...
\Character[WALTER]{WALTER}{Walter}{Eun pollentch\'on cost\'o di-z-àn '60, gran buveur, to\-dzor achouat\'o i ban é amì de Selmo, \name{\\Alain Yeuillaz}}
...
\Character[PINO]{PINO}{Pino}{Pappa de Vilma, tsarvensolèn di-z-an '60 que lame eustegué, tsertchì rize, \name{\\Paolo Cima Sander}}

\Character[\hspace*{1cm}]{pippo}{ll}{\hspace{1cm}}
...
\Character[DINO]{DINO}{Dino}{Piornats\'on é malereu di veladzo, a tsasse de dzen\-te feuille, \name{Jo\"{e}l Albaney}}
...
\Character[CUBISTA]{CUBISTA}{Cubista}{Danseuze professioniste di Disco Flama, \nameF{Sophie Comé}}
...
\Character[\hspace*{1cm}]{aa}{ff}{\hspace{1cm}}
...
\centering
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2015/0.JPG}
}
\end{figure}
\vspace*{\fill}
...
\centering
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2015/1.JPG}
}
\end{figure}
\vspace*{\fill}
...
\StageDir{\hspace*{2.5em}Lemiye \lemieSi\ si lo \textsl{proscenium}.}
 
\StageDir{\hspace*{2.5em}Laurent entre eun fièn le paolle crouijaye.}

\begin{drama}

\Laurentspeaks Avouì seutta nite dèyo pe fose fenì le paolle crouijaye\ldots satte ba\ldots \og Abile, actif, euntellijàn\fg\ldots Digourdì! Tchica com\-me no Tsarvensolèn.
...
\Laurentspeaks Le Pollentch\'on! Avouì noutra dzenta é grousa Becca-de-Noua devàn, l'è normal que prègnon pa lo solèi! Ara finalemàn sen arrevoù a la dériye; 26 ba: \og Quemeua protso de Tsarvensoù\fg\ldots Gressan! Na! Comenche avouì la p.
...
\StageDir{Lemiye \lemieSi\ si to lo palque.}

\StageDir{La \textsl{scène} prensipale l'è lo local istorique Disco Flama de Pollein, lleu de \textit{rencontre} di Pollentch\'on, iaou chouèn passoon eunc\'o de Tsarvensolèn.\\ I mentèn n'at eunna caèya ata, lo ban, eun lavandeun é eunna crédense avouì plen de botèille é de vèyo. A gotse, n'a la remiza di dra avouì de pourtamantì. A drèite, desì eun petchoù palque cllend\'o, n'a le-z-enstrumèn di joueur; protso di palque lèi son de banquette é lo caro pe danchì.}
\StageDir{Acapèn Gène, propétéo di local, é Dorina, la serventa. Dérì lo ban, Gène baille bèye i dzi. Deun la remiza di dra, Dorina beutte eun caro le palt\'o.
I ban n'at eun joueur é eun cliàn abituel (Walter, achouat\'o si la caèya). A drèite, achouataye si eunna banquetta, n'a doe feuille.}
...
\StageDir{Entre la \textit{claviériste}, salie le doe feuille achouataye é arite lo collègue de lleu que l'iye eun tren de fé maque de tapadzo. Proue lo \textsl{clavier}, riille l'atchaou di microfonne é proue sa vouése (eunna mia tro ata).}

\StageDir{Entre lo chanteur: tita ata é fier de lli. Eunna di doe feuille, can lo vèi, lo arite pe lèi dimandé eugn \textsl{autographe}.}
...
\sound{https://www.youtube.com/watch?v=md-k3_D08cg}{Let's Twist Again - Chubby Cheker}

\StageDir{Le doe feuille saouton si pe l'er é atacon a danchì. I ban, tcheutte bouéch\'on lo ten.}
...
\Dorinaspeaks Gène di pa pèi, te sa que mé me jèino! N'i mai betoù la premì baga que n'i acapoù pe l’armouére! Te lo sa que a la feun di coun\-tcho mé si eunna fenna bièn seumpla.

\Genespeaks Seumpla comme le pateun que t'a adosse.

\StageDir{Gène poulite lo ban. Acappe pa lo Scottex. De déz\'o lo ban (majiquemèn\footnote{ Noutro pouo Pierre Savioz l'è it\'o to lo premì acte déz\'o lo ban maque pe tapé si lo Scottex pe Gène!}) saoute foua lo Scottex.}
...
\Dorinaspeaks Walter! Resta quèi que t'i finque fianchà! \`Eita\ldots ara areuv\-ve Gemma é te fé pi pasé le voye.

\StageDir{Gemma se levve de la banquetta é, demì malechaye, tsemin-e ver Walter. Dimèn entre Selmo. Sensa diye ren saliye Dorina, paye l'entraye é se plache i ban. Gène lèi soum\'on eunna bira.}

\Gemmaspeaks Walter! Alèn? Mamma l'a deu d'itre i mitcho pe onz'aoue, pa pi tar.

\Walterspeaks	L'è eunc\'o vito, dèyo maque  bèye eunna gotta avouì Selmo que l'è djeusto arrevoù\ldots é aprì pouèn alé.
...
\Dorinaspeaks Beutto mé le dou Martini.
...
\StageDir{Dorina soum\'on le dou Martini.}
...
\Genespeaks Prèdza mai avouì mé. \direct{A Selmo, eun moutrèn Walter} Son 20 an que atseutto la fontin-a avouì son pappa é l'a jamì regalou-me ren!
...
\Kettyspeaks Comme de couteuma t’aré fé-la  malechì! L'è pa pousiblo Walter, tcheu le cou! Dèijoon no veure seuilla\ldots
...
\StageDir{Ketty se plache i ban pe comandé lo bèye. Selmo l'è rodzo comme eun pèivr\'on.}
...
\StageDir{Gène apreste le \textsl{cocktail}.}
...
\StageDir{Sensa remersì Selmo, Ketty pren le \textsl{cocktail} é s'achouatte si la banquetta avouì le-z-amie de lleu.} 
...
\sound{https://www.youtube.com/watch?v=WEl5nEU6ARg}{Piccola Katy - Pooh (Karaoke)}
...
\StageDir{Selmo tourne i ban ba de moral. L'è dispéoù. Le joueur comprègnon la situach\'on é désidon de soun-ì eun \textit{lento}.}
...
\StageDir{Dimèn areuvvon dou gars\'on de Tsarvensoù. Entron sensa paì.}

\Dorinaspeaks\direct{I dou Tsarvensolèn} Bonsouar! Pensade de payì?

\Pinospeaks	Mi fa eunc\'o paì a st'aoua?

\Genespeaks\direct{Totchà deun l'orgueuill, ver Pino}	Acrapì que t'i pa d'atro! Seutta l'è pa an crotta! Si si solàn l'an tsemià de dzi comme \direct{eun moutrèn le fotografiye} Petchoù Tony, Mike Bondzor\ldots pa\-ya\-de maque l'\textit{entrée}.

\Pinospeaks\direct{Eun bèichèn la crita} Va bièn ad\'on payèn.

\StageDir{Le dou Tsarvensolèn se gavon lo palt\'o, lo baillon a Dorina é payon l'\textsl{entrée}.}

\Pinospeaks\direct{A Dorina} Varda maque la resta.

\Dorinaspeaks Voualà le dou beillet, entrade maque ara.

\StageDir{S'avèitson a l'entor é van i ban.}
...
\StageDir{Lo chanteur fé seumblàn de comprende, s'apreste é baille l'a\-ta\-que i-z-atre joueur.}
...
\StageDir{Pino é Selmo se baillon ba. Eunterveugnon eunc\'o Geppino é Walter. Lo local ara l'è eun \textsl{ring pe boxeur}. Le vèyo s'icllapon, le caèye tsizon pe tèra é Gène avouì totta sa forse tsertse de pouchì foua di local Pino, Geppino é Selmo.}

\StageDir{Aprì eun per de seconde de poueun pe le coute é de patèle i dzoute, Gène tsache foua a piataye Pino, Geppino é Selmo. Walter tourne s'achouatté i ban.}
...
\StageDir{Gène, to pris\'o, pren de sou é paye le joueur. La \textsl{band} beutte eun secotse le sou é chor avouì le-z-eunstrumèn.}
...
\StageDir{La servietta saoute foua dèi dézò lo ban. Gène la pren é comenche a poulité.}
...
\StageDir{Lemiye \lemieSi\ si lo \textsl{proscenium}.}
...
\Taniaspeaks Lièn mioù l'articllo\ldots \textit{Festa del Peperoncino}! Seutta l'è  dzenta! L'è fran vrèi que a Tsarvensoù son maque bon a medjì de pépéron\-tcheun é bèye d'éve di distributeur.
...
\Laurentspeaks L'è mioù que no Tsarvensolèn organizisan de fite a la Grand-Place pitoù que vére le dzi catchà dérì le bouèiss\'on que binòcolon le feuille que se dezarbeuillon\ldots ou pitoù que vére sise de Pollein que dzouyon a Tsan eun \textit{serie} C!

\Taniaspeaks Grama lenva! \`Eitsa que no de Pollein n'en pi finque gagnà lo \textit{Championnat} de \textit{serie} A!

\Laurentspeaks Ouè si qué! Mi l'iye pe le-z-àn '80, 35 an fé, mersì i dzou\-yaou de Roulaz é de Feleunna! \'E te rapello que sise de Roulaz é Feleunna son de Tsarvensolèn!
...
\centering
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2015/2.JPG}
}
\end{figure}
\vfill
...
\StageDir{Lemiye \lemieSi.}

\StageDir{Sen todzor i Disco Flama, mi si cou sen pe le-z-àn '80. Acapèn Gène, dérì lo ban, é Dorina, protso de la remiza di dra, avouì 20 an de pi. Tcheu dou l'an le pèi blan. Gène, sourtoù, l'è bièn reillèn deun la jestch\'on di local. Pe bailli-lei eunna man, acapèn protso de llou Berta, sa feuille.}

\StageDir{Lo local l'è tsandjà reuspé a 20 an fé. A gotse n'at eunna tabla avouì trèi caèye rodze, a drèite, a la plase di banquette de bouque n'a de pégne poltronne é a la plase di joueur l'è plachà eun \textsl{jukebox}.}
...
\Vilmaspeaks A mé l’ariye deu-me que n’a la crize é de sou n'a pa.

\Vandaspeaks	A mé igale.

\Ornellaspeaks\direct{Eun moutrèn l'\textsl{entrée}} Avèitsade qui areuvve!

\StageDir{Entre Giulio. S'aprotse a la remiza di dra, paye lo beillet, baille la djacca a Dorina é s'aprotse i ban. Dimèn le trèi feuille conteneuvvon a tsaplétì.}

\Vandaspeaks	Mondje, que tipo, que gramo Pollentch\'on\ldots

\Ornellaspeaks	 \ldots é aprì blagueur, avèitsa que stat!

\StageDir{Vilma ite quèya é chouèn avèitse Giulio.}
...
\StageDir{Dimèn entre Dino. Paye lo beillet é se plache i ban.}

\Ornellaspeaks Ouè mondjeu! Mé que si totte, l’an finque deu-me que l’è it\'o opéroù can l'iye mèinoù.
...
\Vilmaspeaks Ara plantade-là lé pe dab\'on.  Se fran vouillade la savèi totta, vo la diyo totta: mé è Giulio son dji dzor que no no véyèn.

\Ornellaspeaks	 Té é Giulio, dji dzor que vo vo véyade?

\Vandaspeaks Mi t'i matta?

\Ornellaspeaks Se lo veun a savèi ton pappa, té te chor pamì pe catro mèis.

\Vandaspeaks Ouè cheur.

\StageDir{Dimèn Vilma avèitse Giulio. Le dou se sourion, s'avèitson a cats\'on, djouyon avouì leur joueu. Malerezamente, i mentèn de si djouà de regar é sourì, n'a Dino, que se beutte eun tita que Vilma l'è eun tren de lèi proué avouì llou. Di ban l'avèitse, man deun le secotse, preste pe partì a l'ataque.}
...
\Dinospeaks\direct{Eugn avèitsèn Vilma} \textit{Bella}! \direct{Eun mioulèn Gène} Beutta doe igale! Praou pai! Véo l'è?

\Genespeaks Son 500\ldots

\StageDir{Dino teurie foua le sou é le pouze si lo ban.}
...
\StageDir{Dino se plache pe eunna coueugne é bèi le doe \textsl{mentine}.}

\scene[-- L'è de mé]

\StageDir{Vilma déside que l'è lo momàn de s'aprotchì a Giulio. Partèi é va ver lo ban, mi, douàn de lleu, areuvve Berta.}

\Bertaspeaks\direct{Chalereuza, ver Giulio} Giulio! Comèn va?

\Giuliospeaks \direct{A Berta, eugn avèitsèn Vilma} Tot amoddo.

\StageDir{Giulio tsertseré todzor de clloure lo discoù avouì Berta pe s'acapé avouì Vilma, que, bièn eunfastedjaye, tsertse de lo queryì avouì de pégno pouteun, de sourì é de joueu douse. }

\Bertaspeaks Giulio senque t'i eun tren de fiye? Te lame ma noua maille?

\Giuliospeaks \direct{A Berta, eugn avèitsèn Vilma} Ouè, ouè dzenta!
...
\Bertaspeaks Acouta Giulio\ldots veun danchì avouì mé!

\sound{https://www.youtube.com/watch?v=g2eH5FSMsoc}{Tuca Tuca - Raffaella Carrà}

\StageDir{Ivron le danse Dino é Vanda. Avouì la squeuza di \textit{Tuca Tuca} Dino alondze tchica tro le man si Vanda que, sensa lèi pensé dou cou, rep\'on avouì eun per de patèle é piataye que spédèison Dino pe eun anglle.}
...
\StageDir{Le dou s'aprotson i ban.}
...
\StageDir{Berta caye eun panamàn si Vilma. Gène, chocoù, apreste dou nouo vèyo de gazeuza é i mimo ten tsertse de tsachì foua Berta.}
...
\Djouiyaoueunspeaks\direct{I compagn\'on} V'ouèi vi que pertse que n’i acapoù?
...
\Djouiyaoueunspeaks Me rappello, que riye si dzor! Dimanda eunc\'o a Gène\ldots
...
\Selmospeaks \direct{Eugn avèitsèn son gars\'on} Can mimo\ldots mé si pa senque vo diye. No n'en la caletoù pe le femalle. N'en de djette é bièn aloù que si arrevoù a lo passé i gars\'on de mé.
...
\Marteunspeaks\direct{Eugn avèitsèn Ornella} Salla avouì la maille a fleur\ldots
...
\StageDir{Selmo é Marteun passon douàn lo ban.}
...
\StageDir{Ornella sourì. Selmo pren pe man Ornella é Marteun é le pourte i mentèn di palque.}
...
\StageDir{Selmo gante la tita é se plache i ban.}
...
\Marteunspeaks \og Souffla-lèi pe le bouigno\fg t'a deu-me! Brao! Dzen con\-sè\-ille!
...
\Selmospeaks\direct{\'Emochon-où} Mi cheur! To de chouite! Me perdo pa si mo\-màn!
...
\StageDir{Selmo trame Giulio eunna mia pi louèn de Vilma. Dimèn entre Pino, pappa de Vilma. Se plache i ban pe bèye eun creppe.} 
...
\Pinospeaks\direct{Malechà} Senque t'a deu? Té te prèdze a salla baga \direct{eun moutrèn Giulio} lé pai! Avèitsa comèn l'è combin-où! Vilma se l'è maque pe lo non, n'en eunc\'o no-z-atre i Bournì eun Giulio que l'è ren mal!

\Vilmaspeaks Mi na pappa, mé vouì \direct{inamoraye, eugn avèitsèn Giulio} llou!

\Pinospeaks\direct{Digout\'o} Mi avèitsa eun que stat l'et! Comèn l'è arbeillà! Salla baga lé!
...
\StageDir{Gène pren eun boteill\'on de rodzo é lo régale i trèi djouyaou pe le tsachì foua di local. Le trèi lo prègnon contèn é chorton. Dimèn Dorina l'è alaye prendre eugn'icaoua pe ramachì le vèyo cllapoù.}
...
\begin{center}
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2015/3.JPG}
}
\end{center}
\vspace*{\fill}
...
\begin{center}
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2015/ff.JPG}
}
\end{center}
\vspace*{\fill}
...
\Laurentspeaks\direct{A Tania} Pensao\ldots l'a pa de sanse i dzor de oueu no fé la guèra euntre Valdotèn; l'a pa de sanse se fé la guera euntre vezeun.
...
\Laurentspeaks Ouè, dzenta idé! Pe eun discoù de collaborach\'on pourian fé pouèi\ldots mi eun tsandzo vo de Pollein no betade pe icrì que can noutro prée l'è maladdo ou l'è pa eun servicho veun si si de Pollein. Pouèi messa comenche eugn oréo, fenèi pi vito é n'en eunc\'o lo ten de bèye eun blan!

\Taniaspeaks Maque a so pensade!

\Laurentspeaks D'acor?

\Taniaspeaks Ouè! Mé n'i eugn'atra idì: senque te di se fièn la patse pe le montagne? Tsamolì, Martchaouchì\ldots comprègno pa pequé le Tsarvensolèn vardon salle de Pollein é le Pollentch\'on vardon salle de Tsarvensoù.
...
\Laurentspeaks\direct{Pa convencù} Mé diriyo\ldots fièn eugn atro discoù pe la Grand-Place. Pitoù que le spèize de manutench\'on, mé vo ba\-illé\-ri\-o a vo de Pollein l'oneur de fé si voutro territouéo\ldots l'o\-neur de fé la fita di pépérontcheun!

\Taniaspeaks Na! La fita di pépérontcheun vardade-vo-là! No l'è di-z-àn '90 que n'en la Grand-Place é de fite pouèi le vouillèn fran pa.
...
\StageDir{La streutteua de la \textsl{scénographie} l'è la mima, mi avouì eun per de tsandzemèn pe la rendre pi moderna: si lo ban l'è plachà lo sidel de la llase pe lo \textit{Champagne} é a drèite, iaou n'ayè lo \textit{jukebox}, n'at eunna danseuse é la \textit{consolle} di \textit{DJ}. Dérì lo ban, pendia i meur, n'a eunna fotografie de Gène.

Ara la propriétéa di local l'è Berta (feuille de Gène). A la remiza di dra n'a todzor Dorina, avouì dji-z-àn de pèi blan eun pi é eun per de \textit{decibel} eun mouèn. Achouataye li eun livro, mi eun réalit\'o, avouì de grou biicllo di solèi, l'è eun tren de drimì. Dérì lo ban acapèn Hélène, serventa di local. L’è minite é le premì cliàn dérian arrevé de sé a pouza.
...
\StageDir{Berta se gave lo palt\'o é lo baille a Dorina, que, mèitchà eundrimiya, lo pen i pourtamantì.}
...
\StageDir{Berta s'aproste i ban.}
...
\Helenespeaks\direct{Naif} Sayoù eun tren de lie lo journal.

\Bertaspeaks\direct{Malechaye} Hélène! Sel\'on té mé te payo pe ité inque a liye lo journal?
...
\Bertaspeaks N'i dza de-te-l\'o l'atra senà que te fayè atseté le fuste! Te lo sa que le botèille son bièn pi tchiye!
...
\Helenespeaks\direct{Eun moutrèn lo sidel si lo ban} Ouè, doe botèille i frique.
...
\Dorinaspeaks Pe fose que le dzouveuno i dzor de oueu reston malle pe de dzor. \direct{Mélanconique} I ten de mé, n'ayè pa totte seutte po\-tchaquiye. No béyaon todzor lo Vermouth! L'iye boun lo Vermouth!

\StageDir{Hélène tourne dedeun avouì lo \textsl{lime}.}

\Bertaspeaks\direct{Stouffie} Ouè Dorina, ouè.

\StageDir{Entron lo DJ é la \textsl{cubista}, que s'aprotse a Hélène pe ataqué a fé la counta.}
...
\Dorinaspeaks Malpoulite! Dibroilla-té maque que t'i dza eun retar é Ber\-ta l’è dza ajitaye é greundze.
...
\Bertaspeaks\direct{Ver Hélène é la \textsl{cubista}} \ldots é vo doe? Senque v'ouite eun tren de fiye?
...
\Bertaspeaks Hélène t'i todzor eun tren de pédre de ten! Planta-là li! Poulita si ban soplé!
...
\Bertaspeaks Mi Hélène! N'i deu-te que oueu l'è la dériye nite comme gars\'on pe Giulio!
...
\StageDir{Entron dou dzouveun-o, eun poumpa pe fé fita é s'amuzé. Galoppon drette i ban.}
...
\StageDir{Louis é Pierre queutton le palt\'o a Dorina é se plachon i ban.}
...
\StageDir{Louis paye é aprì rejouèn i ban  Pierre, que l'a dza tap\'o lo joueu si Berta é Hélène.}
...
\Louisspeaks\direct{A Pierre, entouziaste, eugn avèitsèn lo local} Que poste!

\Pierrespeaks\direct{Eun sourièn} Ouè, que dzen!

\StageDir{Louis vionde la tita ver la \textsl{cubista} é reste éton-où.}

\Louisspeaks\direct{Eun moutrèn la \textsl{cubista}} \`Eitsa que qui! \`Eitsa-l\'o!

\StageDir{Eunc\'o Pierre l'è eumpréchon-où, le joueu foua de la tita.}

\Pierrespeaks Mi senque l'a salla? Lo fouà i qui! \`Eita comèn danche! Belle se sen a Pollein, l'è dzen si local!
...
\StageDir{Pierre é Louis s'achatton si de pégno chofà a drèite di palque, dèi iaou pouon bièn veure totta la danse de la \textsl{cubista}.}
...
\StageDir{Berta, orgueilleuza, se viounde ver la fotografie de pappa Gène.}
...
\Bertaspeaks Ouè. Can mimo\ldots l'è dza belle tchica tar\ldots Giulio é le-z-amì de lli dérian pa tardì a arevì. Beutta eugn odre lo ban!

\Helenespeaks Ouè, ouè tracàcha-te pa.

\scene[-- Ouassa pe lo moteur]

\StageDir{Entron Giulio é trèi seun amì: Federico, Marco é Michel. S'apro\-tson i ban eun tsemièn tchica tose: son dza tcheu catro belle tsa.}
...
\Federicospeaks\direct{Eun se medzèn le paolle} Squeza-n\'o\ldots no sen arit\'o a fé benzin-a; pe sen que sen arrevoù eun retar.
...
\Federicospeaks Ouè, mi pa pi de \textit{super}! \direct{Eun tapèn son palt\'o a Dorina} Tchap\-pa so caramban-a!

\Dorinaspeaks A sentì l’èina que t’a, me semble pitoù que martsade a ouassa.

\StageDir{Michel dimèn paye l'entraye pe tcheutte.}

\Giuliospeaks Ouè Dory l’a belle rèizoun!\direct{Eun s'aprotsèn a Berta} Berta, eum\-bra\-cha-mé que oueu l’è ma dériye nite comme garsoùn!

\Bertaspeaks\direct{Digoutaye, eun se ditatsèn de Giulio} Ouè, ouè, acoutta, beut\-ta ba le man pe plèizì, soplé!

\StageDir{Le-z-amì de Giulio se plachon i ban.}
...
\Giuliospeaks Sayoon d'atre ten\ldots
...
\Federicospeaks\direct{Gadeun, eugn alondzèn le man} Sario prao mé sen que no baillì, mi maque a mé! 
...
\Michelspeaks \direct{A Hélène} Te sa pa senque l'è la Mimosa? L'è lo \textit{cocktail} di momàn! Mi iaou te viquèi?
...
\StageDir{Partèi la fita: Hélène pourte lo bèye, Berta counte le sou, le-z-amì fan santé pe la dériye nite de Giulio, la \textsl{cubista} ataque a danchì. Pierre é Louis lèi beutton eun per de beillette deun le pantal\'on.}
...
\Pierrespeaks\direct{A Giulio} Sotcho! Beutta-té eun quiya!
...
\StageDir{Eunc\'o Marco s'aprotse a la \textsl{cubista} pe baillì de coadzo a Giulio.}
...
\StageDir{Tcheutte braillon, levvon le man é danchon. Dimèn Berta s'a\-pro\-tse i DJ, lèi di quetsouza i bouigno é aprì chor.}
...
\Helenespeaks Vou la queryì to de chouite!

\Valletspeaks Vito! \direct{I-z-atre prézèn} Vo tcheutte, si le man é foua le documàn.
...
\StageDir{Tcheutte moutron avouì lo dèi Giulio, que dimèn l'iye aprotcha-se a la chortia.}
...
\Valletspeaks Ad\'on vegnade inque, que vo fiyo vin-ì eun devàn to de chou\-i\-te lo pequé.
...
\StageDir{Giulio ara l'è to llat\'o a la caèya. Le-z-amì se plachon dérì de lli, protso di ban. Tcheutte riyon eun silanse dimèn que lo squerse conteneuvve.}

\Valletspeaks\direct{Arroganta} Ita quèi! Eun manganel desì l'itseun-a t'a jamì tcha\-pou-lo?
...
\StageDir{Partèi eunna mezeucca \textsl{dance}. Lo vallet comenche a se dizarbeillì; vionde a l'entor de Giulio, lo acaresse.}

\Giuliospeaks\direct{Bièn pi relassoù} Ouélla!

\StageDir{Le-z-amì de Giulio, Pierre é Louis son électrizoù; l'an le man si pe l'er é dzouzon lo spettaclle.}

\scene[-- Totchì, mi pa avèitchì!]

\StageDir{Aprì eun bon momàn, la mezeucca se tchoué é lo vallet, avouì sa craotta, toppe le joueu de Giulio, que dimèn fricotte si la caèya.}
...
\StageDir{Entre eun \textit{trans} brazilièn: perruque roze, \textsl{foulard} rodzo, tsemize dzana, \textsl{jeans} é de grou pià que chorton foua di-z-\textsl{infradito}. La mezeucca tsandze pe créé eunna ambianse pi brazilienne. Lo vallet se plache i ban pe quetì la plase a Sami.}
...
\StageDir{La mezeucca bèiche. Sami s'achouatte desì Giulio é lèi prèdze avouì eunna vouése ata é femminile.}
...
\Michelspeaks\direct{A Giulio, eun fièn semblàn d'itre tracachà} Pensao que t'iye de l'atro djette!
...
\StageDir{Marco beutte le sou si lo ban. Dimèn Louis é Pierre se nen van eun salièn tcheutte. Federico nen profite pe s'achouaté si le poltronne protso de la \textsl{cubista}.}
...
\StageDir{Louis é Pierre son caze foua can  euncrouijon d'atre dou gars\'on: eun bièn ate é ipesse, l'atro base é méyo comme eun pioù. Lo petchoù, Paul, baille eun cou d'ipala a Louis. Louis se reveuriye, mi lo pi grou, Auguste, lo pouche contre Pierre.}

\Pierrespeaks Oh tchappa tchuque! Ad\'on!

\StageDir{Le catro (eun réalit\'o le trèi, Auguste contre Pierre é Louis) comenchon a se pouchì. Auguste l'è braamente pi for. Pierre é Louis se tramon ver la chortia, a tita ata, eun djabléyèn countre le dou mal polì.}

\Pierrespeaks Avèitsade vèi iaou betade le pià! Alèn ià Louis\ldots mi pensa té sise!

\StageDir{Paul é Auguste se plachon i ban.}
...
\Augustespeaks Dou Zibibbo.

\Paulspeaks\direct{Arrogàn, eun bouéchèn la man si lo ban} Fé-l\'o doblo!
...
Mé me rapello can n'i fitoù ma dériye nite de démouazella! Sen aloù si i sondz\'on di veladzo, pe eun pailleue\ldots
...
\Djspeaks Senque vèyon mé joueu! L'è arrevaye l'ipaouza\ldots é seutta tsan\-s\'on l'è totta pe vo! 
\newpage
\sound{https://www.youtube.com/watch?v=8DNQRtmIMxk}{Saturday Night - Whigfield}

\StageDir{Vilma, Ornella é Vanda atacon eunna danse de groupe. I ban Paul é Auguste bouéchon lo ten avouì lo pià. Michel, Marco é Federico tsertson d'alé dérì le pa de la danse que fan le trèi feuille.}
...
\Bertaspeaks Todzor mé que le payo! Mi iaou son fenè le-z-atre? \direct{Eugn avè\-i\-tchèn foua} Gars\'on vegnade! Vegnade dedeun. Si cou vo lo payo mé eun tor.
...
\Bertaspeaks\direct{Eun prédzèn i pebleuque} Qui l'arì jamì deu-lo que eun dzor Pollentch\'on é Tsarvensolèn l’arian betoù de coutì totte  leur discuch\'on é plantou-la li de tsacotì pe de counte foule\ldots va savèi tanque a can!
...
\StageDir{Tcheu le personadzo entron pe danchì. Le-z-atteur tsarvensolèn avouì eunna maille rodze avouì l'icrita \og Tsarvensoù pa de mioù\fg é sise de Pollein avouì eunna maille bleuvva avouì l'icrita \og Pollentchoùn le pi boun\fg. Ver la feun de la danse le Tsarvensolèn é le Pollentch\'on se divijon eun dou groupe, eun a drèite é eun a gotse di palque. Sembleria que sisan tourna preste a se battre é a tsacoté\ldots}
...
\RoleNoms{\textit{Chorégraphie}}{Jo\"elle Bollon}
...
\centering
\whiteshadowbox{
\includegraphics[height=5.5cm,keepaspectratio]{Foto/2015/4.JPG}
}
\end{figure}
\vfill
