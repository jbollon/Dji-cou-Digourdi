...
\item \textit{mise} a bilàn de la \og colach\'on\fg a Lugano \direct{avèitse Cima} de 2000 èiro; \StageDir{Tcheu repoundon avouì eugn \og Euh!\fg é avouì lo dèi lév\'o reprodzon Cima \dei ;}
...
\Dallasspeaks Chère Digourdie é cher Digourdì, conséillì Bollon, mi de senque v'ouite eun tren de prédjì! De fé le Simpson? Avèitsade lo pebleuque: pappa é mamma de mé san pa sen que son le Simpson; fa prédjì di bague de no-z-atre, de la Val d'Outa, de la poleteucca\ldots mogà pourian fé eunna pièse si noutra Prézidanta\ldots èitsade comme l'è dzenta!
...
\begin{enumerate}
	...
	\item avouì lo \textit{metal detector} eun djouyao di fiolet teurie foua lo beillette élettoral dèi déz\'o téra.
\end{enumerate}
}
...
\begin{enumerate}
	...
	\item eunna feuille ivre eun conjélateur é lèi troue dedeun Jordy avouì eun beillette élettoral eun man.
\end{enumerate}
}
...
\Brunospeaks \direct{A marlène é Jordy dimèn que la tèila veun teriaye si} V'ouèide tcheu dou fé eunna dzenta \textit{vidéo}. \direct{A Jordy} La voutra l'è fran dzenta\ldots \direct{a Marlène} mi la voutra l'è bièn pi dzenta ah ah ah!
...
\Jordyspeaks I Limonet n'en spendì 500 \textit{euro} de Prosecchi, 450 \textit{euro} de Spritz\ldots 1 \textit{euro} de Martini Blanc? \direct{Douteu \doute} Qui l'a bi de Martini Blanc? Voualà\ldots mi pe lo reste n'en pa terià foua eun sou!
