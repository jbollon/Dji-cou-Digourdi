...
%\vspace*{-0.5cm}
\LinkPiese{La vatse de l'universitoù}{https://www.youtube.com/watch?v=GhEbo6vx-xY&list=PLBofM-NS_eLJUln45l7VH457fGak_Bk5O&index=11}{.75}{.75}
...
\item[$\bullet$] 1 arieuza\footnote{ Lamèn la queryì eunc\'o trepeullalasì.};
...
\centering
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2011/IMG_2008.JPG}
}
\end{figure}
\vfill
\begin{figure}[h]
\centering
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2011/b.JPG}
}
\end{figure}

\setlength{\lengthchar}{2.5cm}

\Character[SAHLAM]{SAHLAM}{Sahlamm}{Maroqueun aourì de Tchièn, todzor avouì la baquetta eun man, \name{Paolo Cima Sander}}

\Character[PICCINA]{PICCINA}{Piccina}{Rèina di lasì, blantse avouì eun per de tatse maròn, lame sondjì é l'è salla avouì pi d'ichèn, \nameF{\\Jo\"{e}lle Bollon}}
...
\Character[SIMON]{SIMON}{Simon}{Gars\'on   de Tchièn é Iolanda, caze laoureoù, l'a pa tan voya de se pouertchì le man, \name{\\Laurent Chuc}}
...
\Character[CHEF\\ MOTTINHO]{MOTTINHO}{Chef}{Lo cape de l'équipe de vétérinéro,\\ \nameF{Ilaria Linty}}
...
\Character[\hspace*{1cm}]{df}{ff}{\hspace{1cm}}

\Character[VET. SCHULZ]{ SCHULZ}{Schulz}{Vétérinéro d'orijine tédesque, spésializoù deun la psicolojì de la vatse, \name{Marco Ducly}}

\Character[VET.\\ TRINCHERO]{ TRINCHERO}{Trinchero}{Vétérinéro jamaiquèn, esper d’ali\-men\-ta\-ch\'on de la va\-tse, \name{Simone Roveyaz}}

\Character[]{TCHEUTTE}{Tutti}{\hspace{1cm}}

\DramPer
% OK 4.5CM per entrambe
\vfill
\begin{figure}[h]
\centering
\whiteshadowbox{
\includegraphics[height=4.5cm,keepaspectratio]{Foto/2011/IMG_1658.jpg}
}
\end{figure}
\vfill
...
\centering
\whiteshadowbox{
\includegraphics[height=4.5cm,keepaspectratio]{Foto/2011/IMG_2102.jpg}
}
\end{figure}
\vfill
...
\StageDir{Entre totta flappa la premiye vatse\footnote{ Pe rendre l'eunterprétach\'on bièn pi téatralla, totte le vatse se boudzon si do pià/patte \riye .}. }

\Sahlammspeaks Mondjemé se fisan totte lente comme té n’ario cheur jamì lo flou queurt. Cobra, Cobra!

\StageDir{Entre la secounda vatse é eunc\'o lleu tsemin-e flappa eun gantèn la tita. Eunsemblo a Tsardoùn se proméon douàn lo palque é de tenzentèn se frotton eunna countre l'atra ou desì de bale de fen.}
...
\Cobraspeaks Mi iaou gramo? Mé eun dzor avouì ma corna drèita n’i levou-lo desì mé é n'i caya-lo bièn louèn. \direct{Bièn fièira} Eugn éffé a mé reste pa tan protso é fé bièn attench\'on.

\Piccinaspeaks \'E aprì comenche a itre vioù é chor. Vèyade beun que l’è pi sen que fi de sa tita que sen que lèi diyon de fére.

\Tzardounspeaks Fé attench\'on a sen que te di di viille! Mé si la pi viille di baou mi salla que sa todzor de pi de vo totte. Rappèla-té que, sensa de mé, vo ariya jamì aprèi eunna matse de bague. Té, Cobra, si pa se te rappèle euncoa: l’an que t’i nèissia, mé é mamma de té allavon bièn d’accor é\ldots

\Cobraspeaks Voualà que torne reprende sise discour stoufiàn pa pocca.
...
\Piccinaspeaks Fran té te prèdze. Avouì la squeuza di bataille di rèine te queutton pa crèitre le teteun é te teurion cheur pa de lasì\latte. La fontin-a la féyon avouì mé! \direct{En moutrèn le teteun} Avèitsa-mé que mezeua: la satchima!

\Tzardounspeaks Finque ézajeroù! Pensa que Tchièn, noutro propriétéro, l’a de foto de mé da dzouvin-a que\ldots le n’ayoù pa magà grouse comme le tin-e, mi bièn pi caraye é diye comme eun bèrio! Atro qué!

\StageDir{Piccina é Cobra s'avèitson.}

\Piccinaspeaks  \direct{Eun se moquèn de Tsardoùn} Ara te te pouriye finque fé fée eun \textit{lifting}! N’i sentì que refàn eunc\'o le sen pe le vatse ara.
...
\Tzardounspeaks Can mimo mé me rappèlo eun cou can Tchièn me a\-ria\-ve a man! Sen vouè que l'iye dzen. Cheurtoù can n’ayoù de maleusse avouì caqueun ou la dzournoù l'iye pa tan allaye bièn vèyao pa l’aoua de itre accaéchaye é baillì mon bon lasì. Sario restaye pouza é pouza a itre patchocaye pe llu. Cheurtoù can baillave campa a sé dzente tsans\'on\ldots a mé me s’eumplissave lo queur d’amour. Belle se Tchièn l’a jamì tsantoù a Sent-Or, \direct{avèitse l’atra} eh\ldots t’a comprèi\ldots sayè me fiye relassì.
...
\Tzardounspeaks T’a rèiz\'on é cheurtoù noutro Tchièn n’en pamì tan vi-lo seuilla i baou. Sembleavì que, dèi can l'è arrevoù sit aourì, llu l'ise queuttoù totte é lèi euntéressise pamì ren de no.
...
\Tzardounspeaks Te lame sondjì eh?!  Mi acouta Cobra\ldots mi l’è vrèi que t’a de problème a restì prègne? Perqué n’atte de vouése que vouyadzon pe seuilla\ldots
...
\Piccinaspeaks Na, na, si pa mé!\imbarazzatoo\ Mi l’a pa d'eumportanse, di maque\ldots

\Cobraspeaks Ouè l’è vrèi. Mé, dèi can n’i prouvoù Mol\'on, lo bou de la grandze de Marteun, n’i todzor pensoù a llu é djeusto a llu. S’i fran eunnamoraye!
...
\Tzardounspeaks Cobra, te lo vèi pamì, resta tranquila. Seuilla te fa pa te eunnamorì \inamourou\ d’eun bou! Tcheu le-z-àn se tsandze. Eun nouo é dzouveun-o tcheu le cou.
...
\Piccinaspeaks \direct{Eun braillèn} Topo! N’ayoù cogni-lo a Gressan a l’Anaborava, mi can n'i si qué que l’ayè trèi meulle mèinoù\ldots

\Tzardounspeaks Senque? Trèi meulle mèinoù?

\Cobraspeaks Trèi meulle?

\Piccinaspeaks Ouè bon\ldots trèi meulle paillette!

\Tzardounspeaks Ah l'è diffièn!

\Piccinaspeaks \ldots é beun n’i to de chouite oublia-lo!

\Cobraspeaks \direct{A Tsardoùn} Pensa 3000 ratte seu dedeun! Mi can mimo m’euntéresse pa de Topo! Mé vouillo mon Mol\'on!
...
\sound{https://www.youtube.com/watch?v=66Essn5jIUA}{A la besse - Cheb Hasni}

\StageDir{Can l’a fenì de beuttì su totte, icaoue an mia pe tèra, mi aprì do seconde se beutte protso d'eunna balla de fen é s’eundrumme. Aprì pocca entre deun la mèiz\'on di lasì Tchièn l’éléveur. L’è restoù to lo mateun eun Veulla a fere de commech\'on é l’è bi-se dza caque apéritif, donque l’è eunna mia gramo. Ren lèi va bièn.\\ Se gave lo palt\'o é lo tsapì é va ver lo parque pe vère sen que l'è seutta mezeucca que sen. Can areuvve deun lo parque vèi Sahlam eundrumì.}
...
\Cienspeaks Vouè bondzor eunc\'o a té. Vou-te cafilasì é brioche vi que t’i djeusto levoù?
...
\Cienspeaks Mi lèi penso gnenca! \direct{Bièn arrogàn} L'è pa eun travaille de mé sen. L’a djeusto de arrevì tchica devàn lleu, pitoù de tchacolé foua de messa avouì le-z-amie; ou diye i prée de copé an mia lo serm\'on. Fé todzor de counte si prée\ldots
...
\Iolandaspeaks Imajin-o!

\Simonspeaks Pappa! Di pa de counte foule, te cougnisèn! Te passe de-z-aoure é de-z-aoure avouì Calliste é Jérôme a bèye de vèyo tanque a noua i Bar de l’Arena.
...
\Cienspeaks \direct{Eun moutrèn foua \textit{scène}} Te vèi ba lé i fon de la toula? Va ba me tramé la souye! Ara! Vito! 
...
\Cienspeaks Pe ara si eunc\'o mé que désido le bague é \direct{eun moutrèn la tabla} vardo bièn mon ouficho.

\Simonspeaks Pappa te fa comprendre que mé n'i itedjà! Mé que si laouréoù, si de bague que té t'imajin-e gneunca. T’a jamì sentì prédzì de \textit{dematerializzazione}? Tcheu le papì allérian deun lo \textit{computer} é d’eunna secounda te trouveriye totte sen que t’a fata.

\Cienspeaks Acouta-mé, va eunc\'o to bièn pouèi, n’i pa fata de novitoù.
...
\Cienspeaks Argh acoutta Simon, n'i pa fata de nouvot\'o! Pappa l’è con\-tèn pouèi\ldots é seunséramente se t’isse pa fenì de itedjì a 40 an t’arie pouì me éidjì tchica devàn pe seuilla. N’ario cheur pa avì fata de prende Sahlam!
...
\StageDir{Marietto areuve a la fenitra \finestra\ é vèi le dou achattoù a medjì.}
...
\Cienspeaks Amoddo. Te me semble eun priye que cougnisavo: arrevave todzor fran a l’aoura de maenda pe baillì la bénédich\'on i mitcho. Comme eunna moutra souisse!
...
\Mariettospeaks A Marietto beutta mai plen!

\Simonspeaks \ldots é queutto sé la botèille\wine pe Marietto!

\Cienspeaks Simon aprì beutta tchica eugn odre seutta tabla plèin-a de papì.
...
\Mariettospeaks Grama?! Dedeun ton baou? T’a maque de croué va\-tchine!

\Cienspeaks \direct{Caze avouì le larme i joueu \plaoue\ é eun se levèn} Queutta-mé pe plèizì. Te sa bièn comèn terì si lo moral di-z-amì té.
...
\Cienspeaks Mi l’è to li lo lasì?
...
\Cienspeaks Acouta, mi pe plèizì, mi queutta-mé pédre, té é ta icoula!

\Mariettospeaks Mi ouè queutta ité pappa.

\Simonspeaks Pappa, crèi-mé, mé si sen que fé de noutre vatse.
...
\StageDir{Aprì èi bi eunna goloù, Sahlam vouidze lo sidel demì plen de lasì deun la tsaoudée é beutte an mia de caille.}
...
\StageDir{Pe queriaouzitoù Sahlam gneufle la bouite di caille, mi to d'eun creppe iternèi é to lo caille fenèi dedeun la tsaoudée.}
...
\StageDir{Avouì totte sé forse arreuve a teri-lo foua! Lo beutte eun caro é s'avèitse a l'entor.}
...
\Mariettospeaks Ah nen si quetsouza eunc\'o mé!

\StageDir{Le dou entron deun la mèiz\'on di lasì, douàn Marietto é aprì Tchièn.}

\Cienspeaks Entra maque Marietto!

\Mariettospeaks Ouè cougniso lo mitcho!

\StageDir{Le dou s'achouatton a tabla.}

\scene[-- Chef d’équipe Mottinho]

\StageDir{Arreuve Iolanda.}

\Iolandaspeaks Oh Marietto drolo te vère seuilla pe l’aoura de maenda.

\Cienspeaks Ouè drolo!

\Mariettospeaks Ouéla Iole! Vatte?

\Iolandaspeaks Vouè totte amoddo. Te pense de t’arritì eunc\'o oueu a ma\-en\-da ?

\StageDir{Marietto l’è preste a diye de vouè mi Tchièn lo antisipe.}

\Cienspeaks Na, oueu na Iolanda. Oueu n’en de grouse novit\'o é eunc\'o bièn eumportante! Dèyon arrevé avouì Simon, n'en pa lo ten de medjì!
...
\Cienspeaks \direct{Eun tegnèn Marietto pe eunna mandze} Na, na, Iolanda tra\-cà\-cha-te pa pe le cannell\'on! Le medzèn oueu a sin-a, tante Marietto l'è pi ià!
...
\Chefspeaks Mé si lo Chef d’équipe Mottinho. N'i prèi satte \textit{lauree} é s’i eun di pi capablo é aprestoù vétérinéro de la Val d'Outa. Si seuilla a voutra dispozich\'on pe rezoudre tcheutte voutro problème avouì le bitche pe djeusto 128 \textit{euro} la meneutta.
...
\Cienspeaks Se l’è pouèi\ldots \direct{eun s'avèitsèn a l'entor} Sahlam!

\StageDir{Sahlam, que l'iye eun tren d'acouté, se beutte si l'\og attenti\fg.}
...
\Sahlammspeaks Vouè!
 ...
 \Cienspeaks Mi te vèi pa que l'è arrevó lo vétérinéro?\\ \direct{Malechà \malecha} Pourta eun sé le bitche! Fé-me pa fé seutte fegueue!
...
\StageDir{Schulz se plache protso de Gilles.}
...
\StageDir{Lo vétérinéro Trinchero salie Marietto avouì eun djouà di man juvenile: se baillon lo sinque, deun coutì é de l'atro, é eun creppe de panse eun countre l'atro. Aprì èi salià, lo vétérinéro Trinchero se plache protso di-z-atre collègue.}

\Chefspeaks Voualà, ara vo prèdzon de leur spésializach\'on. Vo dou \direct{a Gilles é Trinchero} alade maque vo presté dimèn que comenchèn avouì Schulz.

\StageDir{Le vétérinéro Trinchero é Gilles chorton.}
...
\Schulzspeaks \direct{A Tchièn é Marietto} Salù! Ad\'on mé si lo docteur vétérinéro Hermann Schulz é si laouréoù eun psicolojì de la vatse é stress di baou. I dzor de oueu l'è eugn argumàn todzor pi eumportàn pe la bon-a calétoù de la rase.

\Cienspeaks Ah\ldots

\Schulzspeaks Pouì comenchì ma térapì?
...
\Mariettospeaks \direct{A Tchièn, a basa vouése} Me semble eunna bagga tchica drola a mé.

\Cienspeaks Marietto! Lèicha travaillì lo vétérinéro! Pitoù va baillì eun\-na man a si Sahlam lé!
...
\Schulzspeaks\direct{A Tchièn} Squezade, pouide tornì tcheut deun la mè\-i\-z\'on di lasì perqué la vatse l'a de problème a predzì avouì totte seutte dzi.
...
\Mariettospeaks Mi mé vouillavo djeusto sentì sen que l'ayè a lèi diye.

\Cienspeaks Sah, Marietto! Veun que te voueudzo eun vèyo!

\Mariettospeaks Ah! Areuvvo!

\StageDir{Se nen van tcheutte deun la mèiz\'on, mouèn que Sahlam que chor foua ver le pro a drèite, é queutton le vatse avouì lo vétérinéro que lèi prèdze.}

\sound{https://www.youtube.com/watch?v=9O_3m6thJUM&list=RD9O_3m6thJUM&start_radio=1}{Il Ritorno Del Ringo - Nazca}

\StageDir{Lo vétérinéro Schulz acoutte totte le vatse, que, sensa prédjì, maque avouì de jeste, se plègnon de sen que va pa. Aprì èi acoutto-le totte é trèi, le ipnotize avouì de movemèn de la man que le trèi vatse chouivèison euntsantaye. A la feun de la mezeucca, Schulz fenèi sa térapì é le trèi vatse son deun eugn étà de transe: son rite é baoudzon maque la tita a drèite é a gotse. \\ Schulz criye Simon, Mottinho, Tchièn é Marietto, que sayoon eun tren d'avèitchì de papì deun la mèiz\'on di lasì.}
...
\Schulzspeaks De problème n’a tan. Le vatse l’an fran perdì leur caratéro é se senton sfruttaye sensa pamì eunna rèiz\'on de viya é, cheurtoù, vouillon chédre leur lo bou.
...
\Schulzspeaks Ara vo fiyo vère le bou que n’en a dispozich\'on é vo vo lo cherdéré. Tot comprèi?

\StageDir{Cobra, Piccina é Tsardoùn repondoun avouì eun \og meuh\fg!}

\Schulzspeaks Bièn, ad\'on \textit{vidéo}!

\StageDir{Comenche eunna \textsl{vidéo} iaou trèi bou difféèn se prézenton: lo bou chouisse, bièn fier, dzen, prestàn é rebeusto; lo bou piémontèis, drolo mi seumpateucco; lo bou valdotèn, croué bagga é finque tchica euntredeutte.}
...
\Schulzspeaks Ah t’a cherdì Boston, lo bou chuisse. Piccina ara totse a té, vi que t’i la rèina di lasì. Queun bou t'a cherdì?
...
\Schulzspeaks\direct{Eun soladzèn Tsardoùn} Tracacha-té pa! Te vèi pi que l'aré bièn de caletoù catchaye! \direct{A Tchièn} Bon mé sé n'ario fenet, n'i djeusto fata de eunna baga: que vo a feun senà m'a\-tse\-tade pe voutre vatse eun ordinateur portablo; pouai l'an pi comoddo se cougnitre avouì le bou cherdì\ldots pe mézo de la \textit{chat}!
...
\Cienspeaks\direct{Dizorientoù} D'acor comme vouillade!

\Schulzspeaks Tracachade-v\'o pa! Véyade aprì que rezultà aprì to so! Ad\'on mé marco le-z-aoure beutto trèi, fiyèn sinque va, tante no paye la Réjón. Va bièn igale?
...
\Simonspeaks Pappa t’a vi? So vouè que l’è lo tsandzemèn que te pré\-dza\-vo. Te te ren contcho iaou pouèn arrevì no que n’en itedjà?

\Cienspeaks Vouè, vouè. S’i fran vioù.

\Mariettospeaks Ah ouè, t'i fran vin-ì vioù!

\scene[-- Vétérinéro Gilles]

\Chefspeaks Vouillèn veure lo sec\'on vétérinéro? Lo ferio entré é vé\-yèn sen que no di. Vétérinéro Gilles, vegnade!

\StageDir{Entre eun galopèn lo vétérinéro Gilles. Marietto saoutaille com\-me Gilles.}

\Maracanaspeaks Bondzor a tcheutte. Mé si lo docteur vétérinéro Gilles, fri\-que frique d’étude. Si djeusto laouréoù eun sosializach\'on é mouvemèn pe la vatse.
...
\Maracanaspeaks  Ad\'on mé n’i dza aprestoù eunna mezeucca avouì eun cour\-se que pou le-z-èidjì a itre pi sportive!
...
\Maracanaspeaks \textit{Ok} n'i djeusto fata de tchica de caro.

\StageDir{Gilles pouze l'abrosaque é teurie foua trèi jupe awouayenne pe le vatse, que, totte contente, se le beutton.}

\Maracanaspeaks \ldots é ad\'on, \textit{one, two and one, two, three}, mezeucca!
...
\centering
  ...
  \centering
    \qrcode[hyperlink, height=0.5in]{https://www.youtube.com/watch?v=HirTuF1oA6g}
  \end{subfigure}%
%\vspace*{-5pt}
\end{figure}

\StageDir{Gilles, i mentèn di palque, danche é fé vère le premì pa. Le trèi vatse comenchon a aprende le pa é se queutton alì. Tcheu le-z-atteur (eunc\'o Iolanda, Sahlam, Trinchero é Schulz) se fion prende é comenchon a danchì, mouèn que Tchièn, lo seul que l’è pa tan cheur de to sen que l'è eun tren de capité.}

\StageDir{Fenia la tsans\'on, tcheutte tournon iaou sayoon douàn.}

\Maracanaspeaks \textit{Ok}! Parfé!

\Mariettospeaks So te pren eh! Que chouéyaye!

\Cienspeaks Vouè, mi squezade vétérinéro mi l’è garantì si prodouì ?

\Maracanaspeaks Mi ouè l’è garantì. L’è dza lo catrimo baou que viondo seutta senà avouì ma térapì é son tcheutte reustoù contèn. 
...
\Mariettospeaks Ad\'on \textit{ok}, salù a tcheutte, salù!
...
\StageDir{Lo vétérinéro Trinchero entre pa.}

\Chefspeaks Vétérinéro Trinchero, vegnade!

\StageDir{Lo vétérinéro Trinchero areuvve pa.}

\Tuttispeaks\direct{Eun braillèn} Trinchero!
...
\Trincherospeaks Bièn. Ad\'on fièn l’odre desù Internet é deun eun mo\-màn dériye arrevì totte.

\StageDir{Trinchero teurie foua lo portable é fé l'odre.}

\Cienspeaks \direct{A Marietto} Internet? Te vèi i dzor de oueu que bague? Mé que l'iyo eunc\'o acotemoù a alì prendre eun tchi Paolina a Gressan le bague que t’ayè fata. 

\Mariettospeaks Ah se te pren eunc\'o té Internet lo Pezzoli va clloure.

\StageDir{Caqueun soun-e lo campaneun de la pourta di mitcho.}
...
\Cienspeaks Ah la fèi n'i comprèi. Seràn torna salle drole pomate de la \og Djeust\fg que pren to di lon la fenna! Se son sen le féo tchapé eun vaoulo!
...
\Mariettospeaks Mondjemé n’i dza mou a la tita Tchièn!

\StageDir{Trinchero baille l'erba i vatse. Son de grou can\'on \spinello\ que Trinchero aleumme avouì lo briquet\accendino. Eunc\'o Sahlam nen pren eun.}

\Trincherospeaks Voualà eunna pe eun. Fa le-z-allemì avouì lo briquet é le djouà son fé. Aprì eun dzen momàn de mouvemèn, so l’é sen que vo idze a vère to roze. To so se criye térapì \textit{Rave}\ldots Na! Rèina \textit{party}. N’i eunc\'o eunna mezeucca pe l’occaj\'on!

\sound{https://www.youtube.com/watch?v=RIMxmnfDSOs}{Jamming - Bob Marley \& The Wailers}

\StageDir{Totte le vatse comenchon a alé d’eun coutì a l’atro di palque comme se fusson drogaye é bièn relassaye. Eunc\'o Trinchero se relasse.\\ Sahlam é Marietto prouon a pipé eunc\'o leur.}

\Trincherospeaks Ah, n’i dza comandoù eunna conféch\'on pe senà pe to l’an, pouèi v'ouite tranquilo pe tchica de ten. 
...
\Chefspeaks Voualà, ara que vo vèyo pi tranquilo é que seutte bitche l’an tchandjà plima, me nen allério eunc\'o mé. Vo queutto ma\-que eun per de papì pe pouèi paì eun 36 comode \textit{rate}.
...
\StageDir{Marietto se beutte a saouté i mentèn di palque eun bouéchèn le bri comme se fusson de-z-ale!}

\Sahlammspeaks Eh patroùn! Avèitsa, si to blan Tchièn! 

\Mariettospeaks \ldots é Sahlam l'è vin-ì to blan! 

\StageDir{Tchièn sa pa senque diye é le-z-avèitse éton-où é deperdù \confuso.}
...
\StageDir{Eun scène n'a le vatse itaoulaye si le caèye di solèi é dézò l'oumbra d'eugn ombrell\'on \ombrellone. Eunna vatse l’a la bandjèira de la CGIL.}

\Cienspeaks \direct{Moral a téra, i pebleuque} L’é dza tchica que va eun devàn seutta conta é le bitche de mé son todzor pi drole é te areuvve pamì a lèi fi fiye sen que te vou. Avèitsa Cobra, ara que l’é icrita i sindacat bare fran pamì ren. Pa que devàn l’isse itaye eunna gran rèina mi ara eumpeugne djeusto se te lèi promé pe icrì sinque potchà de \textit{mangime} pe souye; é Piccina é Tsardoùn reston to lo dzor i solèi é dèyo eunc\'o atseti-lèi eunna pomatta pe le berleue di solèi. Mi cheurtoù ara que son icrite a la CGIL me baillon lo lasì eun cou pe dzor é djeusto can l’an voya leur\ldots é fenèi pa seuilla. Son doe senà que me queutton pa entrì dedeun lo parque\ldots é perqué? Perqué le-z-itreuillo pa tcheu le dzor é leur lèi teugnon tan a itre prope.  Sise drouet l’an rovin-ou-me-lé. \direct{Pause} na mi si cou praou seutta bagga! \direct{Malechà é déterminoù} Ara fa tsandjì! Si cou\ldots ara Simon me sen! Si cou si botcha va me sentì!
...
\Simonspeaks Mi comèn sen que n’en fé? N’en fé-le restì mioù. 

\Cienspeaks Ah reston mioù? Reston trop amoddo! Si cou la fèi n'i fenì eunc\'o d'avèi eun icouila de lasì pe dzor. 

\Simonspeaks Mi pappa! Te fa pa avèitchì vio te ren la vatse, mi se reste bièn avouì le-z-atre é se l’è contenta de sa viya!
...
\Cienspeaks Praou, praou Simon! N’i fran comprèi que lo mondo l’a tsandjà. Lamao tan lo Simon que l’ayè nou-z-àn é criyave \og pap\-pa, pappa pourta-mé ba i baou que veugno avouì té a baillì lo fen a la viille Poudre\fg. Poudre\ldots te la lamave é lleu lamave té. Te chortave de l’icoula é te galoppa-ve eun tsan pe pouèi la vère é l’accaéchì. T'iye bièn dzouvin-o mi bièn pi sensiblo!

\Simonspeaks Mi\ldots

\Cienspeaks Acoutta! N’i desidoù eunna bagga. Le-z-amì vétérinéro dèi oueu queutta-lé maque louèn de si baou é\ldots a si Sahlam lèi accapèn pi caque d’atre travaille. Si noureun vouì lo vardì  eunsemblo a ta mamma. Vouì lo traillì tcheu le dzor é vouì appréchì le-z-émoch\'on que te fan prouì le bitche tcheu le dzor\ldots que chouèn te baillon bièn pi di dzi\ldots
\vspace*{-0.5cm}
\ridocliou
...
\centering
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2011/IMG_5940.jpg}
}
\end{figure}
\vfill
...
\centering
\whiteshadowbox{
\includegraphics[height=5.5cm,keepaspectratio]{Foto/2011/IMG_5966.jpg}
}
\end{figure}
\vfill
