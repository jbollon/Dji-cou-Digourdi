...
%\vspace*{-1cm}
\LinkPiese{Avanspettaclle, Todzo pi Digourdì}{https://www.youtube.com/watch?v=IaFisR_YuYo&list=PLBofM-NS_eLJUln45l7VH457fGak_Bk5O&index=4, https://www.youtube.com/watch?v=MiAzDgBoOTY}{.45}{.65}
...
\centering
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2018/pegno.jpg}
}
\end{figure}
\vfill

\setlength{\lengthchar}{2.80cm}
...
\Character[\hspace*{1cm}]{a}{b}{\hspace*{1cm}}
...
\StageDir{\hspace*{2.5em}Laurent l'è si \textsl{proscenium} que avèitse lo pebleuque.}

\begin{drama}

\Laurentspeaks Bonsouar é bienvenù a tcheutte a seutta souaré di Printemps Thé\^atral avouì le Digourdì de Tsarvensoù. Me semble ieur can no sen acapó lo premì cou comme compagnì é n'en désidoù de beté si le Digourdì. Dèi si dzor lé n'en fé tan de souaré é de chortie, todzor eun vardèn lo mimo esprì, la mima voya de riye é de fée riye. Donque, eugn'occajón de noutro anniverséo, n’ayoon désidó de pourté inque si lo palque eun momàn bièn tipique, é sourtoù bièn téatral, de sen que l'iye la viya valdoténa: lo Consèille réjonal. Mi aprì no no sen deu: \og mi le dzi veugnon sé pe riye ou pe plaoué?\fg Pe riye! É ad\'on no no sen deu: \og na, na, na!\fg L'è vrèi que lo téatro é la poleteucca son bièn gropoù; bièn de cou te comprèn pa qui fé la poleteucca é qui fé lo téatro. Mi i mimo ten, euncó no Digourdì pouèn pa tan cretequì la poleteucca; euncó no n'en noutro pégno euntsardzo eun poleteucca. La Joueunte comunale de Tsarvensoù l'è compozaye pe cattro Digourdì si sinque! N'en la majoranse! \'E l'unique que l'è pa eun Digourdì, lo seul que l'a jamì resitó desì si palque (é de so dèi se baillì lagne)\ldots l'è noutro Seunteucco! Seunteucco que, comme tcheu le vrèi politisièn, l'è vin-ì eun salle de téatro, l'a saroù la man a tcheutte, l'è fé-se vére, l'a fé de grou sourì\ldots é ara iaou l'è aloù? L'è aloù ià! Mi l'a pa comprèi que sise que l'an resitoù devàn sayoon sise de Brutchón! Pa de Tsarvensoù! Mi se pou beté Seunteucco eun que prèdze gnenca noutro patoué? Mé ara dimando a tcheu vo\ldots mi se pou voté eun Seunteucco que\ldots

\StageDir{Ronny Borbey, Seunteucco de Tsarvensoù, entre eun \textsl{scène}.}
...
\Ronnyspeaks Djeusto! Mi te diyo eugn'atra baga: fièn comme fan le Grilleun!

\Laurentspeaks Ah ouè le sinque-z-itèile!

\Ronnyspeaks Djeusto! Leur senque fan? Demandon i dzi se son d’acor, beutton eun votach\'on, fan le \textit{parlamentarie}. Comme lo PD que fé le \textit{primarie}.
...
\Ronnyspeaks Acouta-mé: no n'en cherdì le Digourdì pe fé lo \textit{court-mé\-tra\-ge} si la Reconstituch\'on de la Quemeua é le DVD l'an i eun gran sucsé. Ad\'on senque fièn? Pourtèn a Tsarvensoù lo festival di \textit{cinéma} de Cannes é de Venize! Imajin-a-té le journal:\og Festival di \textit{cinéma} de Tsarvensoù\fg!

\Laurentspeaks Wow!

\Ronnyspeaks Imajin-a le \textit{star} que se fan le \textit{selfie} si la promenade.

\Laurentspeaks Ah ah ah! Mi iaou sarie noutra promenade?

\Ronnyspeaks Mi n'en euncó no la promenade: lo tsemeun de Veulla. Imajin-a-té le \textit{star} que van si é ba pe lo tsemeun de Veulla!
...
\Ronnyspeaks Donque fé-me pensì\ldots n'i pensoù. Ad\'on té te cougnì amod\-do la Becca, mi te feré pi eugn'atra manifestach\'on: Veulla - Tsarvensoù - Mont-Emilius, pouèi te va euncó pi si!
...
\Ronnyspeaks N'i pensoù euncó a so: lo pro de la grandze de Plan-Feleun\-na. Atsetèn lo pro (le tsanéno l'an fata de sou pe se paì la \textit{badante}), plachèn la Becca é fièn Charvland, lo Gardaland de Tsarvensoù! L'è pa eunna dzenta idoù?

\Laurentspeaks L'è eunna idoù euncrouayabla! A Charvland lèi betèn a traillì sise de la Giradaz, d'Ampaillan é di Pont-Suaz. Aprì totte le-z-attivitoù di Pon travaillon de pi é se travaillon no voton.
...
\Laurentspeaks Avèitsa qui l'a votou-no: Siro Viérin! Demàn nèi!

\Ronnyspeaks N'en l'unanimitoù. Saren-no la man pe la fotografie avouì le journaliste\ldots

\StageDir{Ronny é Laurent se saron la man é sourion pe se fé fée eunna foto. Aprì chorton.}

\Laurentspeaks Ah na!

\StageDir{Ronny é Laurent tornon i mentèn di palque.}

\Ronnyspeaks Sen oublia-no di Digourdì!

\Laurentspeaks Djeusto! Donque\ldots vo quetèn avouì lo spettaclle di Digourdì icrì eugn'occaj\'on di djijimo anniverséo de la compagnì! A vo\ldots
...
\StageDir{Lemiye \lemieSi\ a drèite di palque, iaou acapèn eun chofà é magàn protso d'eunna poltronna.\\ \Fv{Tsarvensoù, 4 janvieu 2050}
}

\Maganspeaks \direct{Eun s'achouatèn si la poltronna} Oh\ldots si belle lagnaye! Ara m'achouatto eun momàn. Ah na! Me fa euncó poulité lé pe tèra. Ah! Mi n'i la soluch\'on! Lola!

\StageDir{Eun peuccapoussa \textsl{automatique} chor foua di chofà é poulite sel\'on sen que comande Magàn.}
...
\StageDir{Magàn se levve é catse lo peuccapoussa dézò lo chofà. Aprì s'a\-chou\-at\-te tourna si la poltronna é teurie foua lo portable.}

\Maganspeaks\direct{Eun lièn} Véyèn sen que conte-tì lo moundo oueu\ldots

\StageDir{Entre pagàn avouì l’\textsl{hoverboard}.}

\Paganspeaks Sophie! Si arrevoù!

\Maganspeaks L'iye l’aoua bon!

\Paganspeaks \direct{Eun se boudzèn avouì l’\textit{hoverboard}} N'i fé eunna dzenta promin-ada oueu\ldots avouì la dzenta mezeucca de l’Orage n'i fé belle dou kilomètre!

\Maganspeaks \ldots é t'i gnenca tsizì! T'i fran eun gamba!

\StageDir{Pagàn fé dou tor si lo poste é aprì bèiche ba de l’\textsl{hoverboard}.}

\Paganspeaks \`Eitsa que mé si eugn esper de seutte machine! Pa comme té, todzor dérì a si portablo é a Facebook é iPhone!

\Maganspeaks \`Eitsa que mé oueu n'i dza to fé, n'i dza to poulit\'o !

\StageDir{Pagàn s'achouatte si lo chofà.}

\Paganspeaks Ouè, poulit\'o avouì salle machine que t'a pe lo mitcho\ldots que nen si mé sen que te combeun-e pe lo mitcho! \direct{Eun terièn foua lo portablo} Ara fé-me liye lo journal.
...
\Maganspeaks \ldots é lo pappagràn l'ayè fé-lo dza a son ten!

\Paganspeaks Ouè, que dzen veure comèn le mitchì se tramandon, l'è dzen so!

\Maganspeaks T'a fran rèiz\'on!

\StageDir{Le dou nevaou entron eun galopèn avouì eun man eun grou \textsl{album} di fotografie. S'achouatton pe tèra, protso de pagàn.}
...
\StageDir{Pagàn pren lo livro eun man é lèi souffle desì pe lèi gavé ià la poussa\footnote{Pe fé vère la poussa, deun l'\textsl{album} n'a bièn de \textit{borotalco}.}.}
...
\Paganspeaks Deh Aimé! Pourta de reuspé pe Le Digourdì! Le Digourdì l'an port\'o lo non de Tsarvensoù ià pe to lo moundo!
...
\StageDir{Pagàn fé de caro si lo chofà é le dou nevaou s'achouatton.}

\Paganspeaks \ldots ara vo fiyo la conta\ldots l'iye l'an 2000 é\ldots ouette é\ldots

\StageDir{Teuppe \lemieBa. Lemiye \lemieSi\ a gotse é i mentèn di palque.}

\scene[-- La nésanse di Digourdì]

\StageDir{Eun \textsl{scène} n'at eun banc\'on é doe pégne table avouì eun per de caèye. N'a la serventa que poulite lo ban é eun vétchot achouatoù a gotse que li lo journal pe son contcho.\\ Entron deun la cantin-a  Jo\"{e}l, Jo\"{e}lle, Pierre é Francesca.}
...
\Francescaspeaks Euh Jo\"{e}l Albaney! Fa-tì te rapélé que n'i portó té é llou \direct{eun moutrèn Pierre} i mitcho? \'E pe terì si sitte tanque si la Basteuille n'en finque rechà Viro!

\Vetchotspeaks Ouè! Mé alao si i fèye \pecora\ é sise se retèriaon!

\Pierrespeaks\direct{I vétchot} Conteneuvva a liye lo journal! Euncó té can t'iye dzou\-eun-o t'a fé de fite!

\Vetchotspeaks Penso beun! Mi l'an jamì pourto-me i mitcho le femalle! To\-dzor arrevó i mitcho avouì l’ape; é pe to diye, i ten de mé le femalle servichaoun pe d’atro!
...
\Joelspeaks Pierre! Pourian beté si eunna compagnì de téatre.
 
\Pierrespeaks Pequé pa? Pa mal comme idoù. 

\Joelspeaks\direct{Todzor a Pierre} N'arian djeusto fata de fenne\ldots

\Pierrespeaks Eh ouè sen maque mé é té.

\StageDir{Le dou penson eun momàn dimèn que Jo\"{e}lle é Francesca comenchon a se amalechì pe pa itre considéraye.}
...
\Pierrespeaks\direct{I vetchot} Té que t'i plen de femalle, te sarie no deue se n'a de fenne que pouon itre euntéressaye a fé téatro?
...
\Joelspeaks Sayoon eun tren de squersé!
...
\Pierrespeaks Mi ouè! Sen que capite, capite! Seu a Tsarvensoù sen tcheut amod\-do!
...
\Cimaspeaks Feleunna? Feleunna! Mi té can te di Feleunna te di Paolo Cima Sander! Mi gars\'on, chourtade eunna mia de sise \textit{schemi}! Chortade de Tsarvensoù, bèichade ba de salla montagne, i\-vra\-de le joueu, végnade avouì no que n’en lo solèi to l’an!
...
\Pierrespeaks\direct{I-z-amì} Vo dimando squiza mi si cheur que le prochèn dou\ldots
...
\Pierrespeaks Marco, Simone! Vo laméria fé téatre avouì no?
...
\StageDir{Lemiye \lemieSi\ a drèite di palque.}

\scene[-- Pe to lo moundo \moundo!]

\Paganspeaks Véo d'émoch\'on! Son dza belle passoù 40 an!
...
\Nevaousaspeaks Squeza-mé pagàn, poui-dze te dimandé eunna baga? Péqué lo non Digourdì? 

\Paganspeaks\direct{Fier de seutta dimanda} Ah!  Seutta l'è eunna dzenta coun\-ta: ad\'on, eun dzor\ldots \direct{comenche a borboté, vague} dou de no son partì ià pe eun mariadzo; aprì can son tournoù i mitcho l'iye tar é l'ayoon fata de pantchì d'éve\ldots se son betoù protso d'eun meur, mi l'è chortia la mamma de eun de sise dou\ldots la mamma l'a vouaillà : \og Deh! Me raccomando vo dou\ldots fiade pa tro le Digourdì! \fg{} . Voualà! De si momàn la Compagnì l'ayè son non!

\Nevaouspeaks Ouè mi pagàn, se sitte l'è lo non, vouillo pa imajin-ì le pièse que v'ouèide fé!

\Paganspeaks Aimé! Pourta de reuspé pe le Digourdì é rappella-té que le Digourdì l'an pourtoù lo non de Tsarvensoù ià pe to lo moundo!
...
\Maganspeaks\direct{Eun se levèn} Mi senque te counte? \direct{Eun prégnèn l’\textsl{album} é eun s'achouatèn} Acoutade mèinoù, de sen que counte pagàn coppade la mèitchà, vardade eun car é tsapotade euncó eunna mia! Vegnade seuilla  que vo counto mé\ldots

\StageDir{Teuppe \lemieBa.}

\StageDir{Lemiye \lemieSi\ a gotse é i mentèn di palque.}

\scene[-- Catro tsatte \gatto\ \gatto\ \gatto\ \gatto]

\StageDir{Si lo palque n'a 15 caèye plachaye si trèi feulle. Eun vétchot é eun éleveur bièn annouiyà son achouatoù si la seconda feulla.}

\StageDir{Eunna mamma entre to de coursa.}

\Mammaspeaks\direct{I vétchot, avouì lo flo queur} Squizade-mé! L'è-tì dza comenchà? 

\Spectateurspeaks Comme tcheu le demicro attaque a ouette é demì.

\Vetchotspeaks  N'a pa de prisa.

\Mammaspeaks Amoddo. Mé ara dèyo vardé eun per de plase pe de paèn.

\StageDir{La mamma comenche a se dizarbeillì pe vardé la plase i paèn. Se gave lo palt\'o, eunna maille, eunna botta \scarpa\ é le plache si le caèye.}

\Mammaspeaks So pe tanta Filoméne, la siaou, lo botcha\ldots l'onclle Gene! \direct{Eun gavèn ià eunna caèya é eun se gavèn eunna botta} Pe llou  que areuvve avouì la caèya avouì le raoue queutto eunna botta! 

\StageDir{La mamma finalemàn s'achouatte si la premì  feulla, totta émo\-chon-aye. Lo vétchot é l'éleveur l'avèitson douteu.\\ Silanse.}

\Mammaspeaks  Mancon seun meneutte! Spéèn que arrevisan tcheutte!

\StageDir{Silanse. Entron dou tsachaou. Eun de leur seuble eunna tsans\'on.}

\TsachaouIspeaks N'i la fèi que n'en trompoù poste! \direct{I vétchot} Squezade, l'è-tì seuilla la réuni\'on de la tsasse? 
...
\Mammaspeaks Ouè mi seutta l'è totta eunna noua Compagnì! Le dzou\-eun\-no de ara l'an désidoù de beté torna si lo téatro a Tsarvensoù.

\StageDir{Le tsachaou, lo vétchot é l'éleveur son sensa paolle.}
...
\TsachaouIspeaks Ad\'on l'è nèisia eunna noua Compagnì\ldots ad\'on a\-vèi\-tsen-là!
...
\StageDir{Le dou tsachaou s'achouatton si la trèijima feulla.\\ Bèichon eunna mia le lemiye.}

\Mammaspeaks Oh comenchon!

\StageDir{La mamma, le tsachaou, lo vétchot é l'éleveur boueuchon di man \bouechiman .}

\StageDir{Silanse. Tcheut avèitson lo spettaclle.}

\Vetchotspeaks\direct{A l'éleveur} Mi senque l'è-tì salla beurta baga lé?
...
\Mammaspeaks\direct{Inervaye, ver le dou que son eun tren de prédjì} Deh! \`Ei\-tsade que v'ouite eun tren de prédjì de la feuille de mé! Itade quèi! Grame lenve!
...
\StageDir{Lo premì tsachaou stchoppe a riye bièn for. Tcheu le-z-atre riyon pa é avèitson mal lo tsachaou que molle pa de riye. Silanse.}

\Vetchotspeaks\direct{Eun sarèn le joueu} Mi! L'è-tì pa de Feleunna si lé?
...
\StageDir{Silanse. Lo vétchot s'eundrime. Lemiye \lemieSi .}

\Mammaspeaks\direct{Eun se levèn é eun bouéchèn le man} L'è fenì! \direct{Ver l'éleveur} Oh l'è fenì!

\StageDir{L'éleveur l'è eunna mia dizorientoù, mi can mimo se levve é eun bouéchèn di man rèche lo vétchot.}
...
\scene[-- Fran de-z-atteur professionel!]

\Nevaousaspeaks Magàn, n'ayè fran eun pebleuque mal polì\ldots

\Maganspeaks Ouè pebleuque! Se te vou queri-lo pebleuque! N'ayè catro tsat\-te!

\Paganspeaks Mi senque te nen sa té? Sophie tourna aoutre a moungouì avouì salla baga lé, lo portable, Facebook, Amazon\ldots

\StageDir{Pagàn gave ià di man l'\textsl{album} a magàn. Magàn se levve é tourne s'achouatté si la poltronna. Pagàn s'achouatte si le chofà, todzor i mentèn di dou nevaou.}
...
\StageDir{Pagàn vionde le padze de l'\textsl{album}.}
...
\Paganspeaks\direct{Eunna mia surprì de seutta dimanda} No sayoon de professioniste! Tsaqueun s'aprestave, prouave sa partia, aprì n'ayè de \textit{coiffeur}, caqueun que fiè an mia de méditach\'on pe\ldots
...
\StageDir{No no trouèn dérì le rid\'o di Téatro Giacosa. Deun seutta \textsl{scène} tcheu le-z-atteur fan semblàn que lo rid\'o di fon di palque sisa lo rid\'o rodzo di téatro, de fas\'on que lo pebleuque sisa dérì le rid\'o eunsemblo i-z-atteur mimo.\\ Tcheu l'an lo teste de la pièse eun man, caqueun l'è ajitoù, d'atre relassoù é caqueun d'atro finque tro relassoù!\\ Eun \textsl{scène} n'a Cima achouat\'o si eunna caèya.}
...
\StageDir{Entre Pierre arbeillà comme eun priye, eun béyèn eun ju de frouite. Cima s'achouatte.}
...
\StageDir{Jo\"{e}l se baille de patèle si la tsamba pe bouéchì lo ten. Paolo é Pierre avèiston la \textsl{scène} dispéroù.}
...
\Joelspeaks Bon sen beun a poste; sen aloù bèye eunna goloù é sen arrevoù lo pi vito poussiblo é sen arrevoù ara\ldots é ara prouèn\ldots
...
\Francescaspeaks Ad\'on, mi senque l'è to si vacarno? Vo siade panco tsandjà \disperazione ? Senque v'ouite eun tren de fiye? Dji meneutte é comenchèn! I galoppe, vito vo tsandjì!
...
\StageDir{Entre Simone avouì eun vazette de \textsl{zuccherini} alcolique.}

\Simonespeaks\direct{To contèn} Ouélla Franci! Agouta eun \textit{zuccherino}!

\StageDir{Simone soum\'on eun \textsl{zuccherino} a Francesca.}
...
\StageDir{Simone, comme se Cima fuche eun petchoù tseun, lèi tappe de \textsl{zuccherini}. Cima tsertse de le medjì i vol.}

\StageDir{Entre Jo\"{e}lle eun galopèn, an mia inervaye.}

\Joellespeaks Sssht! Oh mi prédzade plan 	\quei ! Se sen totte lé dérì! \direct{A Francesca}  A propoù, Jo\"{e}l iaou l'è? Dièn proué eun per de bague.

\Francescaspeaks N'i spedi-lo se tsandjì eunsemblo i-z-atre é l'a deu-me \og eun\-na mailletta é si preste\fg \ldots panco vi-lo!
...
\Joellespeaks Lo si\ldots é aprì fa eunc\'o fé la foto comme souvenir de la première i Giacosa!

\Francescaspeaks Ouè la ferèn se n'en lo ten!

 \Joellespeaks Pouèn euncó pa la fiye! Pe comèn pouriye chotre seutta foto: sitte \direct{eun moutrèn Cima} que tremble comme eun pe\-dzeun, l’atro lé \direct{moutre Simone} que areuvve pa a resté rito, l'atro que molle pa de bèye!
 
 \Francescaspeaks Si pa sen que te diye. Euncó mé me fa liye lo boc\'on de mé\ldots
 
\StageDir{Entre Jo\"{e}l.}

\Joelspeaks\direct{Eun fièn eun viondolet pe se moutré} Me voualà preste pe lo \textit{referendum}!

\Joellespeaks Ouè mi Jo\"{e}l, mi comèn t'i arbeillà?

\Joelspeaks Pequé? Pe la pièse di \textit{referendum}.

\Joellespeaks T'i arbeilla-te pe la pièse de l'an passoù! Seutta l'è la noua pièse: \og L’opetaille moderno\fg.

\Joelspeaks Isto! La noua pièse: \og L'opetaille moderno\fg!

\Joellespeaks Rècha-té va! Soplé, galoppa te betì eun pijama ou que\-tsouza que semblise a eun pijama.

\Joelspeaks Mi so semble eun pijama!

\StageDir{Jo\"{e}l comenche a chotre di palque.}

\Francescaspeaks\direct{Ver Jo\"{e}l} Na, Jo\"{e}l iaou t'i eun tren d'alé? Ara restèn tcheut\-te seu que de sé a dji meneutte no fa fé la fotografie. 
...
\Cimaspeaks Senque? N'en pa le souffleur, voualà l'è fenia. T'ayè eunna baga a fiye, eunna! \direct{Tsache ià Pierre} Mi va ià soplé! \direct{Ver Jo\"{e}lle} Euh Giada, na euh Esterina, na Jasmine\ldots

\Joellespeaks Jo\"{e}lle.

\Cimaspeaks Soplé va queryì Pepe é Paoletta, dimanda-lèi se pouon fé le souffleur vi que leur cougnisson la pièse.
...
\StageDir{Jo\"{e}lle chor é entre Richard avouì eunna grousa machina di foto de la Kodak.}
...
\Fotografespeaks I meun trèi diade fromadzo \formaggio ! Eun, dou\ldots trèi!
...
\StageDir{Jo\"{e}l accompagne foua Richard. Dimèn tcheu le-z-atre se plachon eun demisercllo é s'apreston pe lo motte final.}

\Joelspeaks Ad\'on Richard mersì de totte é a la prochène.

\StageDir{Richard chor é Jo\"{e}l rejouèn le-z-atre.}

\Joelspeaks Alé Gars\'on, ara si reprèi-me eunna mietta! Mondjeu! V'ouite pre\-ste? I meun trèi, noutre motte\ldots eun, dou\ldots

\StageDir{Entre eun \textsl{scène} Richard é se tappe i mentèn di demisercllo.}
...
\StageDir{Tcheutte chorton a gotse, mouèn que Jo\"{e}l que chor ver lo fon, dérì lo rid\'o, pe baillì lo bienvenù é pe prézenté la pièse.}

\StageDir{Teuppe \lemieBa.}

\Joelspeaks Bonsouar a tcheutte. Oueu n'en la Compagnì di Digourdì de Tsarvensoù que pe lo premì cou deun l'istouére pouye si lo palque di Giacosa. Vo queutto donque a la pièse icrita pe leur \og L'opetaille moderno\fg{}!

\StageDir{ Lemiye \lemieSi\ a drèite.}
...
\Maganspeaks Te féo vère. \direct{Eun terièn foua son téléfonne} N'i djeusto di\-tsardjà eunna applicach\'on.
...
\Paganspeaks Mondjemé! Sen mal betoù. \direct{I nevaou} Acoutade, magàn l'è eun\-na mia ià de tita. Can mimo, Aimé é Julie\ldots sitte l'iye maque lo comenchemèn. Aprì n'en fé eunna matse de spettaclle, sen fé-no eunna matse de sou é avouì sise sou n'en fé de fite, de maende, de sin-e é pi finque de dzente chortie!

\Nevaousaspeaks De chortie? Wow! Iaou v'ouite aloù?
...
\newpage
\scene[-- Chortia bièn digourdia]

\StageDir{Lèi son nou caèye plachaye (trèi pe trèi) pe reprézenté eun poulmeun. Douàn lo sédil di \textsl{chauffeur}, n'at eun volàn. Totte le-z-ach\'on di-z-atteur que dèyon euntérajì avouì lo poulmeun (iverteua di pour\-te ou di finestreun, queurve, frènaye) seràn mimaye.}

\StageDir{Lo \textsl{chauffeur} l'è achouatoù deun lo poulmeun to solette, eunna mia eunfastedjà.}

\Chauffeurspeaks Sise de Tsarvensoù son todzor eun retar: pe la chortia di For\ldots eun car d'aoua, le pompì volontéo demì aoua\ldots é ara sise di téatro l'an dza trèi car d'aoua bondàn! Atégnèn euncoa. Dimèn controlèn que sise totte a poste: le lemiye lèi son, lo clacson martse é le panavèyo martson\ldots se fé lo temporal sen a poste. Ara atégnèn.
...
\Jordyspeaks Mé é Simone sen arrevoù! Attégnèn le-z-atre seuilla de foua.

\Chauffeurspeaks Na, na vegnade si! Pouyade maque si que aprì alade bèye eun cafì é vo vèyo pamì; si beun comèn martson le bague.

\StageDir{Simone ivre lo}

\effet{https://soundcloud.com/user-234168361/portellone-posteriore}{Portell\'on}

\StageDir{Simone é Jordy entron deun lo poulmeun. Jordy cllou lo portell\'on\footnote{ Dèi-z-ara tcheu le cou que lo portell\'on se ivre ou se cllou, se sen lo seun son.}. Entron eun \textsl{scène} Thierry é Jo\"{e}l. Jo\"{e}l l'at eun petchoù saque pe la mordiya.}
...
\Joelspeaks So l'è la mordia.

\Chauffeurspeaks Ad\'on la mordiya va dérì!

\StageDir{Lo \textsl{chauffeur} tchappe lo saque é lo tappe dérì.}

\Joelspeaks Mi pequé?

\Chauffeurspeaks Pequé se no ariton fan de counte.

\Thierryspeaks\direct{Dezò vouése a Jo\"{e}l} Que malpolì si \textsl{chauffeur}!

\Joelspeaks Ouè t'a rèiz\'on.

\StageDir{Entron eun \textsl{scène} trèi feuille: Marlène, Jo\"{e}lle é Stephanie. Se plachon douàn lo poulmeun pe se fé eun \textsl{selfie}.}
...
\Stephaniespeaks Squezade lo retar, mi n'ayé lo passadzo a livel d’Ampaillan ba\ldots

\Simonespeaks Ouè, fa clloure lo portell\'on!

\StageDir{Simone se levve é cllou lo portell\'on.}
...
\Joelspeaks\direct{I \textsl{chauffeur}} Feleunna l'è djeusto douàn d'arrevé a Pollein.

\Chauffeurspeaks Si beun iaou l'è Feleunna!

\StageDir{Lo \textsl{chauffeur} aleumme lo poulmeun, mi lo moteur vou pa nen sèi de partì.}

\effet{https://soundcloud.com/user-234168361/motorino-davviamento}{Tentatif aviemèn moteur}

\Joelspeaks\direct{Eun rièn} Comenchèn bièn!

\StageDir{Lo \textsl{chauffeur} reproue.}

\effet{https://soundcloud.com/user-234168361/accensione}{Aviemèn moteur}

\StageDir{Finalemàn lo moteur s'aleumme.}

\StageDir{Lo \textsl{chauffeur} beutte la rétro.}
...
\StageDir{Lo \textsl{chauffeur} beutte la premiye é partèi.}
...
\Thierryspeaks Betèn de mezeucca!

\StageDir{Thierry alondze la man pe avì la radi\'o, mi lo \textsl{chauffeur} lèi baille eunna dzifla.}

\Chauffeurspeaks Na, beutto mé!

\StageDir{Lo \textsl{chauffeur} tsertse eun per de canal mi n'a maque de publisit\'o.}

\Chauffeurspeaks Tchouéyèn, maque de publisit\'o.
...
\StageDir{Tcheutte (douàn la premiye feulla, aprì la secounda é a la feun la trèijima) saouton si can lo poulmeun pase desì lo \textsl{dosso}.}
...
\StageDir{Jo\"{e}l, eunsemblo a tcheu le-z-atre, teurie foua di saque de palt\'o, gan é bounet pe se toppé di frette. Dimèn lo poulmeun s'arite.}

\Chauffeurspeaks Mondjeu que frette! Tsandze fran l'er! Mé n'i pa prèi ren dérì.

\StageDir{Caqueun baille i \textsl{chauffeur} eun bounet.}
...
\Chauffeurspeaks Ouè pensade de alé lo queryì? Seu fé frette!

\Joelspeaks Ouè, ouè vou mé! Vo itade seuilla.

\StageDir{Jo\"{e}l bèiche ba di poulmeun.}
...
\StageDir{Thierry cllou la pourta. Se sen pamì lo ravadzo de l'oua dzalaye que soufflè foua di poulmeun. Lo \textsl{chauffeur} partèi. Tcheutte se dizarbeuillon.}
...
\StageDir{Lo \textsl{chauffeur} entre deun la rionda avouì bièn de vélosité. Vionde lo volàn é tcheutte se plèyon ba a leur drèite.}
...
\StageDir{Lo \textsl{chauffeur} vionde de l'atro coutì lo volàn é tcheutte tournon a itre achouatoù drette.}

\Joelspeaks\direct{I \textsl{chauffeur}} Mi comèn se fé a prendre de rionde pouai! Can te entre te rallente!
...
\StageDir{To d'eun creppe, le Digourdì achouatoù dérì lo \textsl{chauffeur} saouton si pe l'er comme se quetsouza sise pasoù dézò le raoue di poulmeun. Lo \textsl{chauffeur} arite to de chouite lo poulmeun.}
...
\StageDir{Tcheutte eunsemblo se viondon pe avèitchì.\\ Gneun vèi que\-tsouza.}

\Chauffeurspeaks Ad\'on bèicho ba pe vère.

\StageDir{Lo \textsl{chauffeur} ivre la pourta é bèiche ba di poulmeun. Can cllou la pourta Jo\"{e}l ataque a prédjì. Dimèn lo \textsl{chauffeur} mioule sen que n'a dérì lo poulmeun.}
...
\Thierryspeaks\direct{A Jo\"{e}l} Ah can t'iye té Prézidàn!

\StageDir{Lo \textsl{chauffeur} ivre la pourta.}
...
\Chauffeurspeaks L'è mioù queryì le Garde Forestier pe pa èi de counte.

\StageDir{Can lo \textsl{chauffeur} cllou la pourta Jo\"{e}l ataque a prédjì.}
...
\Joelspeaks\direct{Ver tcheutte} Mé é Thierry n'en i eunna idoù! Se prégnèn no lo poulmeun é ataquèn ba?

\StageDir{Tcheutte, mouèn que Jo\"{e}lle, son d'acor é entuziaste. Lo \textsl{chauffeur} l'è euncó eun tren de prédjì i téléfonne. Jo\"{e}l pouye si lo poste di \textsl{chauffeur}.}

\Joellespeaks\direct{Dispéraye} Jo\"{e}l soplé, fièn pa le Digourdì!

\StageDir{Jo\"{e}l beutte eun martse. I mimo ten areuvve lo \textsl{chauffeur}.}
...
\StageDir{Lo poulmeun partèi ià a flama. Lo \textsl{chauffeur} lèi galoppe dérì.}
...
\Nevaouspeaks\direct{A pagàn} Ad\'on te vèi que sise Digourdì son pa it\'o de super star. V'ouite nèisì pe eunna cantin-a, voutro non l'è chortì pe eunna souaré de fita, pe la premiye pièse n'ayè catro tsatte, i premì Printemps fiavade  maque de confuj\'on é di chortie\ldots prédzen-nen pa!
...
\Ledouspeaks Pourtoù lo non de Tsarvensoù pe to lo moun\-do!
...
\Paganspeaks  Totte l'è comenchà mersì a eun \textit{court-métrage} que n'en fé avouì Alessandro Stevanon. To lo moundo l'a vu si \textit{court-mé\-tra\-ge} é l'an euncó finque queria-no a Hollywood; mi ara lamerio sentì la vouése de magàn\ldots di vèi se l'è pa vrèya seutta counta?
...
\Conducteurspeaks Bonsouar, mersì a tcheutte, voutro \textit{acceuil} toujour si chalereu m'émochoun-e todzor. Mi l'è pa pe mé que v'ouite inque, tellamente nombreu pe reumplire totte le caèye de si magnifique téatro. V'ouite inque, \textit{mesdames et messieurs}, pequé l'è arrevoù lo momàn que tcheu no, que to lo mondo l'è eun tren d'attendre: l'asségnach\'on de l'Oscar pe lo meillaou atteur protagoniste. L'è itaye bièn bataillaye. Vo rappello ara le sinque finaliste, euncó se vo sade bièn que maque eun de leur gagneré, maque eun non l'è icrì deun la busta, maque eun de leur entrerè deun l'istouére. Le sinque finaliste son:
\begin{enumerate}
...
\StageDir{Entre eunna feuille élégante avouì eunna busta rodze é l'Oscar. Lo conducteur, can la vèi, s'émochoun-e é la bèije eun per de cou. Aprì pren la busta.}
...
\StageDir{Paolo Cima Sander l'è achouatoù i mentèn di pebleuque. Can sen son non se levve eun pià tot émochon-où. Eunna lemiye s'aleumme fran iaou l'è achouatoù.}
...
\StageDir{Tro émochon-où, Paolo lèi beutte bièn de ten pe arrevé. Lo conducteur, ad\'on, tsertse de fé passé lo ten.}

\Conducteurspeaks Ad\'on lo attégnèn. Qui se l'attégnave? Tan de complemèn a Paolo, mi euncó a tcheu le-z-atre que se refàn pi eugn atro an\ldots

\Cimaspeaks\direct{Eun braillèn} N'i sbaillà chortia! Areuvvo!
...
\Conducteurspeaks\direct{A la feuille, pe fé pasé lo ten} Aprì pensa que dzen: pe eunna personna, que tanque ieur itave deun eun petchoù veladzo de montagne, arrevé inque a Hollywood, i \textit{temple}, i Mont-Olympe, a l'éillize di \textit{cinéma} mondial.
...
\Cimaspeaks\direct{Avouì la ranfan-a} Me voualà! \textit{Of course, ok, ok}. \textit{I don't} me l'attégnavo pa. \direct{Eugn eumbrachèn eunna madama} Oh madama mora\-tsa\-de-me vèi!
...
\Conducteurspeaks N'i lo plèizì de queryì si lo palque:
\begin{itemize}
...
\Conducteurspeaks Voualà son tcheu inque. \textit{Mesdames et messieurs}, a vo le Digourdì!
...
\Paganspeaks Ouè! L'atsetavon si Amazon, l'avèitsavon si l'iPhone, l'atsetavon eun tchi no; mi lo cou que n'en vendi-nen de pi l'iye l'an que n'en fé la pièse pe le dji-z-àn di Digourdì! L'iye lo 10 marse 2018 i Téatro Splendor!
...
\Maganspeaks L'iye lo Seunteucco d'eun cou: Ronny Borbey!
...
\StageDir{Se avion le lemiye \lemieSi\ si to lo palque. A gotse n'a tcheu le Digourdì, que, eunsemblo a pagàn, magàn é le dou nevaou, eurlon ver lo pebleuque:\
\begin{center}
\ldots pi Digourdì!
\end{center}
}
...
\RoleNoms{Lemiye}{Alessandro Chiono}
...
\centering
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2018/deri.jpg}
}
\end{figure}
\vfill
