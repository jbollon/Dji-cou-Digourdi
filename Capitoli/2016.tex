...
\fotocopertina{Foto/2016/gruppo.jpg}{Paolo Cima Sander (avouì son tseun Margot), Francesca Lucianaz,\\ Marco Ducly, Simone Roveyaz, Jordy Bollon, Thierry Jorrioz,\\ André Comé, Sophie Comé}{Marlène Jorrioz, Jo\"{e}l Albaney, Stephanie Albaney}{2016}

\LinkPiese{N'en pa lo ten}{https://www.youtube.com/watch?v=dc_RIE5WGek}{.5}{.75}
...
\item[$\bullet$] 1 pourtapaapleu avouì dedeun de paapleu é eugn'èima di fiolet;
\item[$\bullet$] 1 planta dérì laquella n'at catchaye 1 peura pe djouì i fiolet;
\item[$\bullet$] 5 table avouì 5 ordinateur é de baradziye de tsaque eumpléyà: plime, papì, documàn, botèille, frouite (pomme é banane deun lo téèn de Touéno), plante, tasse, mase de carte (deun lo téèn de Richard Foille);
\item[$\bullet$] 5 caèye pe l'ouficho;
\item[$\bullet$] 1 armouére avouì dedeun 2 fezì de tsasse. Lo dérì de l'armouére l'è iver pe pouèi fé entré Margot, lo pégno tseun de tsasse de Touéno Lo Gra. N'at eunc\'o d'atréssateua pe djouì i Ping Pong;
...
\item[$\bullet$] 1 atressateua pe djouì i Golf (catchaye dezò la tabla de Ottino Spritz);
...
\centering
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2016/1.JPG}
}
\end{figure}
\vfill
...
\begin{center}
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2016/0.JPG}
}
\end{center}
\vspace*{\fill}
...
\begin{center}
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2016/aa.jpg}
}
\end{center}
\vspace*{\fill}

\setlength{\lengthchar}{0.75cm}
...
\Character[TOUÉNO LO GRA]{TOUÉNO}{Tueno}{Eumpléyà réjonal fagnàn, lame medjì é bè\-ye, \name{Paolo Cima Sander}}

%mettere zucchino
\Character[GEROMINE\\ COUCHOTTA \zucchino]{GEROMINE}{Geromine}{Eumpléyaye réjonalla végane, salutiste é que lame lo \textit{Zumba}, \nameF{\\Stephanie Albaney}}

%mettere foglia
\Character[RICHARD FOILLE \foglia]{RICHARD}{Richard}{Eumpléyà, activiste pe la nateua é lo bièn di bitche, \name{Jo\"{e}l Albaney}}

\Character[FINE SAVENTA]{SAVENTA}{Saventa}{Eumpléyaye réjonalla, to lo ten attatchaye i \textit{social} pe sèi totte le bague di-z-atre, \nameF{Marlène Jorrioz}}

\Character[COURSIÉ]{COURSIÉ}{Corriere}{\textit{Courrier} avouì pocca voya de traillì, \nameF{Francesca Lucianaz}}

\Character[ÉLECTRISIÈN]{ÉLECTRISIÈN}{Elettricista}{\'Electrisièn de Palase Réjonal, \name{Thierry Jorrioz}}

\Character[SERVENTA]{SERVENTA}{Barista}{Serventa d'eunna cantin-a protso de Palase Réjonal, \nameF{Sophie Comé}}

%\Character[\hspace{1cm}]{adf}{ff}{\hspace{1cm}}
...
\centering
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2016/a.jpg}
}
\end{figure}
...
\centering
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2016/2.JPG}
}
\end{figure}
\vspace*{\fill}
...
\StageDir{Pe totta la pièse saré proyéttaye eunna \textsl{vidéo} si eun \textsl{écran} pozichon-où dérì la \textsl{scène} preunsipalla. La \textsl{vidéo} moutre eunna grousa moutra que s'arite can la \textsl{scène} partèi pe counté sen que capite a sall'aoua.}
...
\centering
  ...
  \centering
    \video\hspace*{0.5mm} \textsc{\small Moutra}\hspace*{0.5mm} \video\\\vspace*{2mm}
    \qrcode[hyperlink, height=0.5in]{https://youtu.be/7tyzy-PbmtY}
  \end{subfigure}%
  \addcontentsline{vds}{section}{Moutra}
%\vspace*{-5pt}
\end{figure}%

\StageDir{Lo palque l'è eun bur\'o réjonal. A gotse n'a l'\textsl{accueil} avouì lo trebeillet, iaou tcheu le-z-eumpléyà teumbron lo cartelleun. Fran a l'entraye, n'at eun pourtapaapleu. I mentèn di palque lèi son sinque table é sinque caèye. Deussì le table son plachà eugn ordinateur é totte sorte de documàn, plime é foillette. N'at eunc\'o eunna planta, eugn armouare de feur é eun pourtamantì.}

\StageDir{\Fv{Sitte l'è eun di pi-z-eumpourtàn bur\'o  réjonal. Aprì de jénérach\'on de poleteucco vijonéo é la crize économique, lo peuple valdotèn l'a ottin-ì eugn ate niv\'o de maturach\'on: le campagnar, le posteill\'on, le bitchoulì, le mijì, le mas\'on, le cordan-ì é surtoù le-z-eumpléyà pebleuque l'an finalemàn comprèi que la productivitoù l'è la rèise di \textsl{bien-\^etre} de la sosiétoù é la seula rotta pe chotre de la crize. Dedeun le-z-ouficho pebleuque é dedeun l'ame de tsaque pe\-tchoù eumpléyà l'è nèisì eun nouo, euncrouayablo, mistérieu é vichaou attatsemèn i travaille}}

\StageDir{Teuppe \lemieBa, avouì pocca de lemiye si l'\textsl{écran} que moutre l'aoua: chouì-z-aoue di mateun.}
\StageDir{Entre Ottino Spritz. L'è djeusto reteria-se. Saoute lo trebeillet. Vèi pa iaou beutte le pià é avouì lo téléfonne se fé de lemiye.}

\begin{drama}
\Spritzspeaks\direct{B\^aillèn} Mondjeu,  se cllèrie ren. 
\StageDir{Boueuche l'artchaou contre quetsouza.}

\Spritzspeaks Ahi que mou! L’iye mioù se restavo euncoa avouì le-z-amì a nen bèye eunc\'o eun\ldots é na, n'i pa pouì\ldots é pequé? Pequé dèyo vin-ì seu traillì! Lo deleun l’è todzor eun dizastre. Bon, comenchèn la dzornoù avouì eun dzen cllopeun. \direct{Eun tramèn quetsouza desì sa tabla} Tramèn ià so\ldots  Mondjeu oubliavo! Lo \textit{badge}! Dèyo queti-lo a Sandrino, pouèi me teumbre llou a ouett'aoue.

\StageDir{Ottino pouze son \textsl{badge} si la tabla de l'\textsl{accueil}. Aprì s'itaoule si la tabla de llou.}

\Spritzspeaks Si cou banì a tcheutte!

\StageDir{La moutra, proyéttaye si l'\textsl{écran}, avanche. Ara l'è ouett'aoue di mateun.}
...
\Thierryspeaks L'è dza ouett'aoue! Me fa timbré lo cartelleun di-z-atre eumpléyà.
...
\Sandrinospeaks L'è deleun é la \textsl{scène} recomenche. Alemèn le lemiye.

\StageDir{Lemiye \lemieSi .}

\Sandrinospeaks\direct{Eugn avèitsèn Ottino} L'atro l'è dza lé que drime.

\StageDir{Sandrino se plache a l'\textsl{accueil}.}

\Sandrinospeaks Lo journal n'en atsetou-lo\ldots betèn si la cafetchiye pouèi no no réchèn amoddo. \direct{Eugn ivrèn lo journal} N'a finque l'eunser di Fiolet é de la Rebatta! Lo avèitsèn aprì que n'i tro a fiye\ldots mon\-djeu! Lo cartelleun de Ottino Spritz!
...
\StageDir{Gene pren lo \textit{pass} é atèn Sandrino, que va ver l’ouficho pe vère se n’a caqueun. Aprì, to todzèn, tourne a l'\textsl{accueil}.}

\Sandrinospeaks\direct{A Gene} Mesieu, squezade mi n’a panco gneun disponiblo.

\Genespeaks L'è ouette é dji é n'a gneun? A ouett'aoue fa ataquì a traillì!
...
\Genespeaks Na, vardo lo \textit{pass}.

\Sandrinospeaks\direct{Comme douàn} Mesieu! Dèyade me baillì tourna lo \textit{pass}!

\Genespeaks Mé payo le-z-empoù é ad\'on vardo lo \textit{pass}.
...
\StageDir{Entre Touéno lo Gra. L'è conflo comme eun bal\'on. Pe le man l'at eun \textsl{dossier} é eun saquette.}
...
\Tuenospeaks\direct{Eun fièn eun petchoù rotto} Ouè. Té to bièn lo feun senà?
...
\StageDir{Sandrino teurie foua eun grou mase de cllo é comenche a tser\-tchì salla djeusta.}

\Tuenospeaks Acapou-la?

\Sandrinospeaks\direct{Eun tsertsèn} Seutta l'è salla di mitcho\ldots ah la voualà!

\StageDir{Sandrino ivre la pégna pourta protso di trebeillet.}

\Tuenospeaks Bièn mersì!

\StageDir{Sandrino tourne a l'\textsl{accueil}.}
...
\StageDir{Sandrino baille a Couchotta eunna coulan-a \textsl{hawaïenne}.}
...
\StageDir{Couchotta se beutte la coulan-a \textsl{hawaïenne} é s'itsaoude. Sandrino levve l'atchaou di trebeillet é Geromine, a ten de mezeucca, lèi pase déz\'o sensa lo totchì, eun fièn lo Limbo.\\ La mezeucca s'arite.}

\Gerominespeaks\direct{Contenta} Oueu l'è bièn aloù! \direct{A Sandrino} Mé diriyo que  demàn pouèn bèichì ba eunc\'o de 4 cm!

\Sandrinospeaks D’acor Couchotta, bèichèn ba totte demàn.

\StageDir{Sandrino, douàn de tournì a son poste, bèiche lo trebeillet é dimèn Couchotta s'aproste a sa tabla.}
...
\Gerominespeaks Oh! Foula mé que n'i demando-te sen que t'a medjà! Le repounse le si dza.

\Tuenospeaks \ldots é la demendze mateun n'en tchoué eun \textit{canard} é n'en medja-lo, que bon, l'iye grou pai! Aprì lo nite n'en medjà eun pégno lapeun que l'iye eunna baga \gustoso ! Mondjeu!
...
\Tuenospeaks \ldots tendro! Ouè, eunc\'o magàn que l'a maque an di, l'a to tritou-lo ba! Que bon; é pe clloure\ldots eunc\'o dou-z-où pe cayì to ba.

\Gerominespeaks Vouì pamì acouté eunna paolla de sen que te di. Prao.

\Tuenospeaks Va bièn. Pitoù té senque t'a fé? 

\Gerominespeaks\direct{Bièn contenta de repoundre} Ad\'on n'i fé de bague trè-z-euntéressante. Lo desando iproù si allaye eun Veulla pe manifesté, pe difendre le droué di dzeleunne \gallina ! 
...
%\vspace*{-1cm}
\Tuenospeaks Djeusto, l'è vrèi que té te lame pa lo salàn \salan ! 
...
\Richardspeaks Ouè, n'i atsetoù eun nouo moublo é l'è fran comoddo, \direct{eugn ézajérèn} mi te diyo que l'è comoddo! L'è comoddo pequé pouì quetì la machina i mitcho\ldots
...
\Richardspeaks Ouè! Si fran contèn é aprì si moublo servèi da matte eunc\'o pe le pouse fin-e. Te sen pa \direct{eugn aneflèn l'er} queunta grama er que n'at? 
...
\Sandrinospeaks\direct{Stouffie \stouffie} Mi va caquì seutte cllo! Fièn pouèi\ldots

\StageDir{Sandrino levve la \textit{trottinette} é la fé passé desì lo trebeillet.}

\Richardspeaks\direct{Eun prégnèn la \textit{trottinette}} Ouè fièn pi vito pèi.

\StageDir{Sandrino tourne a son poste.}
...
\Richardspeaks\direct{I collègue} Bondzor, ad\'on v'ouite eun fourma?

\Tuenospeaks Ouè, tot amoddo.

\Richardspeaks Comenchèn la senà.

\Gerominespeaks Amoddo, \direct{eun somondèn sa tase} t'ou an pégna got\-ta?
...
\Tuenospeaks\direct{Eugn avèitsèn Richard} De iaou t'areuvve? 
...
\Gerominespeaks Na, lo non me di pa ren.

\Richardspeaks Fédérach\'on pe la Santé di Coucouille valdoténe!

\Tuenospeaks Oh mondjemé! Ara si queriaou, euspleuca vèi sen que l'è seutta counta.

\Richardspeaks N'en eunna blita de travaille, sourtoù dérimente! Le coucouille fa l'èidjì, fa bailli-lèi eunna man pe le fé saouté si, leur  vouillon tsire pe tèra, mi fa le pouchì si pe l'er\ldots mi aprì\ldots le dzi vouillon le tchoué \panico !
...
\Richardspeaks\direct{A Couchotta} Touéno comprèn ren. No le coucouille l'èi\-dzèn, le pouchèn si pe l'er, lèi baillèn finque eunna man pe se reprodouiye\ldots

\Tuenospeaks\direct{Ibaì \confuso} Na, na, na, squeza-mé, finque se reprodouiye? Es\-pleu\-ca-mé seutta baga.
...
\Tuenospeaks Donque té te sariye secretéo pe pouchì eunna coucouille dedeun eugn'atra?
...
\Richardspeaks\direct{A Couchotta} Té ouè que te comprèn, t'a eunna martse eun pi. Veun avouì no, n'en fata de dzi comme té dedeun la Fédérach\'on.

\Gerominespeaks Volontchì!

\StageDir{Richard satisfé s'achouatte.}

\Richardspeaks Can mimo ara quetade-mé pédre pequé n'i le papì de la F.S.C.V. que dèyo pourté eun devàn.

\newpage
\scene[-- Petchoudacllenda\footnote{ Néolojisme eunventoù pe la Digourdì pe diye \textit{hastag}/\textit{cancelletto}/$\#$.}]

\StageDir{La moutra marque nou aoue di mateun.}

\StageDir{\Fv{Nou aoue. Finalemàn l'ouficho l'è i complette. Areuvve Fine Saventa, eumpléyaye que sensa la tecnolojì di-z-àn 2000 sa pa iaou bouéchì la tita. Sensa lo téléfonne sa dzornoù sariye vouida é platta}}
...
\Sandrinospeaks Mi ouè lèi manqueriye!

\StageDir{Fine teurie foua lo téléfonne é fé eun \textsl{selfie} avouì Sandrino. Si l'\textsl{écran} chor foua, pe eun per de secounde, la fotografie de Saventa e Sandrino.}

\foto{https://www.instagram.com/p/BD_MwP8nEFL/}{Saventa $\&$ Sandrino}

\Saventaspeaks\direct{Eugn icrièn si lo téléfonne} Donque\ldots petchoudacllenda deleunmateun, petchoudacllenda sandrinotodzorveuste, pe\-tchou\-da\-cllen\-da sensabriochesecomenchepa.

\Saventaspeaks \direct{Eugn avèitsèn lo trebeillet} Sandrino! Coudiye que t'a panco iver-me?
...
\StageDir{Sandrino ivre la pégna pourta protso di trebeillet é Saventa entre eugn ouficho. Aprì la fremme é torne a l'\textsl{accueil}.}
...
\Saventaspeaks\direct{A Richard} Richard t'ioù armagnaye \albicocca\ ou vouida?
...
\Tuenospeaks Se l'a prèi-lo eun tchi Bisson l'è finque trio!

\Saventaspeaks Ouè son kilomètre zéro!

\Richardspeaks Mi comèn fièn a diye kilomètre zéro? Soplé! Seu pré\-dzèn de Gressan-Tsarvensoù: n'a pa zéro kilomètre. N'a a di 1 kilomètre. Soplé fiade le pountuel!
...
\StageDir{Touéno pren la brioche é lèi beutte eunna banane dedeun.}

\StageDir{Tcheutte lo avèiston mal.}

\Richardspeaks\direct{A Touéno} Se pou pa te vère. Te fé fran acro \digouto !
...
\StageDir{Si la tèila l'è proyettaye eunna \textsl{vidéo} iaou véyèn Touéno teryì eun creppe de fezì si eugn aoujì  plachà si eunna brantse de eunna planta, déz\'o laquella Richard l'iye eun tren de fé eunna boccon-où avouì sa fameuille.}

\StartVideo{https://www.youtube.com/watch?v=Rl-CojTfsVc&t=7s}{Touéno Lo Gra vs Richard Foille}

\StageDir{Tcheutte s'achouatton a leur poste, mouèn que Richard que ataque a deusqueté avouì Touéno.}
...
\StageDir{Richard s'achouatte a son poste.}
...
\Tuenospeaks Fièn la belote. Mé me tramo pa, vegnade sé eun tchi mé.
...
\StageDir{Ottino vionde lo queusseun é tourne a drimì.}
...
\Richardspeaks Tourna mé avouì Geromine? Perdèn todzor mé é lleu, lleu l'è fran eun dizastre. \direct{A Couchotta} Té t'ariye fran fata de eunna périodda avouì Gallo\ldots ah se te driche.
...
\StageDir{Sandrino queurie Touéno.}
...
\StageDir{Entre eun coursié avouì eun pourtapaque pe transporté eun cart\'on de Spritz é eun paquette de papì.}

\Corrierespeaks\direct{A Sandrino} Bondzor n'i eun cart\'on pe Ottino Spritz!

\Sandrinospeaks Va bièn, eun momàn\ldots

\StageDir{Mima \textsl{scène} di cllo, iaou Sandrino lèi beutte eunna blita de ten pe ivrì lo portaille.}

\Corrierespeaks Ouè boudzade-v\'o, mé n'i pa to si ten.

\StageDir{Sandrino douàn de ivriye entre eugn ouficho é se dirije ver le djou\-yaou de la Belote.}
...
\StageDir{Tcheutte catson le carte é se plachon douàn l'ordinateur de Touéno eun fièn seumblàn de travaillì. Sandrino chor de l'ouficho é tserste le cllo.}
...
\StageDir{Sandrino ivre lo portaille é tourne a son poste. Lo coursié entre deun l'ouficho.}

\Corrierespeaks Bondzor. Senque v'ouite eun tren de fiye tcheu seuilla?

\Richardspeaks Fièn eunna retsertse\ldots

\Gerominespeaks \ldots de martchà.
...
\StageDir{Tcheu moutron avouì lo dèi la tabla de Ottino. Lo coursié s'a\-pro\-tse a Ottino.}
...
\Corrierespeaks Ouè n'i comprèi, quetèn pédre \stufo. \direct{A Ottino} Dimèn betade eunna croué seuilla.

\StageDir{Ottino avouì la plima firme eun documàn si lo téléfonne di coursié.} 
...
\StageDir{Richard se levve é pren le paquette é le plache déz\'o son \textsl{écran}.}

\Richardspeaks N'ayoù fran fata pe beté-le déz\'o l'\textit{écran} de mé.

\StageDir{Lo coursié s'aprotse a la chortia de l'ouficho é Sandrino areuvve avouì le cllo.}
...
\StageDir{Lo coursié chor de \textsl{scène}, Sandrino cllou lo portaille é tourne a son poste.}
...
\Tuenospeaks Tourna ià la lemiye!

\Richardspeaks \`Eita que mogà va finque bièn pouèi.

\Tuenospeaks Comèn finque bièn?

\Richardspeaks Pequé pouèi consemèn  mouèn d'énerjì deun noutra Réj\'on!

\Gerominespeaks Ouè si d'acor.

\Richardspeaks Acoutade-mé, n'i eunna dzenta man, fa alé eun devàn. Cher collègue \og foua le lemiye comme eun megniye\fg ! 

\StageDir{Le catro belotiste teurion foua eunna \textit{lampe frontale} é se la plachon si la tita. Dimèn areuvve eun électrisièn avouì eunna lemiye eun man.}

\Elettricistaspeaks\direct{A Sandrino} Salì, si seuilla pe l'électrisitoù.

\Sandrinospeaks Areuvvo! Tsertso le cllo. Fiade-mé tchica de lemiye, que dza l'acappo pa avouì la lemiye\ldots feguea-té i teuppe!

\StageDir{Sandrino avouì l'èidzo de l'électrisièn tsertse le cllo é ivre lo portaille.}

\Sandrinospeaks Entrade maque, queutto iver, can chortade cllou\-za\-de.
...
\StageDir{L’électrisièn trafeutse eun momàn a l'anglle de l'ouficho. Aprì eun per de seconde le lemiye se avion \lemieSi .}
...
\Elettricistaspeaks \direct{Eugn avèitsèn le carte de Geromine} Mi na t'i eunna tsasotta! Djouya lo valet d'atoù!
...
\Richardspeaks Mi mé pouì pa te diye sen que n'i! Té pitoù, se t'a eugn asse \asso dénonsa-l\'o!

\StageDir{Geromine é Richard se mandon a caqué é van a s'achouaté a leur poste. Dimèn Saventa s'aprotse a Touéno.}

\Saventaspeaks Touéno fièn an pégna fotografie pe rappelé si mo\-màn!
...
\StageDir{Saventa é Touéno se fan eun \textsl{selfie} é, to de chouito, Saventa lo tsardze si Instagram.}

\Saventaspeaks Donque\ldots petchoudacllenda lerèidelabelote, petchoudacllen\-da tchicaderepoùéaprìnotraillèn.

\StageDir{La fotografie l'è proyettaye si l'\textsl{écran} pe caque secounda:}

\foto{https://www.instagram.com/p/BD_LvPjHECV/}{Pouteun a Saventa}

\StageDir {Saventa s'achouatte a son poste.}

\StageDir {Silanse.}

\scene[-- G.B. di '95]

\Saventaspeaks Richard! N'i acapoù si Facebook eugn articllo pe té!
...
Lo Prézidàn de la Fédérach\'on, devàn lo dzeudzo, l'a accuz\'o lo grandjì  eun dièn: \og Son de personne cruelle! Groppon le quiye di vatse i plaf\'on, sensa gneun motif é gavon a la bitche salla pocca d'euntimitoù que l'at!\fg.

\Richardspeaks Djeusto! A fose eun que pense eunna mietta i bitche. Pensade a seutte poue vatse; todzor itaye topaye, mi ara lèi levvon la quiya é tcheutte vèyon sen que l'an déz\'o. Mi vo semble lo case?

\Gerominespeaks T'a rèiz\'on, poue vatse \triste.

\Tuenospeaks Mi comèn poue vatse? Lèi groppon la quiya pe le-z-aryì! 

\Richardspeaks L'è comme se té te fusse sensa ganes\'on! Saré pa normal!
...
\Tuenospeaks Mi l'è normal gropé le quiye pe le-z-aryì!
...
\StageDir{Touéno queurie Sandrino i téléfonne.}

\effet{https://soundcloud.com/user-234168361/telefono}{Téléfonne}[false]

\StageDir{Sandrino rep\'on.}

\Tuenospeaks Sandrino n'i eunna prateuca bièn eumpourtanta, soplé, te vériye inque?
...
\StageDir{Sandrino tourne a son poste é comande le cafì.}
...
\Tcheuttespeaks \ldots é voualà eun pon de tréze dzor \fita!

\StageDir{Entre eunna serventa avouì eun \textsl{cabaret} plen de tasse.}

\Baristaspeaks Bondzor Sandrino, te me ivre lo portaille?

\Sandrinospeaks Ouè.

\StageDir{Sandrino se levve é gnouye la retsertse de la cllo.}
...
\StageDir{Saventa fé an foto i \textsl{cappuccino}. La fotografie l'è proyéttaye si l'\textsl{écran} pe eun per de secounde.}

\foto{https://www.instagram.com/p/BD_M4GRnEFf/}{Cafì di mateun}

\Saventaspeaks\direct{Eugn icrièn si lo téléphonne} petchoudacllenda cafìlomateun, petchoudacllenda lobarnovoudibièn.
...
\Baristaspeaks\direct{Ver tcheutte} Pe payì?
...
\Baristaspeaks Ad\'on vo queutto a voutro travaille, boun-a dzornoù!
...
\Sandrinospeaks Gars\'on! L'è eun tren d'arrevé lo cappe \panico !
...
\StageDir{Le-z-eumpléyà tramon le table é plachon eun grou matelasse dézò lo trebeillet. Lo Directeur se tsandze avouì eun arbeillemèn sportif.}
...
\StageDir{Trèisoù saoute lo trebeillet eun fièn eunna pirouette si pe l'er. Can tsi desì lo matelasse, tcheu lèi boueuchon di man, entuziaste.}
...
\Saventaspeaks\direct{Eugn icrièn si lo téléphonne} petchoudacllenda SiL'èMon\-Cap\-pe, petchoudacllenda Trèisoùeugnézeumplope\-tcheut\-te é pe\-tchou\-da\-cllen\-da decappecommetélamammanenfépamì
...
\StageDir{Tcheutte beutton eugn odre l'ouficho: gavon ià lo matelasse é plachon amoddo le table comme l'ion douàn. Lo cape se beutte la tsemize é le pantal\'on.}

\scene[-- Course pe le dipendèn]

\Treisouspeaks\direct{Ver Sandrino} Sandrino, beutta djeusto seu de foua lo cartel  \og Uficho cllouzì pe course di dipendèn\fg.

\Sandrinospeaks Ouè, l’è dza preste.

\StageDir{Sandrino plache lo pannel douàn lo trebeillet.}

\StageDir{Trèisoù, eugn avèitsèn avouì supériorité le dipendèn, comenche a fé eunna léch\'on si comèn prodouiye de pi.}
...
\Treisouspeaks\direct{\'Enerjique} Pequé se mé vouillo tsandjì, pequé se vo v'ou\-èi\-de voya de tsandjì\ldots to lo mondo pou tsandjì!

\Tcheuttespeaks\direct{Comme douàn} Ouè!

\Treisouspeaks Ara ataquèn lo course. N'i aprestoù eunna prézentach\'on pe vo-z-esplequì le noue metode pe massimizé la produch\'on deun le-z-ouficho pebleuque. \direct{Ver Touéno} Touéno te me prite ton ordinateur?

\StageDir{Touéno s'ajite é comenche a clloure de vidéo/fotografie.}

\Treisouspeaks\direct{Eugn avèitsèn l'\textsl{écran}} \ldots é totte seutte fenne?

\Tuenospeaks Na, na, ren\ldots \direct{eun baillèn de creppe si lo \textsl{clavier}} ESC, ESC, ESC!
...
\sound{https://soundcloud.com/user-234168361/scherzi-a-parte-sottofondo}{Gbl 386 - Stomp cherzi - Giampiero Boneschi}[false]

\StageDir{Teuppe \lemieBa\ a drèite di palque. La mezeucca s'arite.}

\StageDir{Entre lo vioù.}

\Genespeaks Si tourna seuilla\ldots

\Sandrinospeaks Me diplì mesieu, se vegnavade sinque meneutte fé sa\-yo\-on tcheutte disponiblo.

\Genespeaks Senque?

\Sandrinospeaks Se arrevavade sinque meneutte fé sayoon tcheutte disponiblo.

\Genespeaks Senque?

\Sandrinospeaks\direct{Eun braillèn, eunna paolla pe cou} Se arrevavade sinque meneutte fé sayoon tcheutte disponiblo!

\Genespeaks\direct{Malechà} N'i comprèi, l'iye maque pe diye \og euh, mi l'è pa poussiblo\fg!
...
\Genespeaks Na, n'i pa lo ten; vo mando caqueun que vo rèche! Inutilo! Tche\-tchasoù! Mé payo le-z-empoù é vo ren! Inutilo!
...
\StageDir{La moutra marque onj'aoue. Touéno l'a djeusto gagnà contre Richard.}

\Treisouspeaks \ldots é ara Touéno contre Couchotta. Dériye partia, djeusto eun tsandzo: qui gagne, gagne. Rapello le riille mesieu: si que gagne déside qui euntre vo-z-atre ite inque tanque choui-z-aoue pe fé le prateuque de tcheutte\ldots dimèn que le-z-atre son ià pe se divertì.
...
\StageDir{Touéno baille eun creppe sèque é fé lo poueun. Saoute si pe l'er to contèn, le-z-atre bouéchon di man é lèi fan la fita. Couchotta l'è dispéraye.}
...
\StageDir{Eun remersièn Touéno, le-z-eumpléyà tramon le table a leur poste. La moutra marque midz\'o.}

\newpage
\scene[--  Feun dzornoù]

\Treisouspeaks Vi que l'è belle midz\'o, mé dirio que pouèn alé no divertì!

\sound{https://soundcloud.com/user-234168361/canzone-finale}{Samba Degli Assenteisti - Bruno Zambrini}

\StageDir{Eun aprì l'atro le-z-eumpléyà chorton de l'ouficho, mi douàn de chotre queutton si la tabla de Geromine le prateuque que derè fée.\\ A ten de mezeucca, tsaqueun chor avouì quetsouza que dimoutre sen que feré pe totta l'iproù.\\ Saventa s'arbeuille pe alì colaté é teurie foua eun per de-z-esquì; Ottino chor avouì totta l'attressateua pe djouì a golf; Sandrino se beutte eunna maille di Tsarvensoù Fiolet é chor avouì eugn'èima é eunna peura; Richard s'arbeuille pe alì eun beseclletta é chor desì eun petchoù vél\'o di mèinoù; Touéno é Trèisoù s'arbeuillon pe la tsasse, prègnon le fezì é de l'armouére teurion foua lo tseun de la tsasse: eun cré barbontcheun!}

\StageDir{Fenèi la mezeucca.}

\StageDir{Lemiye base.}

\StageDir{Couchotta, dispéraye, pouze la tita si la tabla.}

\StageDir{\Fv{Ouè, sit an le Digourdì l'an beun tchica ézajéroù avouì leur sarcasme, l'è vrèi. Mi lamérian quetì deun tcheu vo eunna pégna refléch\'on. Sen-n\'o cheur de itre contèn de noutro travaille? No baillèn totte noutro eungadzemèn pe bièn réusì i rézultà final? No metèn tcheu le dzor la paye? I ten que no viquisèn, a vo la reponsa}}
...
\RoleNoms{\textit{Vidéo} é son}{Laurent Barmaverain}
...
\centering
\whiteshadowbox{
\includegraphics[height=5.5cm,keepaspectratio]{Foto/2016/f.jpg}
}
\end{figure}
\vfill
