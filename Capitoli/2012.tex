...
\fotocopertina{Foto/2012/gruppo.png}{\small Pierre Savioz, Ilaria Linty, Francesca Lucianaz, Stephanie Albaney, Stefano Vermillon, Jo\"{e}l Albaney, Simone Roveyaz, Giada Grivon, Jasmine Comé, André Comé, Jordy Bollon}{\small Jean-Marc Savioz, \'Etienne Linty, Ester Bollon, Aimé Squinabol,\\ Laurent Chuc, Philippe Vermillon, Marco Ducly, Julie Squinabol,\\ Michel Ventrice, Lilys Galloni, Paolo Cima Sander, Sophie Comé, Jo\"{e}lle Bollon}{2012}
%\vspace*{-1cm}
\LinkPiese{Eun drolo de distributeur}{https://www.youtube.com/watch?v=8yMGnxab5aY&list=PLBofM-NS_eLJUln45l7VH457fGak_Bk5O&index=9}{.75}{.6}

\input{Souvenir/2012}
\input{Queriaouzitou/2012}

\Scenographie
\begin{itemize}
\item[$\bullet$] 1 distributeur \textit{automatique} d'éve, ate pi de dou mètre é lardzo trèi pa. L'at eunna brotsetta i mentèn, iaou le dzi pouon terì l'éve. Desì la brotsetta lèi son dji bot\'on pe séléchouì le caletaye d'éve. Eun pi, desì la machina, n'at eun grou pleuro iaou le cantognì mi\-cllon de poutreungue pe apresté le caletaye d'éve que le sitouayèn séléchouon;
\item[$\bullet$] 1 grou lenchoueu pe toppé la machina;
\item[$\bullet$] Pe le cantognì desì la machina, totte sorte de baradziye pe apresté le caletaye d'éve (1 modeun, pousse coloraye, benzin-a, erbe\ldots ) é de confettì\footnote{ \textsc{Larouss.fr} - \textit{Mince rondelle de papier coloré qu'on lance par poignées lors de certaines festivités (carnaval). À l'origine, confetti est un pluriel (confetto = boulette de plâtre frais roulée, confectionnée à la main, remplacée plus tard par un petit rond en papier dans les festivités du carnaval). Ce mot niçois et italien s'est imposé en français comme un singulier.}};
\item[$\bullet$] Pe le sitouayèn: botèille, tsaèn, boteill\'on (eun vèyo ou eun plasteucca) pe terì l'éve;
...
\item[$\bullet$] 1 pal de la lemiye;
...
\centering
\whiteshadowbox{
\includegraphics[height=5.5cm,keepaspectratio]{Foto/2012/a.JPG}
}
\end{figure}
...
\centering
\whiteshadowbox{
\includegraphics[height=5.5cm,keepaspectratio]{Foto/2012/1.JPG}
}
\end{figure}
\vspace*{\fill}

\setlength{\lengthchar}{2.90cm}

\Character[ATTILA]{ATTILA}{Attila}{Cantognì cost\'o, grou ventro, todzor arbeillà eun man\-dze queur\-te é avouì tan de-z-àn d'espérianse eun Quemeua, \name{Simone Roveyaz}}
...
\Character[GIADA]{GIADA}{Giada}{Femalla que pase pe case protso di distributeur, \nameF{Giada Grivon}}

\Character[PIERLUIGI]{PIERLUIGI}{Pierluigi}{Comandàn di-z-alpeun,\\ \name{Marco Ducly}}

\Character[SEUR\\ CLARETTA]{SEUR}{Seur}{Seur que l'at a queur lo bièn spirituél (é surtoù si économique) de l'èillize, \nameF{\\Sophie Comé}}

\Character[V\'ETCHOT]{V\'ETCHOT}{Vetchot}{Ommo ansièn di péì, bièn euntredeutte \name{Michel Ventrice}}

\Character[PROSPERO]{PROSPERO}{Prospero}{Vioù bièn veuste que lame s'euntremelé deun le-z-affée di-z-atre, todzor avouì la repounsa presta \name{Joël Albaney}}

\Character[VOLONTÉO\\ DI SECOUR]{VOLONTÉO}{Volontero}{Volontéo di premì secour, bièn fier d'itre volontéo é di drouet que lèi baille, \name{Pierre Savioz}}
...
\Character[NAIMA]{NAIMA}{Naima}{Femalla tunizine avouì sinque mèinoù; tsemie to\-dzor avouì eun grou tsaèn si la tita, \nameF{\\Ilaria Linty}}

\Character[]{\hspace*{1cm}}{qq}{\hspace{1cm}}

\Character[FRANÇOIS]{FRANÇOIS}{Francois}{Lo pi\'on di péì, \name{Marco Ducly}}

\Character[TROUPE RAI]{JOURNALISTE RAI}{Journaliste}{Journaliste fenna di TG valdotèn, eunterprétaye pe \textsc{Giada Grivon}; opérateur \textit{vidéo} de RAI 3, \name{André Comé}}

\Character[]{MACHINA}{Machina}{\hspace{1cm}}
...
\centering
\whiteshadowbox{
\includegraphics[height=5.5cm,keepaspectratio]{Foto/2012/2.jpg}
}
\end{figure}
\vspace*{\fill}
...
\StageDir{ Di dou coutì di palque entron Attila (a drèite) é Diego (a gotse). Attila l'at avouì sé eun abrosaque é l'et arbeillà avouì eunna crè flanella. Diego, i contréo, l'è bardoù tanque i cou é se frotte le man pe lo frette.}
...
\Attilaspeaks\direct{Per la pachense} Eunc\'o? Mi vouè, no fa mandé a la bro\-tsetta la caletoù d’éve que le dzi l’an cherdì!
...
\Attilaspeaks Pe mé, can arrevèn a ouet aoue n’a praou é d'avanse.

\Seunteuccospeaks Se n’i deu choui-z-aoue, l’è choui-z-aoue, va-ti bièn? A do-z-aoue de l’iproù vo baillon pi lo tsandzo d'atre dou\ldots é pe lo nite de dji a chouì s'i eun tren de pensì de criì torna vo.
...
\Diegospeaks \direct{Malisieu} Ouè, l’an beun deu-me-l\'o\ldots \malisieu

\Diegospeaks \direct{Suspecteu} Senque l'an deu-te?

\Seunteuccospeaks\direct{Eun copèn la counta di dou} Seutta l’et eunna situach\'on d’émerjensa!

\Diegospeaks Mi comèn trèi \textit{turni}? Véyo coute to so a la Quemeun-a?

\Seunteuccospeaks So son pa de-z-affée que vo regardon!

\Diegospeaks Na, sarèn pa de problème de no dou mi de totta la populach\'on de Tsarvensoù\ldots

\Attilaspeaks \ldots é squezade-mé, avouì totte seutte spèize, dedeun lo pat de stabilitoù comèn fiade a resté?

\Seunteuccospeaks Mi pensa pitoù a la tin-a de stabilitoù can te torne lo nite i mitcho! Can mimo, se n'i deu choui-z-aoue l'è choui-z-aoue, pa eunna meneutta pi tar! Bon ara mé vou, pequé sarèn dza tcheut lé a m’atendre. Salì é a choui-z-aoue! 

\StageDir{Lo Seunteucco chor.}

\Attilaspeaks Mi di-me té se fa féye no si travaille! Avouì to sen que n'en a féye pe la quemeun-a!

\Diegospeaks Mi l'è pa ren sen. L'è que no fa resté lé a la machina tanque no baillon pa lo tsandzo!

\Attilaspeaks \ldots é aprì féye le trèi \textit{turni} perqué le dzi veugnon a prende l'éve a totte-z-aoure! Ah, mi mé me féyo pi apresté pe la fenna eun paneun avouì eunna grousa \textit{cotoletta} eumpanaye.
...
\Attilaspeaks Mi \direct{eun moutrèn lo seun grou bri} gnenca pe sondzo! T'a maque a te organizé devàn, comme mé!
...
\Diegospeaks Pe bèye? Mi n'en lo distributeur de l'éve seuilla!

\Attilaspeaks Te bèi pi té sen. Mé n'i todzor avouì mé eunna gotta de veun \direct{ivre l'abrosaque é teurie foua eun boteill\'on} perqué lo paneun fé sèi.

\Diegospeaks \direct{Avouì eun ton malisieu, eugn avèitsèn lo boteill\'on} Eun boteill\'on de dou litro! Cheur d'avèi-nèn praou? 
...
\Attilaspeaks Ouè, si qué que la Pro-Loco l’at aprestoù eunna mordia pe tcheut. 

\Diegospeaks Ad\'on vito alèn!

\StageDir{Chorton tcheu dou. Teuppe \lemieBa .}

\scene[-- L'inaougurach\'on]

\ridoiver

\StageDir{Lemiye \lemieSi .\\ Totta la pièse vionde a l'entor d'eunna machina de distribuch\'on  de l'éve, plachaye a gotse di palque. La particularitoù de si distributeur l'è que baille tan de calitoù d’éve. La machina l’a maque eunna brotsetta é dameun lo distributeur l'è plachà eun grou pleuro. Pe l'inaougurach\'on la machina l'è topaye pe eun grou lenchoueu. \\ Eun scène, a gotse, douàn lo distributeur, n'at Attila, eun vallet de veulla, lo Seunteucco é lo préye avouì son servàn de messa; a drèite, n'a totta la populach\'on : lo cap di groupe di-z-alpeun avouì leur gonfal\'on, la tsantiì, eun fotografe, dou mèinoù de la Gaie Famille é bièn d'atre dzi.\\ Si lo fon di palque n'at eunna tèila iaou l'è proyettaye l'icrita: \og \textit{\mbox{Acqua} Santa Colomba}\fg. Pe clloure, comme décor, a gotse l'è plachà eun cartel avouì icrì de mésadzo pe le sitouayèn é a drèite n'at eunna banquetta é eun pal de la lemiye.}

\Seunteuccospeaks\direct{Avouì bièn d'entouziasme} \textit{Mesdames} é \textit{messieurs}, sitoua\-yèn de Tsarvensoù, bondzor a tcheut é bienviì a l'inaougurach\'on de seutta moderna machina, frouì de la meillaouza tecnolojì!
...
\Seunteuccospeaks Mersì, mersì. Seutta l'è la premiye Bouteucca de l'é\-ve que ivrèn eun Val d'Outa. Vio de cou atsetèn de botèille d'éve que sen pa de iaou veugnon? \'E ad\'on l’Amministrach\'on diqué l’a fé? L'a pensoù de beté 18 caletaye d’éve\ldots
...
\Seunteuccospeaks \ldots dji caletaye d’éve
 ...
 \StageDir{Le dzi tornon bouechì di man eunc\'o pi for.} 
...
\Seunteuccospeaks  Dji caletaye d’éve
 diffiente pe bailli-vo la possibilitoù de chédre queunta vo euntéresse. Mersì a eun pégno èidzo réjonal n'en pouì beutté a si distributeur eun \textit{software} de dérì jénérach\'on. Pe chédre l'éve que vo euntéresse baste eunsérì \direct{eun terièn foua eun paquet de \textit{tessere}} seutta \textit{tessera}\ldots
  ...
  \StageDir{Lo Seunteucco baille le \textsl{tessere} a la populach\'on.} 
 
\Seunteuccospeaks \ldots  chédre la tipolojì d’éve volua é voualà que chor lo prodouì que v'ouèi comandoù. Ouè mé cher sitouayèn, si cou pouade eumpléyé l'éve de voutra quemeun-a pe féye de tot: se pou seumplemàn la bèye naturella ou \textit{mousseux}, eumpléi-la pe varì sertène patolojì é, se voulade, finque la vardé desù la crédense comme éve bénédiya!

\StageDir{Le dzi tornon bouechì di man bièn for.} 

\Seunteuccospeaks \ldots é fenèi pa lé! L’Amministrach\'on comunale l’a pensoù a eun discour sosial: eun se trouèn seuilla a féye la quiya, pe prende l’éve, le dzi l’an la possibilitoù de se cognitre é de sosializé. Pe tcheu sise motif, vouillo remersié totte le-z-aouto\-ri\-toù: ma Jeunte é to lo Consèille comunal, le consèillì réjonal, lo chef di groupe di-z-alpeun, lo serdzèn di pompì, Monseur de noutra parotse\ldots

\Donspeaks \direct{Stouffie} Amen! \stufo

\StageDir{Lo Seunteucco s'arite é comprèn d'itre tro tchatchar\'on-a.}
...
\Donspeaks \ldots l'è eunna rezoursa que l'a queuttou-no noutro Bon Djeu, mi que chouèn l'è pa appréchaye pe le dzi. L'éve\ldots

\Dzispeaks Amen!

\Donspeaks que l'a fé é feré todzor de miacllo, l'è lo bièn pi eumportàn pe vivre\ldots pe la viya de l’ommo. \'E aprì que dimandé de pi a noutro Seunteucco que, mersì a sa sensibilitoù, l’a beuttoù eunc\'o la calitoù de l’éve \ldots
...
\StageDir{Don Carmelito, avouì l'èidzo di servàn de messa, pren l'\textsl{as\-per\-soir} pe la bénédich\'on.
Lo chef di groupe di-z-alpeun baille l'\og attenti\fg é tcheutte repoundon a l'odre. A si poueun, lo prée prononche caque paole eun lateun é bénédèi la machina.\\ Aprì la bénédich\'on, la tsantiì ataque eun \textit{Salve Regina} pocca eunton-où.} 
...
\Seunteuccospeaks Ad\'on remercherio euncoa Monseur de noutra parotse, lo cappe di-z-alpeun, le pompì, la Pro-Loco que l'a a\-pres\-tou-no eun petchoù \textit{casse-cro\^{u}te} é aprì remersio eunc\'o la tsantiì\ldots Na! La tsantiì na! Vo remersio tcheu vo seuilla prézèn!

\StageDir{Dimèn dou mèinoù de la Gaie Famille, douàn la Bouteucca de l'éve, sopendon eun lon ribàn neur é rodzo. I mimo ten arreuve Attila avouì eun grou sicateue. Lo baille i vallet, que lo moutre i Seunteucco. Sensa tan d'atre soluch\'on, lo Seunteucco pren lo sicateue é finalemèn l'è preste pe copé lo ribàn pe l'inaougurach\'on di distributeur.}

\Seunteuccospeaks Decllaro iverta la Bouteucca de l'éve!

\StageDir{Le dzi boueuchon di man, mi lo Seunteucco arreuve pa a copì lo ribàn. Pe l'èidjì eunterveun Attila que avouì eun grou Opinel lo coppe a mèitchà.\\
Teuppe \lemieBa .}
\newpage
\scene[-- George é l'éve naturella]

\StageDir{L’è choui-z-aoue di mateun.}

\effet{https://soundcloud.com/user-234168361/verso-del-gallo}{Chan di pou}

\StageDir{Desì la Bouteucca de l'éve, iao l'è plachà eun grou pleuro, n'a le dou cantognì que son dza prest pe fé leur servicho. Naturellamente son panco bièn réchà \sbadiglio .\\ A drèite, iao n'at eunna banquetta pe s'achouatì, arreuvon le premì dzi: eunna mamma avouì eunna petouda é eunna madama (Claudine) bièn arbeillaye avouì eun crè tseun deun sa boursa. La mamma avanche ver la machina é teurie eun litre d'éve. Dimèn, Attila, avouì eun grou modeun pe la polenta, modde le potreungue que Diego tappe dedeun lo pleuro. Can la mamma l'a fenì de terì l'éve, chor foua avouì sa feuille é la madama avouì lo tseun s'aprotse i distributeur.}
...
\StageDir{Claudine teurie foua la \textsl{tessera} é l'eunsérèi deun la machina. Dimèn areuvve eun mètre di-z-esquì (Giaco) avouì an quése de botèille. Semble bièn pris\'o .}
...
\StageDir{Gnaque lo bot\'on de l’éve cherdiya. Le dou cantognì l’an pa comprèi queunta éve l’è itaye cherdiya.}
...
\Giacospeaks\direct{Eun tsemièn nervezamente} Ad\'on no no boudzèn?! Nen pouì pamì! Dèyo fé les\'on mé é l'è do-z-aoue de ten que si protso \direct{eun moutrèn Giada} de seutta stoufianta!
...
\Claudinespeaks\direct{Offenchaye} Mé me rècho totte le mateun pequé dèyo porté George a féye le bague de llou\cacca .
...
\Claudinespeaks L'è lo tseun de mé!
...
\Giadaspeaks Ah, l’è-tì bon-a salla?

\Giacospeaks\direct{Bièn blagueur} Seutta? Seutta l'è la rèina di-z-éve! Te fé féye de rotte que te le sen tanque a Seneun! 

\Machinaspeaks  Eun-se-rì la \textit{tes-se-ra}.

\Giacospeaks Eun momàn de pachense!

\StageDir{Pierre eunserèi la \textit{tessera} é plache eun boteill\'on. Aprì selechoun-e la caletoù é le dou cantognì gnoun-on a tappé ba deun lo pleuro totte sorte de pousse blantse.}

\StageDir{Aprì doe seconde se sen eun son deun seblé \fischietto : lo vallet de veulla  entre eun scène é se plache douàn Giaco.}
...
\StageDir{Giaco conteneuvve a eumpleure le boteill\'on. Areuvve eunc\'o eugn alpeun que s'achouatte si la banquetta pe atendre.\\ Dimèn le dou cantognì traillon pe vouidjì l'éve cherdiya.}
...
\Giacospeaks Orvouar! \direct{Eun terièn foua di pourtafoille dou beillette é eun le baillèn i vallet é a Giada} Ah se v'ouèide fata de eunna les\'on, vo queutto lo beillette. Queriade-mé! Tanque! 
...
\Pierluigispeaks Mi se pou pa féye eugn'esséch\'on? L’è pa pe mé, mi pe lo sièje di groupe.

\StageDir{Dimèn si la banquetta s'achouatte eunna Seur.}

\Valletspeaks Se l’è na, l’è na! Seuilla son tcheut igale.

\Pierluigispeaks N'i comprèi que sen tcheut igale, mi comèn fiyo oueu l'aviproù avouì le-z-alpeun sensa l'éve de sen Grat?
...
\StageDir{Partèi eunna réclamme que sponsorize l'éve de \textit{Sainte Colombe}\footnote{ Malerezamente n'en pa accapoù la \textit{vidéo}. L'è poussiblo la veure (mal) eugn avè\-i\-tsèn la \textit{vidéo} de la pièse. Pouèn deue que n'ayè eunna botèille d'éve que colatèe ba pe eun prou. Ester Bollon, métresse di-z-esquì, la chouivèi tanque i fon di prou. A la feun, pren la botèille é braille: \og L'\'eve de Senta-Colomba, se te la bèi l'è eunna bomba!  \fg.}.} 
...
\Pierluigispeaks Cheur! Se prégnaon la Chiabotto cheur lèi coutave mouén!
...
\StageDir{La Seur se teurie si la soutane pe terì foua di tsaous\'on la \textsl{tessera} é dimèn Pierluigi é lo vallet avèitson queriaou si drolo de comportemèn. Aprì èi prèi la \textsl{tessera}, la Seur l'eunsérèi deun lo distributeur.}

\Machinaspeaks Ché-dre la cale-cale-cale\ldots

\StageDir{Pierluigi baille eun creppe i distributeur. Dimèn entre eugn atro vé\-tchot que s'achouatte protso de Prospero.}

\Machinaspeaks Ca-le-toù de l'é-ve.
...
\Seurspeaks Ouè é inque a dou dzor torno aoutre avouì le maladdo di péì. Ad\'on pensavo de pourté eun per de litre é de le vendre. Que restise euntre no\ldots \direct{eun bèichèn la vouése} inque la payo satte santime é aoutre la vendo a seun \textit{euro} i litre! Pe lo bièn de l’èillize!

\Pierluigispeaks Ouè cheur\ldots lo bièn de l'èillize! Mi eugn éffé l'è pa mal comme magniye pe féye le sou. Caze caze dèyo prédji-nen avouì lo directif: se arrevisan eunc\'o no a vendre la noutra de sen Grat\ldots magà eunsemblo i \textit{vin brulé} a la véillà de Tsarvensoù\ldots
...
\Pierluigispeaks Ah cheur\ldots é aprì se t'i alpeun te la paye eunc\'o mouèn. L'è cllè que te fa alì eun Quemeua fiye eun papì asprése pe seutta dzenta é comodda ajévolach\'on. Mi squezade\ldots se vou\-illa\-de poua\-de vegnì eunc\'o vo amì di-z-alpeun! Pouai pe tsaque sinque litre que teriade reusparmiade eunna santima.
...
\Pierluigispeaks Mi senque diade? Mé l'è dza eun momàn que si seuilla é ara totse a mé.

\Prosperospeaks Mi lèi penso fran pa \arrabbiato. Mesieu lo vallet sit fé lo feun!
...
\StageDir{Lo vallet acompagne lo vétchot a la banquetta é aprì tourne protso di distributeur pe controlé la discuch\'on.}

\Prosperospeaks\direct{A Pierluigi} La quiya l'è la quiya. \direct{I vallet} L'an la plima eun tita é penson de itre va sai qui! Alisan ba a l'Adunata!
...
\Pierluigispeaks\direct{Démoralizoù} Ad\'on vouì pa lo verbal; \direct{ironique} tourno aou\-tre eun Veulla é voualà! Tante n'i to lo dzor! 
...
\Prosperospeaks\direct{Eun plachèn la botèille} Ad\'on la caletoù de l'éve\ldots me rapello pamì, n'ayoù icri-lo seu mateun si lo beillette mi n'i perdi-lo\ldots senque l'iye\ldots ah ouè!  V-Power de Mori\'on! Dèi can bèyo so n'i pamì de mou a l'itsin-a é avouì la fenna totte semble pi amoddo. Si pa se me compregnade madame lo vallet \ok !

\StageDir{Le cantognì tappon ba pe lo pleuro de drole pousse.}
...
\Prosperospeaks\direct{Eugn avèitsèn foua di palque} Tchao, tchao! Ouè sen seu a proué lo moublo nouo. Ouè, ouè, la fenna lèi va beun, l'è i mitcho tranquila. Mi son tcheu dou de té? Mondje se l'è crèisì lo premì! Mi l'è igale a mamma, toutouteun a la mamma! Que dzen botcha; te queutto que la botèille l'è plèin-a. Tchao, tchao!
...
\StageDir{Prospero se beutte a seblì \seble\ eun pégno \textsl{refrain}.}
...
\Volonterospeaks Mé si volontéo! No volontéo n'en la convench\'on. Tan\-que a 25 litre pouèn terì.

\Prosperospeaks Na, na, seu pouade maque terì tanque a 15 litre!
...
\Valletspeaks\direct{Eun prégnèn pe eun bri lo vétchot} Soplé! Alade vo a\-chouat\-tì que seu lèi penso mé!
...
\Prosperospeaks Ouè sembleriye beun tot a poste.
...
\StageDir{Prospero gave ià la dériye botèille di distributeur é reprèn sa \textit{tessera}.} 
...
\Prosperospeaks Mi iaou alade avouì le botèille de mé!

\StageDir{Prospero avouì eun sate pren lo tsaèn, mi lo vallet lo molle pa. Comenchon avouì bièn d'énerjì a se terì ver leur lo tsaèn, tcheu dou eun braillèn: lo vallet vou maque baillì eunna man, Prospero vou pa itre èidjà. Aprì eun per de seconde, lo tsaèn tsi pe tèra. Lo volontéo galoppe per recoillì le botèille.}

\Prosperospeaks\direct{I vallet} Lazar\'on \greundzo !
...
\StageDir{Lo volontéo baille a Prospero eunna botèille que l'iye tsiziya.}
...
\Volonterospeaks Donque\ldots \direct{eun lièn le caletaye} sen Grat, Mori\'on, Tsar\-b\'on\ldots ah voualà: l'éve \textit{effervescente} naturelle de Ponteille. D'abor le medeseun diyon que l'è l'éve pi boun-a pe le maladdo!
...
\StageDir{Lo vallet eunterveun pe bloqué la discuch\'on que dimèn s'i\-tsaou\-de euntre Luciano, Pierluigi é lo vétchot. I mimo ten, pe queriaouzé, s'aprotse eunc\'o Prospero.\\ Aprì eun per de seconde la situach\'on se calme é Luciano vèi lo grou conténiteur di volontéo.}

\Lucianospeaks Ouè mi sitta véo de litre l'at a terì?


\Prosperospeaks\direct{Eun prégnèn Luciano a par} Na l'è totte a poste. N'i dza totte avèitchà mé. 
...
\Lucianospeaks Ouè mi oueu l'è demicro!

\Prosperospeaks \'E ad\'on?

\Lucianospeaks V'ouite todzor a tsaplétì é vo sade pa le bague pi eumportante. Lo demicro l'éve avouì lo gas l'è bièn pi gazaye!

\Prosperospeaks Mi pe dab\'on? \confuso\ Comèn fiade a savèi so?

\Lucianospeaks La fenna de mé, l'atro dzor, l'è vin-a seuilla i distributeur devàn que l’iverteua é dèi avèi sentì, si pa da qui, seutta dzenta novalla. Mi diade-l\'o pa a tcheut\ldots perqué piatro fièn tro de quiye lo demicro é a mé totsériye magà partì demì aoura devàn de mèiz\'on.
...
\Prosperospeaks Mi a no d'Ampaillan areuvvon douàn!

\Lucianospeaks\direct{Eun baillèn lo tsaèn a Prospero} Fiyo passì pi tar la fenna a lo reterì! \direct{Eun lèi baillèn la \textsl{tessera}} Voualà la \textit{tessera} é supergazaye de Fontan-a Tsada.
...
\Prosperospeaks\direct{I volontéo} Si cou l'è plen!

\Volonterospeaks Eh ouè, pouèi le maladdo son contèn. Orvouar!

\StageDir{Lo volontéo chor eun trèinèn la \textsl{tanica} plèin-a d'éve.}

\scene[-- La flemma di vétchot \viou]

\Valletspeaks\direct{I vétchot}  Voualà mesieu totse a vo ara! Plan planotte, alade maque.

\StageDir{Avouì an flemma que la mèitchà baste, lo vétchot se levve é, to to\-dzèn, s'aprotse i distributeur. }
...
\StageDir{Aprì èi eunserì la \textsl{tessera}, lo vétchot s'aprotse a Prospero.}
...
\StageDir{Aprì èi terià l'éve, lo vétchot reteurie la \textsl{tessera} é, accompagnà pe lo vallet, chor foua.}

\StageDir{Pierluigi s'aprotse i distributeur, teurie l'éve pe le-z-alpeun é chor.}

\StageDir{Prospero pren lo tsaèn de Luciano é teurie l'éve. Dimèn entre eunna fenna poua, avouì eun grou cartel de cart\'on \og SI SENSA SOU\fg é s'achouatte pe téra pe dimandé l'armoun-a \elemosina .}
...
\StageDir{Entron, man deun la man, Jack é John, eunna cobla \textsl{homosexuelle}.}
...
\StageDir{Le dou s'aprotson a Prospero pe bailli-lèi eunna man: tsertson de lèi passé le botèille pe terì l'éve.}

\Prosperospeaks Beuttade ba seutte botèille! N'i pa fata de vo-z-atre! Alade ià!


\StageDir{Avouì la baquetta é lo tsaèn, Prospero tsertse de le vardé louèn de llou é tchica pe cou se trame di distributeur.}

\Johnspeaks Ouè mi que caratéo!

\Jackspeaks\direct{A John} Avèitsa Pippi! L'è todzor dzen tournì seuilla, na? \inamourou
...
\StageDir{John, \textsl{euforique}, eumbrache Prospero, que, digout\'o, se reveurie.}
...
\Jackspeaks\direct{Malisieu \malisieu} Fé-me sentì se ta de pise\ldots

\StageDir{Jack, to todzèn, s'aprotse a John pe lo totchì, mi John recule jèinó tanque i poueun de pitì le pià de Prospero, lequel, tourna eunfastedjà, avouì la baquetta lèi baille eun creppe si lo qui.}
...
\StageDir{Entre eunna femalla d'orijine tunizine avouì seun mèinoù.}
...
\StageDir{John se viounde pe moutrì lo qui a Jack é lèi fé comprendre que la \textsl{tessera} l'è dedeun la secotse di pantal\'on. \'Emochon-où, Jack la pren é la eunserèi deun la machina.}
...
\StageDir{John s'aprotse a Jack eun lèi moutrèn lo bourset. Le dou moungouyon eun momàn pe tsertchì la \textsl{tessera} deun lo bourset. Can l'acappon fan eun viondolet é a la feun l'eunserèison deun lo distributeur.}
...
\StageDir{John pren eunna botèille deun la boursa é la plache dézò la bro\-tsetta.}
...
\StageDir{La fenna tunizine s'aprotse i distributeur avouì sinque mèinoù é eun grou tsaèn desì la tita, iaou n'at eunna matse de botèille.}

\Naimaspeaks\direct{Ver la fenna poua} Bondzor! \direct{A Prospero} Bondzor! Mèinoù, boudzade-v\'o, dérì de mé!

\Prosperospeaks Euh na, na! V'ouèide tro de litre! Me semble tchica tro de conténiteur!
...
\StageDir{Eun seblèn, lo vallet entre.}
...
\Valletspeaks Na, le dimando a vo.

\Naimaspeaks Mé n'i pa le documàn, n'i maque la carte \textit{oro}. \direct{Eun baillèn la carte i vallet} L'a bailla-me-là la \textit{Communauté de Montagne} é n'i 100 litre d'éve pe mèis gratouì. Mé é le mèinoù de mé!
...
\StageDir{Naima baille eunna botèille a tita i mèinoù é tcheut eunsemblo comenchon a terì l'éve. Dimèn entre François, lo pi\'on di péì.}
...
\StageDir{Lo vallet, eun véyèn François eunna mia eun difficult\'o, lèi baille eunna man pe reustì drette.}

\Prosperospeaks François! La fèi t'a trompoù poste !

\Francoisspeaks Na, na.

\Prosperospeaks \ldots pequé sé baillon maque l'éve!

\Francoisspeaks Sitte l'è lo poste djeusto. Pequé demàn n'i le-z-analize. Le vioù diyon que se te bèi eunna botèille d'éve de sent'Anna te tchoué tcheu le battère, tcheutte! Proua eunc\'o té!
...
\Seunteuccospeaks\direct{A François, eun lèi sarèn la man} Complemàn, comple\-màn de la par de totta la Jeunte, complemàn!

\StageDir{François veun tellamente sopat\'o pe lo Seunteucco que reusque de tsire pe tèra.}

\Naimaspeaks Mi pensa té sitte! Se passavo mé avouì mon litre, lo prégnò mé lo litre numér\'o 1000! \arrabbiato
...
\StageDir{La journaliste se plache protso de François é l'opérateur se poze\-choun-e pe le reprendre. François l'è vard\'o drette grase a Attila; n'at eunc\'o Prospero que salie la machina di reprèize.}

\Journalistespeaks Bondzor a tcheutte! Sen seu pe sentì sen que l'at a no diye lo mesieu que la terià lo litre num\'er\'o 1000 a la Bouteucca de l'éve. Ara vèyèn sen que l'a gagnà.\\ \direct{Eugn aprotsèn lo microfonne ver François} Ad\'on mesieu\ldots
...
\Seunteuccospeaks Fa diye que no sen contèn d'èi sé a Tsarvensoù lo gagnàn di litre num\'er\'o 1000 de la Bouteucca de l'éve. La sosiétoù que l’a vendi-no seutta machina bailleré i mesieu eun bon de 200 litre pe caletoù d'éve da dzoure devàn lo 31/12/2012.

\StageDir{Prospero s'aprotse i microfonne.}

\Prosperospeaks Se va bièn nen avancheré trèi car! \riye

\Journalistespeaks Ouè ad\'on de Tsarvensoù l'è totte, mersì a tcheut\-te é orvouar a l'an que veun!
...
\centering
\whiteshadowbox{
\includegraphics[height=6cm,keepaspectratio]{Foto/2012/0.png}
}
\end{figure}
\vfill
