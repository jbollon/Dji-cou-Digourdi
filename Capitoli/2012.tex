...
\StageDir{Partèi eunna réclamme que sponsorize l'éve de \textit{Sainte Colombe}\footnote{ Malerezamente n'en pa accapoù la \textit{vidéo}. L'è poussiblo la veure (mal) eugn avèitsèn la \textit{vidéo} de la pièse. Pouèn deue que n'ayè eunna botèille d'éve que colatèe ba pe eun prou. Ester Bollon, métresse di-z-esquì, la chouivèi tanque i fon di prou. A la feun, pren la botèille é braille: \og L'\'eve de Senta-Colomba, se te la bèi l'è eunna bomba!  \fg.}.} 
...
\StageDir{Pierluigi baille eun creppe i distributeur. Dimèn entre eugn atro vétchot que s'achouatte protso de Prospero.}
